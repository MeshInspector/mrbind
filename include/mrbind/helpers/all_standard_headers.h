...
// This file is generated by pasting the entire contents of `https://eel.is/c++draft/headerindex` to a file and running the following command on it:
//     grep -Po '^<[^>]+>' 1.txt | grep -v 'complex.h' | sed 's/\(.*\)/#if __has_include(\1)\n#include \1\n#endif/'
//
// Notice the omission of `complex.h`, which has `#define I` in it, which is dumb for obvious reasons.
