...
namespace MR::StdOptional
{
    ...
    inline void SetIntConstRef(const std::optional<int> &) {}
    ...
    inline void SetEnumConstRef(const std::optional<E> &) {}
    ...
    inline void SetClassConstRef(const std::optional<A> &) {}
    ...
    inline void SetClass2ConstRef(const std::optional<B> &) {}
