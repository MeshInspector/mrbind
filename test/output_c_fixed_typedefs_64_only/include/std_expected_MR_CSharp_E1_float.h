...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const MR_CSharp_E1 *MR_C_std_expected_MR_CSharp_E1_float_value(const MR_C_std_expected_MR_CSharp_E1_float *_this);

/// If this instance represents an error, returns the stored `float`. Otherwise null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const float *MR_C_std_expected_MR_CSharp_E1_float_error(const MR_C_std_expected_MR_CSharp_E1_float *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API MR_CSharp_E1 *MR_C_std_expected_MR_CSharp_E1_float_value_mut(MR_C_std_expected_MR_CSharp_E1_float *_this);

/// If this instance represents an error, returns the stored `float`. Otherwise null. This version returns a mutable pointer.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API float *MR_C_std_expected_MR_CSharp_E1_float_error_mut(MR_C_std_expected_MR_CSharp_E1_float *_this);
