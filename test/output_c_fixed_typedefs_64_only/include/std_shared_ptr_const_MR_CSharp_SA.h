...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_const_MR_CSharp_SA_has_value(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_MR_CSharp_SA_reset(MR_C_std_shared_ptr_const_MR_CSharp_SA *_this);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_CSharp_SA_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_const_MR_CSharp_SA *MR_C_std_shared_ptr_const_MR_CSharp_SA_ConstructFromValue(const MR_CSharp_SA *value);
...
MR_C_API MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_MR_CSharp_SA_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this);
...
MR_C_API void MR_C_std_shared_ptr_const_MR_CSharp_SA_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this, MR_C_std_shared_ptr_const_void *_target);
