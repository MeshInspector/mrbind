...
MR_C_API MR_C_std_function_std_string_from_int_float *MR_C_std_function_std_string_from_int_float_ConstructStateless(const char *(*func)(const char **_return_end, int _1, float _2));
...
MR_C_API MR_C_std_function_std_string_from_int_float *MR_C_std_function_std_string_from_int_float_ConstructWithDataPtr(const char *(*func)(const char **_return_end, int _1, float _2, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
