...
MR_C_API int MR_CSharp_test_constness_int(int _1, const int *_2);
...
/// Generated from method `MR::CSharp::IndexerC::operator[]`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_CSharp_IndexerC_index_mut(MR_CSharp_IndexerC *_this, int i);

/// Generated from method `MR::CSharp::IndexerC::operator[]`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API float MR_CSharp_IndexerC_index(const MR_CSharp_IndexerC *_this, int i);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_CSharp_ConstNonconstConflicts_foo_mut_int(MR_CSharp_ConstNonconstConflicts *_this, int _1);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int *MR_CSharp_IterableC_begin_mut(MR_CSharp_IterableC *_this);

/// Generated from method `MR::CSharp::IterableC::end`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int *MR_CSharp_IterableC_end_mut(MR_CSharp_IterableC *_this);

/// Generated from method `MR::CSharp::IterableC::begin`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_IterableC_begin(const MR_CSharp_IterableC *_this);

/// Generated from method `MR::CSharp::IterableC::end`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_IterableC_end(const MR_CSharp_IterableC *_this);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const int *MR_CSharp_IterableK_Get_arr(const MR_CSharp_IterableK *_this);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int *MR_CSharp_IterableK_GetMutable_arr(MR_CSharp_IterableK *_this);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int *const *MR_CSharp_IterableK_Sentinel_Get_ptr(const MR_CSharp_IterableK_Sentinel *_this);
...
MR_C_API void MR_CSharp_IterableK_Sentinel_Set_ptr(MR_CSharp_IterableK_Sentinel *_this, int *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::IterableK::Sentinel` named `ptr`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int **MR_CSharp_IterableK_Sentinel_GetMutable_ptr(MR_CSharp_IterableK_Sentinel *_this);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_CSharp_IterableK_Sentinel_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_CSharp_IterableK_Sentinel *MR_CSharp_IterableK_Sentinel_ConstructFrom(int *ptr);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int *const *MR_CSharp_IterableK_Iter_Get_ptr(const MR_CSharp_IterableK_Iter *_this);

/// Modifies a member variable of class `MR::CSharp::IterableK::Iter` named `ptr`.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `value` might be preserved in this object in element `ptr`.
/// When this function is called, this object will drop object references it held previously in `ptr`.
MR_C_API void MR_CSharp_IterableK_Iter_Set_ptr(MR_CSharp_IterableK_Iter *_this, int *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::IterableK::Iter` named `ptr`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int **MR_CSharp_IterableK_Iter_GetMutable_ptr(MR_CSharp_IterableK_Iter *_this);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_CSharp_IterableK_Iter_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_CSharp_IterableK_Iter *MR_CSharp_IterableK_Iter_ConstructFrom(int *ptr);
...
/// Generated from method `MR::CSharp::IterableK::Iter::operator*`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_deref_MR_CSharp_IterableK_Iter(const MR_CSharp_IterableK_Iter *_this);
...
/// Returns a pointer to a member variable of class `MR::CSharp::IterableL<int>` named `arr`. This is a pointer to the first element of an array.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const int *MR_CSharp_IterableL_int_Get_arr(const MR_CSharp_IterableL_int *_this);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::IterableL<int>` named `arr`. This is a pointer to the first element of an array.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API int *MR_CSharp_IterableL_int_GetMutable_arr(MR_CSharp_IterableL_int *_this);

/// Returns the size of the array member of class `MR::CSharp::IterableL<int>` named `arr`. The size is `3`.
MR_C_API size_t MR_CSharp_IterableL_int_GetSize_arr(void);

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_CSharp_IterableL_int_Destroy()` to free it when you're done using it.
MR_C_API MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_CSharp_IterableL_int_DestroyArray()`.
/// Use `MR_CSharp_IterableL_int_OffsetMutablePtr()` and `MR_CSharp_IterableL_int_OffsetPtr()` to access the array elements.
MR_C_API MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_DefaultConstructArray(size_t num_elems);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_OffsetPtr(const MR_CSharp_IterableL_int *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_OffsetMutablePtr(MR_CSharp_IterableL_int *ptr, ptrdiff_t i);

/// Generated from constructor `MR::CSharp::IterableL<int>::IterableL`.
/// Parameter `_other` can not be null. It is a single object.
/// The reference to things referred to by the parameter `_other` (if any) might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_CSharp_IterableL_int_Destroy()` to free it when you're done using it.
MR_C_API MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_ConstructFromAnother(const MR_CSharp_IterableL_int *_other);

/// Destroys a heap-allocated instance of `MR_CSharp_IterableL_int`. Does nothing if the pointer is null.
MR_C_API void MR_CSharp_IterableL_int_Destroy(const MR_CSharp_IterableL_int *_this);

/// Destroys a heap-allocated array of `MR_CSharp_IterableL_int`. Does nothing if the pointer is null.
MR_C_API void MR_CSharp_IterableL_int_DestroyArray(const MR_CSharp_IterableL_int *_this);

/// Generated from method `MR::CSharp::IterableL<int>::operator=`.
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `_other` can not be null. It is a single object.
/// The reference to things referred to by the parameter `_other` (if any) might be preserved in this object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_CSharp_IterableL_int *MR_CSharp_IterableL_int_AssignFromAnother(MR_CSharp_IterableL_int *_this, const MR_CSharp_IterableL_int *_other);

/// Generated from method `MR::CSharp::IterableL<int>::begin`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_IterableL_int_begin(const MR_CSharp_IterableL_int *_this);

/// Generated from method `MR::CSharp::IterableL<int>::end`.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_IterableL_int_end(const MR_CSharp_IterableL_int *_this);

/// Generated from function `MR::CSharp::begin<int>`.
/// Parameter `self` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_begin_int(const MR_CSharp_IterableL_int *self);

/// Generated from function `MR::CSharp::end<int>`.
/// Parameter `self` can not be null. It is a single object.
MR_C_API const int *MR_CSharp_end_int(const MR_CSharp_IterableL_int *self);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const MR_C_std_function_int_from_std_string *MR_CSharp_TestStdFunction_Get_f1(const MR_CSharp_TestStdFunction *_this);
...
MR_C_API void MR_CSharp_TestStdFunction_Set_f1(MR_CSharp_TestStdFunction *_this, MR_C_PassBy value_pass_by, MR_C_std_function_int_from_std_string *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f1`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API MR_C_std_function_int_from_std_string *MR_CSharp_TestStdFunction_GetMutable_f1(MR_CSharp_TestStdFunction *_this);

/// Returns a pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f2`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const MR_C_std_function_std_string_from_int_int *MR_CSharp_TestStdFunction_Get_f2(const MR_CSharp_TestStdFunction *_this);
...
MR_C_API void MR_CSharp_TestStdFunction_Set_f2(MR_CSharp_TestStdFunction *_this, MR_C_PassBy value_pass_by, MR_C_std_function_std_string_from_int_int *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f2`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API MR_C_std_function_std_string_from_int_int *MR_CSharp_TestStdFunction_GetMutable_f2(MR_CSharp_TestStdFunction *_this);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const MR_C_std_function_int_ref_from_int_ref_int_rvalue_ref *MR_CSharp_TestStdFunction_Get_f5(const MR_CSharp_TestStdFunction *_this);
...
MR_C_API void MR_CSharp_TestStdFunction_Set_f5(MR_CSharp_TestStdFunction *_this, MR_C_PassBy value_pass_by, MR_C_std_function_int_ref_from_int_ref_int_rvalue_ref *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f5`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API MR_C_std_function_int_ref_from_int_ref_int_rvalue_ref *MR_CSharp_TestStdFunction_GetMutable_f5(MR_CSharp_TestStdFunction *_this);

/// Returns a pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f6`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API const MR_C_std_function_int_rvalue_ref *MR_CSharp_TestStdFunction_Get_f6(const MR_CSharp_TestStdFunction *_this);
...
MR_C_API void MR_CSharp_TestStdFunction_Set_f6(MR_CSharp_TestStdFunction *_this, MR_C_PassBy value_pass_by, MR_C_std_function_int_rvalue_ref *value);

/// Returns a mutable pointer to a member variable of class `MR::CSharp::TestStdFunction` named `f6`.
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
/// The reference to this object might be preserved as the return value.
MR_C_API MR_C_std_function_int_rvalue_ref *MR_CSharp_TestStdFunction_GetMutable_f6(MR_CSharp_TestStdFunction *_this);
