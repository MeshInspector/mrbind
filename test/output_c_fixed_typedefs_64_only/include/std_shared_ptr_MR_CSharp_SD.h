...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_MR_CSharp_SD_has_value(const MR_C_std_shared_ptr_MR_CSharp_SD *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_MR_CSharp_SD_use_count(const MR_C_std_shared_ptr_MR_CSharp_SD *_this);

/// Resets the pointer to null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SD_reset(MR_C_std_shared_ptr_MR_CSharp_SD *_this);

/// Construct from a value.
/// The reference to the parameter `value` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_MR_CSharp_SD_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_MR_CSharp_SD *MR_C_std_shared_ptr_MR_CSharp_SD_ConstructFromValue(MR_C_PassBy value_pass_by, MR_CSharp_SD *value);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_MR_CSharp_SD_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SD *_this);
...
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SD_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SD *_this, MR_C_std_shared_ptr_void *_target);
