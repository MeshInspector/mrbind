...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_MR_CSharp_SC_has_value(const MR_C_std_shared_ptr_MR_CSharp_SC *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SC_reset(MR_C_std_shared_ptr_MR_CSharp_SC *_this);

/// Construct from a value.
/// The reference to the parameter `value` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_MR_CSharp_SC_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_MR_CSharp_SC *MR_C_std_shared_ptr_MR_CSharp_SC_ConstructFromValue(MR_C_PassBy value_pass_by, MR_CSharp_SC *value);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_MR_CSharp_SC_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SC *_this);
...
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SC_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SC *_this, MR_C_std_shared_ptr_void *_target);
