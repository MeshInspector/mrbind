...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_phmap_flat_hash_set_int_Destroy()` to free it when you're done using it.
...
MR_C_API void MR_C_phmap_flat_hash_set_int_Destroy(const MR_C_phmap_flat_hash_set_int *_this);

/// Destroys a heap-allocated array of `MR_C_phmap_flat_hash_set_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_phmap_flat_hash_set_int_DestroyArray(const MR_C_phmap_flat_hash_set_int *_this);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_phmap_flat_hash_set_int_Destroy()` to free it when you're done using it.
MR_C_API MR_C_phmap_flat_hash_set_int *MR_C_phmap_flat_hash_set_int_ConstructFromRange(const int *ptr, size_t size);

/// Assign from a range of elements, overwriting previous contents.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_phmap_flat_hash_set_int_AssignFromRange(MR_C_phmap_flat_hash_set_int *_this, const int *ptr, size_t size);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_phmap_flat_hash_set_int_empty(const MR_C_phmap_flat_hash_set_int *_this);
...
MR_C_API bool MR_C_phmap_flat_hash_set_int_is_begin(const MR_C_phmap_flat_hash_set_int *_this, const MR_C_phmap_flat_hash_set_int_const_iterator *iter);
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_phmap_flat_hash_set_int_is_end(const MR_C_phmap_flat_hash_set_int *_this, const MR_C_phmap_flat_hash_set_int_const_iterator *iter);
...
MR_C_API void MR_C_phmap_flat_hash_set_int_const_iterator_Destroy(const MR_C_phmap_flat_hash_set_int_const_iterator *_this);

/// Destroys a heap-allocated array of `MR_C_phmap_flat_hash_set_int_const_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_phmap_flat_hash_set_int_const_iterator_DestroyArray(const MR_C_phmap_flat_hash_set_int_const_iterator *_this);
...
MR_C_API bool MR_C_equal_MR_C_phmap_flat_hash_set_int_const_iterator(const MR_C_phmap_flat_hash_set_int_const_iterator *a, const MR_C_phmap_flat_hash_set_int_const_iterator *b);
