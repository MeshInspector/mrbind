...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_void_has_value(const MR_C_std_shared_ptr_void *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_void_reset(MR_C_std_shared_ptr_void *_this);
