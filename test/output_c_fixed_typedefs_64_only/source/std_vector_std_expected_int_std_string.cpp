...
{
    MRBINDC_CLASSARG_GUARD(other, std::vector<std::expected<int, std::string>>);
    return (MR_C_std_vector_std_expected_int_std_string *)new std::vector<std::expected<int, std::string>>(std::vector<std::expected<int, std::string>>(
...
{
    MRBINDC_CLASSARG_GUARD(other, std::vector<std::expected<int, std::string>>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<std::expected<int, std::string>>) MRBINDC_CLASSARG_COPY(other, (std::vector<std::expected<int, std::string>>), std::vector<std::expected<int, std::string>>) MRBINDC_CLASSARG_MOVE(other, (std::vector<std::expected<int, std::string>>), std::vector<std::expected<int, std::string>>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<std::expected<int, std::string>>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<std::expected<int, std::string>>) MRBINDC_CLASSARG_END(other, std::vector<std::expected<int, std::string>>))
    );
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).size();
}

bool MR_C_std_vector_std_expected_int_std_string_empty(const MR_C_std_vector_std_expected_int_std_string *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).empty();
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).resize(
        new_size
    );
}
...
void MR_C_std_vector_std_expected_int_std_string_resize_with_default_value(MR_C_std_vector_std_expected_int_std_string *_this, size_t new_size, const MR_C_std_expected_int_std_string *value)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).resize(
        new_size,
        ((value ? void() : MRBINDC_THROW("Parameter `value` can not be null.", void)), *(const std::expected<int, std::string> *)(value))
    );
}

void MR_C_std_vector_std_expected_int_std_string_clear(MR_C_std_vector_std_expected_int_std_string *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).clear();
}

size_t MR_C_std_vector_std_expected_int_std_string_capacity(const MR_C_std_vector_std_expected_int_std_string *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).capacity();
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).reserve(
        new_capacity
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).shrink_to_fit();
}
...
{
    return (const MR_C_std_expected_int_std_string *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).at(
        i
    ));
}
...
{
    return (MR_C_std_expected_int_std_string *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).at(
        i
    ));
}
...
{
    return (const MR_C_std_expected_int_std_string *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).front());
}
...
{
    return (MR_C_std_expected_int_std_string *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).front());
}
...
{
    return (const MR_C_std_expected_int_std_string *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).back());
}
...
{
    return (MR_C_std_expected_int_std_string *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).back());
}
...
{
    MRBINDC_CLASSARG_GUARD(new_elem, std::expected<int, std::string>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).push_back(
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).pop_back();
}
...
{
    MRBINDC_CLASSARG_GUARD(new_elem, std::expected<int, std::string>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).insert(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).begin() + ptrdiff_t(position), (MRBINDC_CLASSARG_DEF_CTOR(new_elem, std::expected<int, std::string>) MRBINDC_CLASSARG_COPY(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_MOVE(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_DefaultArgument, std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_NoObject, std::expected<int, std::string>) MRBINDC_CLASSARG_END(new_elem, std::expected<int, std::string>)));
}

void MR_C_std_vector_std_expected_int_std_string_erase(MR_C_std_vector_std_expected_int_std_string *_this, size_t position)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).erase(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).begin() + ptrdiff_t(position));
}
...
{
    MRBINDC_CLASSARG_GUARD(new_elem, std::expected<int, std::string>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)position)),
        (MRBINDC_CLASSARG_DEF_CTOR(new_elem, std::expected<int, std::string>) MRBINDC_CLASSARG_COPY(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_MOVE(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_DefaultArgument, std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_NoObject, std::expected<int, std::string>) MRBINDC_CLASSARG_END(new_elem, std::expected<int, std::string>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).erase(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)position))
    );
}
...
void MR_C_std_vector_std_expected_int_std_string_insert_at_iter(MR_C_std_vector_std_expected_int_std_string *_this, const MR_C_std_vector_std_expected_int_std_string_const_iterator *position, MR_C_PassBy new_elem_pass_by, MR_C_std_expected_int_std_string *new_elem)
{
    MRBINDC_CLASSARG_GUARD(new_elem, std::expected<int, std::string>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)position)),
        (MRBINDC_CLASSARG_DEF_CTOR(new_elem, std::expected<int, std::string>) MRBINDC_CLASSARG_COPY(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_MOVE(new_elem, (std::expected<int, std::string>), std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_DefaultArgument, std::expected<int, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR_C_PassBy_NoObject, std::expected<int, std::string>) MRBINDC_CLASSARG_END(new_elem, std::expected<int, std::string>))
    );
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_const_iterator *)new std::vector<std::expected<int, std::string>>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_iterator *)new std::vector<std::expected<int, std::string>>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).begin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).begin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::iterator *)(iter));
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_const_iterator *)new std::vector<std::expected<int, std::string>>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_iterator *)new std::vector<std::expected<int, std::string>>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>> *)(_this)).end());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).end() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::iterator *)(iter));
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).cbegin();
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>> *)(_this)).begin();
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_const_iterator *)new std::vector<std::expected<int, std::string>>::const_iterator(std::vector<std::expected<int, std::string>>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)other))
    );
}
...
MR_C_std_vector_std_expected_int_std_string_const_iterator *MR_C_std_vector_std_expected_int_std_string_const_iterator_from_mutable(const MR_C_std_vector_std_expected_int_std_string_iterator *iter)
{
    return (MR_C_std_vector_std_expected_int_std_string_const_iterator *)new std::vector<std::expected<int, std::string>>::const_iterator(std::vector<std::expected<int, std::string>>::iterator(
        ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)iter))
    ));
}
...
{
    return (MR_C_std_vector_std_expected_int_std_string_iterator *)new std::vector<std::expected<int, std::string>>::iterator(std::vector<std::expected<int, std::string>>::iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)other))
    );
}
...
{
    return (const MR_C_std_expected_int_std_string *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::const_iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::const_iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<std::expected<int, std::string>>::const_iterator(*(std::vector<std::expected<int, std::string>>::const_iterator *)b));
}
...
{
    return (MR_C_std_expected_int_std_string *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<std::expected<int, std::string>>::iterator *)(_this)));
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<std::expected<int, std::string>>::iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<std::expected<int, std::string>>::iterator(*(std::vector<std::expected<int, std::string>>::iterator *)b));
}
