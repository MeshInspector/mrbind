...
{
    return (MR_OmittingTargsAndQuals_A_int *)new MR::OmittingTargsAndQuals::A<int>(MR::OmittingTargsAndQuals::A<int>(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_other))
    ));
}
...
{
    return (MR_OmittingTargsAndQuals_A_int *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<int> *)(_this)).operator=(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<int> *)(_this)).operator+();
}
...
{
    a(
        ((_1 ? void() : MRBINDC_THROW("Parameter `_1` can not be null.", void)), MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_1))
    );
}
