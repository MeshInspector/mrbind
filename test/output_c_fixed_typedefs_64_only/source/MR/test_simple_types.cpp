...
void MR_TestSimpleTypes_SetIntPtrDef(int *const *_1)
{
    ::MR::TestSimpleTypes::SetIntPtrDef(
        (_1 ? *_1 : static_cast<int *>(&MR::TestSimpleTypes::global_int))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)(_this)).foo<int>();
}
