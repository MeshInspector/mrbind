...
const int *MR_CSharp_B_Get_a(const MR_CSharp_B *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const MR::CSharp::B *)(_this)).a);
}

void MR_CSharp_B_Set_a(MR_CSharp_B *_this, int value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::B *)(_this)).a = value;
}

int *MR_CSharp_B_GetMutable_a(MR_CSharp_B *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::B *)(_this)).a);
}
...
const int *MR_CSharp_C_Get_a(const MR_CSharp_C *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const MR::CSharp::C *)(_this)).a);
}

void MR_CSharp_C_Set_a(MR_CSharp_C *_this, int value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::C *)(_this)).a = value;
}

int *MR_CSharp_C_GetMutable_a(MR_CSharp_C *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::C *)(_this)).a);
}
...
const int *MR_CSharp_F_Get_a(const MR_CSharp_F *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const MR::CSharp::F *)(_this)).a);
}

void MR_CSharp_F_Set_a(MR_CSharp_F *_this, int value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::F *)(_this)).a = value;
}

int *MR_CSharp_F_GetMutable_a(MR_CSharp_F *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::F *)(_this)).a);
}
...
const int *MR_CSharp_G_Get_a(const MR_CSharp_G *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const MR::CSharp::G *)(_this)).a);
}

void MR_CSharp_G_Set_a(MR_CSharp_G *_this, int value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::G *)(_this)).a = value;
}

int *MR_CSharp_G_GetMutable_a(MR_CSharp_G *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::CSharp::G *)(_this)).a);
}
