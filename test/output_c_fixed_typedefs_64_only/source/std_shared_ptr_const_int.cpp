...
bool MR_C_std_shared_ptr_const_int_has_value(const MR_C_std_shared_ptr_const_int *_this)
{
    return bool(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const int> *)(_this)));
}

int MR_C_std_shared_ptr_const_int_use_count(const MR_C_std_shared_ptr_const_int *_this)
{
...
void MR_C_std_shared_ptr_const_int_reset(MR_C_std_shared_ptr_const_int *_this)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const int> *)(_this)).reset();
}

MR_C_std_shared_ptr_const_int *MR_C_std_shared_ptr_const_int_ConstructFromValue(int value)
{
    return (MR_C_std_shared_ptr_const_int *)new std::shared_ptr<const int>(std::make_shared<const int>(
        value
    ));
}

MR_C_std_shared_ptr_const_int *MR_C_std_shared_ptr_const_int_Construct(const int *ptr)
{
    return (MR_C_std_shared_ptr_const_int *)new std::shared_ptr<const int>(std::shared_ptr<const int>(
...
MR_C_std_shared_ptr_const_int *MR_C_std_shared_ptr_const_int_ConstructNonOwning(const int *ptr)
{
    return (MR_C_std_shared_ptr_const_int *)new std::shared_ptr<const int>(std::shared_ptr<const int>(std::shared_ptr<void>{}, ptr));
}

void MR_C_std_shared_ptr_const_int_AssignNonOwning(MR_C_std_shared_ptr_const_int *_this, const int *ptr)
{
...
MR_C_std_shared_ptr_const_int *MR_C_std_shared_ptr_const_int_ConstructFromMutable(MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_int *ptr)
{
...
void MR_C_std_shared_ptr_const_int_AssignFromMutable(MR_C_std_shared_ptr_const_int *_this, MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_int *ptr)
{
    MRBINDC_CLASSARG_GUARD(ptr, std::shared_ptr<int>);
...
MR_C_std_shared_ptr_const_int *MR_C_std_shared_ptr_const_int_ConstructAliasing(MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, const int *ptr)
{
...
void MR_C_std_shared_ptr_const_int_AssignAliasing(MR_C_std_shared_ptr_const_int *_this, MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, const int *ptr)
{
    MRBINDC_CLASSARG_GUARD(ownership, std::shared_ptr<const void>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const int> *)(_this)) = std::shared_ptr<const int>(
        (MRBINDC_CLASSARG_DEF_CTOR(ownership, std::shared_ptr<const void>) MRBINDC_CLASSARG_COPY(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_MOVE(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_DefaultArgument, std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_NoObject, std::shared_ptr<const void>) MRBINDC_CLASSARG_END(ownership, std::shared_ptr<const void>)),
...
MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_int_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int *_this)
{
    return (MR_C_std_shared_ptr_const_void *)new std::shared_ptr<const void>(std::shared_ptr<const void>(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const int> *)(_this))));
}

void MR_C_std_shared_ptr_const_int_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int *_this, MR_C_std_shared_ptr_const_void *_target)
{
    ((_target ? void() : throw std::runtime_error("Parameter `_target` can not be null.")), *(std::shared_ptr<const void> *)(_target)) = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const int> *)(_this));
}
