...
{
    MRBINDC_CLASSARG_GUARD(other, std::multiset<MR::StdContainers::NonAssignable>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<MR::StdContainers::NonAssignable> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::multiset<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_COPY(other, (std::multiset<MR::StdContainers::NonAssignable>), std::multiset<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_MOVE(other, (std::multiset<MR::StdContainers::NonAssignable>), std::multiset<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::multiset<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::multiset<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_END(other, std::multiset<MR::StdContainers::NonAssignable>))
    );
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).size();
}

bool MR_C_std_multiset_MR_StdContainers_NonAssignable_empty(const MR_C_std_multiset_MR_StdContainers_NonAssignable *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).empty();
}

void MR_C_std_multiset_MR_StdContainers_NonAssignable_clear(MR_C_std_multiset_MR_StdContainers_NonAssignable *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<MR::StdContainers::NonAssignable> *)(_this)).clear();
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).count(
...
{
    return (MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *)new std::multiset<MR::StdContainers::NonAssignable>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *(const MR::StdContainers::NonAssignable *)(key))
    ));
}
...
void MR_C_std_multiset_MR_StdContainers_NonAssignable_insert(MR_C_std_multiset_MR_StdContainers_NonAssignable *_this, MR_C_PassBy new_elem_pass_by, MR_StdContainers_NonAssignable *new_elem)
{
    ...
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<MR::StdContainers::NonAssignable> *)(_this)).insert(
...
{
    return (MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *)new std::multiset<MR::StdContainers::NonAssignable>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *)new std::multiset<MR::StdContainers::NonAssignable>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *)new std::multiset<MR::StdContainers::NonAssignable>::const_iterator(std::multiset<MR::StdContainers::NonAssignable>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<MR::StdContainers::NonAssignable>::const_iterator(*(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<MR::StdContainers::NonAssignable>::const_iterator(*(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)other))
    );
}
...
{
    return (const MR_StdContainers_NonAssignable *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)(_this));
}
...
bool MR_C_equal_MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator(const MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *a, const MR_C_std_multiset_MR_StdContainers_NonAssignable_const_iterator *b)
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::multiset<MR::StdContainers::NonAssignable>::const_iterator(*(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::multiset<MR::StdContainers::NonAssignable>::const_iterator(*(std::multiset<MR::StdContainers::NonAssignable>::const_iterator *)b));
}
