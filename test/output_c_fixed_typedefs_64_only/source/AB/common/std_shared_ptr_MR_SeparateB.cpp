...
{
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<MR::SeparateB>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<MR::SeparateB> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::shared_ptr<MR::SeparateB>) MRBINDC_CLASSARG_COPY(other, (std::shared_ptr<MR::SeparateB>), std::shared_ptr<MR::SeparateB>) MRBINDC_CLASSARG_MOVE(other, (std::shared_ptr<MR::SeparateB>), std::shared_ptr<MR::SeparateB>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::shared_ptr<MR::SeparateB>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::shared_ptr<MR::SeparateB>) MRBINDC_CLASSARG_END(other, std::shared_ptr<MR::SeparateB>))
    );
}
...
{
    return (MR_SeparateB *)(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<MR::SeparateB> *)(_this)).get());
}

bool MR_C_std_shared_ptr_MR_SeparateB_has_value(const MR_C_std_shared_ptr_MR_SeparateB *_this)
{
    return bool(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<MR::SeparateB> *)(_this)));
}

int MR_C_std_shared_ptr_MR_SeparateB_use_count(const MR_C_std_shared_ptr_MR_SeparateB *_this)
{
    return int(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<MR::SeparateB> *)(_this)).use_count());
}

void MR_C_std_shared_ptr_MR_SeparateB_reset(MR_C_std_shared_ptr_MR_SeparateB *_this)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<MR::SeparateB> *)(_this)).reset();
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<MR::SeparateB> *)(_this)) = std::shared_ptr<MR::SeparateB>(
        std::unique_ptr<MR::SeparateB>((MR::SeparateB *)ptr)
    );
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<MR::SeparateB> *)(_this)) = std::shared_ptr<MR::SeparateB>(std::shared_ptr<void>{}, ((MR::SeparateB *)ptr));
}
...
{
    return (MR_C_std_shared_ptr_void *)new std::shared_ptr<void>(std::shared_ptr<void>(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<MR::SeparateB> *)(_this))));
}
...
{
    ((_target ? void() : throw std::runtime_error("Parameter `_target` can not be null.")), *(std::shared_ptr<void> *)(_target)) = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<MR::SeparateB> *)(_this));
}
