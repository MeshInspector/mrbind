...
{
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<MR::SeparateA>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<MR::SeparateA> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::shared_ptr<MR::SeparateA>) MRBINDC_CLASSARG_COPY(other, (std::shared_ptr<MR::SeparateA>), std::shared_ptr<MR::SeparateA>) MRBINDC_CLASSARG_MOVE(other, (std::shared_ptr<MR::SeparateA>), std::shared_ptr<MR::SeparateA>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::shared_ptr<MR::SeparateA>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::shared_ptr<MR::SeparateA>) MRBINDC_CLASSARG_END(other, std::shared_ptr<MR::SeparateA>))
    );
}
...
{
    return (MR_SeparateA *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<MR::SeparateA> *)(_this)).get());
}

bool MR_C_std_shared_ptr_MR_SeparateA_has_value(const MR_C_std_shared_ptr_MR_SeparateA *_this)
{
    return bool(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<MR::SeparateA> *)(_this)));
}

int MR_C_std_shared_ptr_MR_SeparateA_use_count(const MR_C_std_shared_ptr_MR_SeparateA *_this)
{
    return int(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<MR::SeparateA> *)(_this)).use_count());
}

void MR_C_std_shared_ptr_MR_SeparateA_reset(MR_C_std_shared_ptr_MR_SeparateA *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<MR::SeparateA> *)(_this)).reset();
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<MR::SeparateA> *)(_this)) = std::shared_ptr<MR::SeparateA>(
        std::unique_ptr<MR::SeparateA>((MR::SeparateA *)ptr)
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<MR::SeparateA> *)(_this)) = std::shared_ptr<MR::SeparateA>(std::shared_ptr<void>{}, ((MR::SeparateA *)ptr));
}
...
{
    return (MR_C_std_shared_ptr_void *)new std::shared_ptr<void>(std::shared_ptr<void>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<MR::SeparateA> *)(_this))));
}
...
{
    ((_target ? void() : MRBINDC_THROW("Parameter `_target` can not be null.", void)), *(std::shared_ptr<void> *)(_target)) = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<MR::SeparateA> *)(_this));
}
