...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::unordered_map<int, float> *)(_this))[((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *key)]);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::unordered_map<int, float>::const_iterator *)(_this))->first);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::unordered_map<int, float>::const_iterator *)(_this))->second);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::unordered_map<int, float>::iterator *)(_this))->first);
}

float *MR_C_std_unordered_map_int_float_iterator_DerefValue(const MR_C_std_unordered_map_int_float_iterator *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::unordered_map<int, float>::iterator *)(_this))->second);
}
