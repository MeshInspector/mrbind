...
{
    MRBINDC_CLASSARG_GUARD(other, std::vector<MR_C_int64_t>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_COPY(other, (std::vector<MR_C_int64_t>), std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_MOVE(other, (std::vector<MR_C_int64_t>), std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_END(other, std::vector<MR_C_int64_t>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)) = std::vector<MR_C_int64_t>(ptr, ptr + size);
}

size_t MR_C_std_vector_int64_t_size(const MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).size();
}

bool MR_C_std_vector_int64_t_empty(const MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).empty();
}

void MR_C_std_vector_int64_t_resize(MR_C_std_vector_int64_t *_this, size_t new_size)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).resize(
        new_size
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).clear();
}

size_t MR_C_std_vector_int64_t_capacity(const MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).capacity();
}

void MR_C_std_vector_int64_t_reserve(MR_C_std_vector_int64_t *_this, size_t new_capacity)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).reserve(
        new_capacity
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).shrink_to_fit();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_at(const MR_C_std_vector_int64_t *_this, size_t i)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).at(
        i
    ));
}
...
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).at(
        i
    ));
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).front();
}

MR_C_int64_t *MR_C_std_vector_int64_t_front_mut(MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).front();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_back(const MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).back();
}

MR_C_int64_t *MR_C_std_vector_int64_t_back_mut(MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).back();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_data(const MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).data();
}

MR_C_int64_t *MR_C_std_vector_int64_t_data_mut(MR_C_std_vector_int64_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).data();
}

void MR_C_std_vector_int64_t_push_back(MR_C_std_vector_int64_t *_this, MR_C_int64_t new_elem)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).push_back(
        new_elem
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).pop_back();
}

void MR_C_std_vector_int64_t_insert(MR_C_std_vector_int64_t *_this, size_t position, MR_C_int64_t new_elem)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).insert(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).begin() + ptrdiff_t(position), new_elem);
}

void MR_C_std_vector_int64_t_erase(MR_C_std_vector_int64_t *_this, size_t position)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).erase(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).begin() + ptrdiff_t(position));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)position)),
        new_elem
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).erase(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)position))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)position)),
        new_elem
    );
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR_C_int64_t>::const_iterator *)(iter));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_begin_mut(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).begin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).begin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR_C_int64_t>::iterator *)(iter));
}

MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_end(const MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR_C_int64_t>::const_iterator *)(iter));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_end_mut(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t> *)(_this)).end());
}

bool MR_C_std_vector_int64_t_is_end_mut(const MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).end() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR_C_int64_t>::iterator *)(iter));
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).cbegin();
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t> *)(_this)).begin();
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(std::vector<MR_C_int64_t>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)other))
    );
}
...
MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_const_iterator_from_mutable(const MR_C_std_vector_int64_t_iterator *iter)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(std::vector<MR_C_int64_t>::iterator(
        ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)iter))
    ));
}
...
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator(std::vector<MR_C_int64_t>::iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t>::const_iterator *)(_this)));
}

void MR_C_std_vector_int64_t_const_iterator_incr(MR_C_std_vector_int64_t_const_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::const_iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::const_iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)b));
}

MR_C_int64_t *MR_C_std_vector_int64_t_iterator_deref(const MR_C_std_vector_int64_t_iterator *_this)
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR_C_int64_t>::iterator *)(_this)));
}

void MR_C_std_vector_int64_t_iterator_incr(MR_C_std_vector_int64_t_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR_C_int64_t>::iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)b));
}
