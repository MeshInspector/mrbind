...
{
    MRBINDC_CLASSARG_GUARD(other, std::set<int>);
    return (MR_C_std_set_int *)new std::set<int>(std::set<int>(
...
{
    MRBINDC_CLASSARG_GUARD(other, std::set<int>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::set<int>) MRBINDC_CLASSARG_COPY(other, (std::set<int>), std::set<int>) MRBINDC_CLASSARG_MOVE(other, (std::set<int>), std::set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::set<int>) MRBINDC_CLASSARG_END(other, std::set<int>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int> *)(_this)) = std::set<int>(ptr, ptr + size);
}

size_t MR_C_std_set_int_size(const MR_C_std_set_int *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).size();
}

bool MR_C_std_set_int_empty(const MR_C_std_set_int *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).empty();
}

void MR_C_std_set_int_clear(MR_C_std_set_int *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int> *)(_this)).clear();
}

bool MR_C_std_set_int_contains(const MR_C_std_set_int *_this, const int *key)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).contains(
...
{
    return (MR_C_std_set_int_const_iterator *)new std::set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_std_set_int_const_iterator *)new std::set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).cbegin());
}

bool MR_C_std_set_int_is_begin(const MR_C_std_set_int *_this, const MR_C_std_set_int_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::set<int>::const_iterator *)(iter));
}

MR_C_std_set_int_const_iterator *MR_C_std_set_int_end(const MR_C_std_set_int *_this)
{
    return (MR_C_std_set_int_const_iterator *)new std::set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).cend());
}

bool MR_C_std_set_int_is_end(const MR_C_std_set_int *_this, const MR_C_std_set_int_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::set<int>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_set_int_const_iterator *)new std::set<int>::const_iterator(std::set<int>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::set<int>::const_iterator *)(_this)));
}

void MR_C_std_set_int_const_iterator_incr(MR_C_std_set_int_const_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::set<int>::const_iterator *)(_this));
}
...
bool MR_C_equal_MR_C_std_set_int_const_iterator(const MR_C_std_set_int_const_iterator *a, const MR_C_std_set_int_const_iterator *b)
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)b));
}
