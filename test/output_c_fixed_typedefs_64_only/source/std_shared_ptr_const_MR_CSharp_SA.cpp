...
{
    return bool(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this)));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)).reset();
}
...
MR_C_std_shared_ptr_const_MR_CSharp_SA *MR_C_std_shared_ptr_const_MR_CSharp_SA_ConstructFromValue(const MR_CSharp_SA *value)
{
    return (MR_C_std_shared_ptr_const_MR_CSharp_SA *)new std::shared_ptr<const MR::CSharp::SA>(std::make_shared<const MR::CSharp::SA>(
        ((value ? void() : throw std::runtime_error("Parameter `value` can not be null.")), MR::CSharp::SA(*(MR::CSharp::SA *)value))
    ));
}
...
{
    return (MR_C_std_shared_ptr_const_void *)new std::shared_ptr<const void>(std::shared_ptr<const void>(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this))));
}
...
{
    ((_target ? void() : throw std::runtime_error("Parameter `_target` can not be null.")), *(std::shared_ptr<const void> *)(_target)) = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this));
}
