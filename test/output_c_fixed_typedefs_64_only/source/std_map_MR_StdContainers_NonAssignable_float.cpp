...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).size();
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).empty();
}

void MR_C_std_map_MR_StdContainers_NonAssignable_float_clear(MR_C_std_map_MR_StdContainers_NonAssignable_float *_this)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).clear();
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).contains(
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).find(
        ((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *(const MR::StdContainers::NonAssignable *)(key))
    ));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).find(
        ((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *(const MR::StdContainers::NonAssignable *)(key))
    ));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).cbegin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).begin());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).begin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::iterator *)(iter));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).cend());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).cend() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).end());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float> *)(_this)).end() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::iterator *)(iter));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::const_iterator(std::map<MR::StdContainers::NonAssignable, float>::const_iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)other))
    );
}
...
MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator_from_mutable(const MR_C_std_map_MR_StdContainers_NonAssignable_float_iterator *iter)
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::const_iterator(std::map<MR::StdContainers::NonAssignable, float>::iterator(
        ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::iterator(*(std::map<MR::StdContainers::NonAssignable, float>::iterator *)iter))
    ));
}
...
{
    return (MR_C_std_map_MR_StdContainers_NonAssignable_float_iterator *)new std::map<MR::StdContainers::NonAssignable, float>::iterator(std::map<MR::StdContainers::NonAssignable, float>::iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::iterator(*(std::map<MR::StdContainers::NonAssignable, float>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float>::iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::iterator(*(std::map<MR::StdContainers::NonAssignable, float>::iterator *)other))
    );
}
...
{
    return (const MR_C_std_pair_const_MR_StdContainers_NonAssignable_float *)std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::map<MR::StdContainers::NonAssignable, float>::const_iterator *)b));
}
...
{
    return (MR_C_std_pair_const_MR_StdContainers_NonAssignable_float *)std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::iterator *)(_this)));
}
...
{
    ++((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float>::iterator *)(_this));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::iterator(*(std::map<MR::StdContainers::NonAssignable, float>::iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::map<MR::StdContainers::NonAssignable, float>::iterator(*(std::map<MR::StdContainers::NonAssignable, float>::iterator *)b));
}
