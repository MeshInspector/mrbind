...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::parallel_node_hash_set<int>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::parallel_node_hash_set<int>) MRBINDC_CLASSARG_COPY(other, (phmap::parallel_node_hash_set<int>), phmap::parallel_node_hash_set<int>) MRBINDC_CLASSARG_MOVE(other, (phmap::parallel_node_hash_set<int>), phmap::parallel_node_hash_set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::parallel_node_hash_set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::parallel_node_hash_set<int>) MRBINDC_CLASSARG_END(other, phmap::parallel_node_hash_set<int>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int> *)(_this)) = phmap::parallel_node_hash_set<int>(ptr, ptr + size);
}

size_t MR_C_phmap_parallel_node_hash_set_int_size(const MR_C_phmap_parallel_node_hash_set_int *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).size();
}

bool MR_C_phmap_parallel_node_hash_set_int_empty(const MR_C_phmap_parallel_node_hash_set_int *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).empty();
}

void MR_C_phmap_parallel_node_hash_set_int_clear(MR_C_phmap_parallel_node_hash_set_int *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int> *)(_this)).clear();
}

bool MR_C_phmap_parallel_node_hash_set_int_contains(const MR_C_phmap_parallel_node_hash_set_int *_this, const int *key)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).contains(
...
{
    return (MR_C_phmap_parallel_node_hash_set_int_const_iterator *)new phmap::parallel_node_hash_set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_parallel_node_hash_set_int_const_iterator *)new phmap::parallel_node_hash_set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const phmap::parallel_node_hash_set<int>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_parallel_node_hash_set_int_const_iterator *)new phmap::parallel_node_hash_set<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const phmap::parallel_node_hash_set<int>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_parallel_node_hash_set_int_const_iterator *)new phmap::parallel_node_hash_set<int>::const_iterator(phmap::parallel_node_hash_set<int>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), phmap::parallel_node_hash_set<int>::const_iterator(*(phmap::parallel_node_hash_set<int>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), phmap::parallel_node_hash_set<int>::const_iterator(*(phmap::parallel_node_hash_set<int>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::parallel_node_hash_set<int>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::parallel_node_hash_set<int>::const_iterator *)(_this));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), phmap::parallel_node_hash_set<int>::const_iterator(*(phmap::parallel_node_hash_set<int>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), phmap::parallel_node_hash_set<int>::const_iterator(*(phmap::parallel_node_hash_set<int>::const_iterator *)b));
}
