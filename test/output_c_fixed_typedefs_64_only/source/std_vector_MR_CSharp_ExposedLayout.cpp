...
{
    MRBINDC_CLASSARG_GUARD(other, std::vector<MR::CSharp::ExposedLayout>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<MR::CSharp::ExposedLayout>) MRBINDC_CLASSARG_COPY(other, (std::vector<MR::CSharp::ExposedLayout>), std::vector<MR::CSharp::ExposedLayout>) MRBINDC_CLASSARG_MOVE(other, (std::vector<MR::CSharp::ExposedLayout>), std::vector<MR::CSharp::ExposedLayout>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<MR::CSharp::ExposedLayout>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<MR::CSharp::ExposedLayout>) MRBINDC_CLASSARG_END(other, std::vector<MR::CSharp::ExposedLayout>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)) = std::vector<MR::CSharp::ExposedLayout>(((const MR::CSharp::ExposedLayout *)ptr), ((const MR::CSharp::ExposedLayout *)ptr) + size);
}

size_t MR_C_std_vector_MR_CSharp_ExposedLayout_size(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).size();
}

bool MR_C_std_vector_MR_CSharp_ExposedLayout_empty(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).empty();
}

void MR_C_std_vector_MR_CSharp_ExposedLayout_resize(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, size_t new_size)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).resize(
        new_size
    );
}
...
void MR_C_std_vector_MR_CSharp_ExposedLayout_resize_with_default_value(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, size_t new_size, const MR_CSharp_ExposedLayout *value)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).resize(
        new_size,
        ((value ? void() : MRBINDC_THROW("Parameter `value` can not be null.", void)), *(const MR::CSharp::ExposedLayout *)(value))
    );
}

void MR_C_std_vector_MR_CSharp_ExposedLayout_clear(MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).clear();
}

size_t MR_C_std_vector_MR_CSharp_ExposedLayout_capacity(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).capacity();
}

void MR_C_std_vector_MR_CSharp_ExposedLayout_reserve(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, size_t new_capacity)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).reserve(
        new_capacity
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).shrink_to_fit();
}
...
{
    return (const MR_CSharp_ExposedLayout *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).at(
        i
    ));
}
...
{
    return (MR_CSharp_ExposedLayout *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).at(
        i
    ));
}
...
{
    return (const MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).front());
}

MR_CSharp_ExposedLayout *MR_C_std_vector_MR_CSharp_ExposedLayout_front_mut(MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return (MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).front());
}
...
{
    return (const MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).back());
}

MR_CSharp_ExposedLayout *MR_C_std_vector_MR_CSharp_ExposedLayout_back_mut(MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return (MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).empty() ? nullptr : &((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).back());
}
...
{
    return (const MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).data());
}

MR_CSharp_ExposedLayout *MR_C_std_vector_MR_CSharp_ExposedLayout_data_mut(MR_C_std_vector_MR_CSharp_ExposedLayout *_this)
{
    return (MR_CSharp_ExposedLayout *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).data());
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).push_back(
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).pop_back();
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).insert(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).begin() + ptrdiff_t(position), MRBINDC_BIT_CAST((MR::CSharp::ExposedLayout), new_elem));
}

void MR_C_std_vector_MR_CSharp_ExposedLayout_erase(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, size_t position)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).erase(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).begin() + ptrdiff_t(position));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)position)),
        MRBINDC_BIT_CAST((MR::CSharp::ExposedLayout), new_elem)
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).erase(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)position))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).insert(
        ((position ? void() : MRBINDC_THROW("Parameter `position` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)position)),
        MRBINDC_BIT_CAST((MR::CSharp::ExposedLayout), new_elem)
    );
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *)new std::vector<MR::CSharp::ExposedLayout>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *)new std::vector<MR::CSharp::ExposedLayout>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).begin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).begin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::iterator *)(iter));
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *)new std::vector<MR::CSharp::ExposedLayout>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *)new std::vector<MR::CSharp::ExposedLayout>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout> *)(_this)).end());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).end() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::iterator *)(iter));
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).cbegin();
}
...
{
    return ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)iter)) - ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout> *)(_this)).begin();
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *)new std::vector<MR::CSharp::ExposedLayout>::const_iterator(std::vector<MR::CSharp::ExposedLayout>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)other))
    );
}
...
MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator_from_mutable(const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *iter)
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *)new std::vector<MR::CSharp::ExposedLayout>::const_iterator(std::vector<MR::CSharp::ExposedLayout>::iterator(
        ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)iter))
    ));
}
...
{
    return (MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *)new std::vector<MR::CSharp::ExposedLayout>::iterator(std::vector<MR::CSharp::ExposedLayout>::iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)other))
    );
}
...
{
    return (const MR_CSharp_ExposedLayout *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::const_iterator(*(std::vector<MR::CSharp::ExposedLayout>::const_iterator *)b));
}
...
{
    return (MR_CSharp_ExposedLayout *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::vector<MR::CSharp::ExposedLayout>::iterator *)(_this)));
}

void MR_C_std_vector_MR_CSharp_ExposedLayout_iterator_incr(MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::iterator *)(_this));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::vector<MR::CSharp::ExposedLayout>::iterator *)(_this)) += delta;
}
...
{
    return ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)b)) - ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)a));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::vector<MR::CSharp::ExposedLayout>::iterator(*(std::vector<MR::CSharp::ExposedLayout>::iterator *)b));
}
