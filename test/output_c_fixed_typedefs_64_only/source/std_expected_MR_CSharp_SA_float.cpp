...
const MR_CSharp_SA *MR_C_std_expected_MR_CSharp_SA_float_GetValue(const MR_C_std_expected_MR_CSharp_SA_float *_this)
{
...
const float *MR_C_std_expected_MR_CSharp_SA_float_GetError(const MR_C_std_expected_MR_CSharp_SA_float *_this)
{
    auto &_self = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::expected<MR::CSharp::SA, float> *)(_this));
    return _self ? nullptr : &_self.error();
}

MR_CSharp_SA *MR_C_std_expected_MR_CSharp_SA_float_GetMutableValue(MR_C_std_expected_MR_CSharp_SA_float *_this)
{
...
float *MR_C_std_expected_MR_CSharp_SA_float_GetMutableError(MR_C_std_expected_MR_CSharp_SA_float *_this)
{
    auto &_self = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::expected<MR::CSharp::SA, float> *)(_this));
    return _self ? nullptr : &_self.error();
}
