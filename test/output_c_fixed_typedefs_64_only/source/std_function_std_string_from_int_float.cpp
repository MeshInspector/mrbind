...
MR_C_std_function_std_string_from_int_float *MR_C_std_function_std_string_from_int_float_ConstructStateless(const char *(*func)(const char **_return_end, int _1, float _2))
{
