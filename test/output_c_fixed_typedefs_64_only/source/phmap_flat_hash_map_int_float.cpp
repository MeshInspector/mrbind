...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::flat_hash_map<int, float> *)(_this))[((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *key)]);
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::flat_hash_map<int, float> *)(_this)).begin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::flat_hash_map<int, float>::iterator *)(iter));
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::flat_hash_map<int, float> *)(_this)).end() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::flat_hash_map<int, float>::iterator *)(iter));
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int, float>::const_iterator *)(_this))->first);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int, float>::const_iterator *)(_this))->second);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int, float>::iterator *)(_this))->first);
}

float *MR_C_phmap_flat_hash_map_int_float_iterator_DerefValue(const MR_C_phmap_flat_hash_map_int_float_iterator *_this)
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int, float>::iterator *)(_this))->second);
}
