    ...
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_ParallelFlatHashSet_Int : MR.CS.Misc.Object<Const_ParallelFlatHashSet_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                public unsafe Const_ParallelFlatHashSet_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    ...
                    extern static MR.CS.Phmap.ParallelFlatHashSet_Int._Underlying *__MR_C_phmap_parallel_flat_hash_set_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe nuint Size()
                {
                    ...
                    extern static nuint __MR_C_phmap_parallel_flat_hash_set_int_size(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
            ...
            public class ParallelFlatHashSet_Int : Const_ParallelFlatHashSet_Int
            {
                ...
                /// Construct from a range of elements.
                public unsafe ParallelFlatHashSet_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_parallel_flat_hash_set_int_ConstructFromRange", ExactSpelling = true)]
                    extern static MR.CS.Phmap.ParallelFlatHashSet_Int._Underlying *__MR_C_phmap_parallel_flat_hash_set_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe void Assign(int? ptr, nuint size)
                {
                    ...
                    extern static void __MR_C_phmap_parallel_flat_hash_set_int_AssignFromRange(_Underlying *_this, int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                    int __deref_ptr = ptr.GetValueOrDefault();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
