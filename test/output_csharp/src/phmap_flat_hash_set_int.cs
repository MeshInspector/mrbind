public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_FlatHashSet_Int : MR.CS.Misc.Object<Const_FlatHashSet_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                {
                    Const_FlatHashSet_Int _container;
                    MR.CS.Phmap.FlatHashSet_Int.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_FlatHashSet_Int container)
                    {
                ...
                public unsafe ulong Size()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool Contains(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_contains(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.FlatHashSet_Int.ConstIterator Find(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_find(_UnderlyingPtr, &key);
                ...
                public unsafe MR.CS.Phmap.FlatHashSet_Int.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_begin(_UnderlyingPtr);
                    MR.CS.Phmap.FlatHashSet_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsBegin(MR.CS.Phmap.FlatHashSet_Int.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.FlatHashSet_Int.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_end(_UnderlyingPtr);
                    MR.CS.Phmap.FlatHashSet_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Phmap.FlatHashSet_Int.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_flat_hash_set_int_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe int Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_flat_hash_set_int_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_phmap_flat_hash_set_int_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
