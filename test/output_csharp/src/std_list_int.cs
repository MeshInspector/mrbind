        ...
        public static partial class Std
        {
            ...
            public class Const_List_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public class _InOptConst_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator _InOptConst_ConstIterator(MR.CS.Std.List_Int.Const_Iterator iter) {return new MR.CS.Std.List_Int.ConstIterator(iter);}
                }
            ...
            public class List_Int : Const_List_Int
            {
                ...
                public unsafe MR.CS.Std.List_Int.Iterator MutableBegin()
                {
                ...
                public unsafe bool IsMutableBegin(MR.CS.Std.List_Int.Const_Iterator iter)
                {
                ...
                public unsafe MR.CS.Std.List_Int.Iterator MutableEnd()
                {
                ...
                public unsafe bool IsMutableEnd(MR.CS.Std.List_Int.Const_Iterator iter)
                {
