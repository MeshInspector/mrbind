        ...
        public static partial class Std
        {
            ...
            public class Const_UnorderedMultiset_Int : MR.CS.Misc.Object<Const_UnorderedMultiset_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                public unsafe Const_UnorderedMultiset_Int(int? ptr, ulong size) : this(null, is_owning: true)
                {
                    ...
                    extern static MR.CS.Std.UnorderedMultiset_Int._Underlying *__MR_C_std_unordered_multiset_int_ConstructFromRange(int *ptr, ulong size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe ulong Size()
                {
                    ...
                    extern static ulong __MR_C_std_unordered_multiset_int_size(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe ulong Count(int key)
                {
                    ...
                    extern static ulong __MR_C_std_unordered_multiset_int_count(_Underlying *_this, int *key);
                    MR.CS.Misc._Exceptions.Prepare();
            ...
            public class UnorderedMultiset_Int : Const_UnorderedMultiset_Int
            {
                ...
                public unsafe void Assign(int? ptr, ulong size)
                {
                    ...
                    extern static void __MR_C_std_unordered_multiset_int_AssignFromRange(_Underlying *_this, int *ptr, ulong size);
                    MR.CS.Misc._Exceptions.Prepare();
                    int __deref_ptr = ptr.GetValueOrDefault();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
