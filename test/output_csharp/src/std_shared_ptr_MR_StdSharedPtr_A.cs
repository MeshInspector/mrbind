public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_MRStdSharedPtrA : MR.CS.Misc.Object<Const_SharedPtr_MRStdSharedPtrA>, System.IDisposable
            {
                ...
                ~Const_SharedPtr_MRStdSharedPtrA() {Dispose(false);}

                internal unsafe Const_SharedPtr_MRStdSharedPtrA(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA other) : this(new _ByValue_SharedPtr_MRStdSharedPtrA(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_MRStdSharedPtrA(SharedPtr_MRStdSharedPtrA other) : this((Const_SharedPtr_MRStdSharedPtrA)other) {}
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_SharedPtr_MRStdSharedPtrA _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_MR_StdSharedPtr_A_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe int UseCount()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_MR_StdSharedPtr_A_use_count(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                /// Construct from a value.
                public static unsafe implicit operator Const_SharedPtr_MRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new(value);}
                ...
                public static unsafe implicit operator MR.CS.Std.SharedPtr_Void(MR.CS.Std.Const_SharedPtr_MRStdSharedPtrA _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_MR_StdSharedPtr_A_ConvertTo_MR_C_std_shared_ptr_void(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            public class SharedPtr_MRStdSharedPtrA : Const_SharedPtr_MRStdSharedPtrA
            {
                internal unsafe SharedPtr_MRStdSharedPtrA(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA other) : this(new _ByValue_SharedPtr_MRStdSharedPtrA(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_MRStdSharedPtrA(SharedPtr_MRStdSharedPtrA other) : this((Const_SharedPtr_MRStdSharedPtrA)other) {}
                ...
                /// Construct from a value.
                public static unsafe implicit operator SharedPtr_MRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new(value);}
            ...
            /// This is used as a function parameter when the underlying function receives `SharedPtr_MRStdSharedPtrA` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `SharedPtr_MRStdSharedPtrA`/`Const_SharedPtr_MRStdSharedPtrA` to copy it into the function.
            /// * Pass `Move(instance)` to move it into the function. This is a more efficient form of copying that might invalidate the input object.
            ///   Be careful if your input isn't a unique reference to this object.
            /// * Pass `null` to use the default argument, assuming the parameter has a default argument (has `?` in the type).
            public class _ByValue_SharedPtr_MRStdSharedPtrA
            {
                #pragma warning disable CS0649
                internal readonly Const_SharedPtr_MRStdSharedPtrA? Value;
                #pragma warning restore CS0649
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_SharedPtr_MRStdSharedPtrA() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA arg) {return new(arg);}
                public _ByValue_SharedPtr_MRStdSharedPtrA(MR.CS.Misc._Moved<SharedPtr_MRStdSharedPtrA> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_SharedPtr_MRStdSharedPtrA(MR.CS.Misc._Moved<SharedPtr_MRStdSharedPtrA> arg) {return new(arg);}

                /// Construct from a value.
                public static unsafe implicit operator _ByValue_SharedPtr_MRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new MR.CS.Misc._Moved<MR.CS.Std.SharedPtr_MRStdSharedPtrA>(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_MRStdSharedPtrA` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_SharedPtr_MRStdSharedPtrA`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_MRStdSharedPtrA`/`Const_SharedPtr_MRStdSharedPtrA` directly.
            public class _InOptMut_SharedPtr_MRStdSharedPtrA
            {
                public SharedPtr_MRStdSharedPtrA? Opt;

                public _InOptMut_SharedPtr_MRStdSharedPtrA() {}
                public _InOptMut_SharedPtr_MRStdSharedPtrA(SharedPtr_MRStdSharedPtrA value) {Opt = value;}
                public static implicit operator _InOptMut_SharedPtr_MRStdSharedPtrA(SharedPtr_MRStdSharedPtrA value) {return new(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_MRStdSharedPtrA` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_SharedPtr_MRStdSharedPtrA`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_MRStdSharedPtrA`/`Const_SharedPtr_MRStdSharedPtrA` to pass it to the function.
            public class _InOptConst_SharedPtr_MRStdSharedPtrA
            {
                public Const_SharedPtr_MRStdSharedPtrA? Opt;

                public _InOptConst_SharedPtr_MRStdSharedPtrA() {}
                public _InOptConst_SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA value) {Opt = value;}
                public static implicit operator _InOptConst_SharedPtr_MRStdSharedPtrA(Const_SharedPtr_MRStdSharedPtrA value) {return new(value);}

                /// Construct from a value.
                public static unsafe implicit operator _InOptConst_SharedPtr_MRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new Const_SharedPtr_MRStdSharedPtrA(value);}
            }
        }
    }
}
