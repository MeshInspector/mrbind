public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_IntArray : MR.CS.Misc.Object, System.IDisposable
            {
                internal struct _Underlying {} // Represents the underlying C++ type.

                internal unsafe _Underlying *_UnderlyingPtr;

                internal unsafe Const_SharedPtr_IntArray(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                ~Const_SharedPtr_IntArray() {Dispose(false);}
                ...
                public unsafe MR.CS.Misc.Ref<int>? Get()
                {
                    ...
                    var __ret = __MR_C_std_shared_ptr_int_array_Get(_UnderlyingPtr);
                ...
                public unsafe ref int At(long i)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_array_At", ExactSpelling = true)]
                    extern static int *__MR_C_std_shared_ptr_int_array_At(_Underlying *_this, long i);
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_array_UseCount", ExactSpelling = true)]
                    extern static int __MR_C_std_shared_ptr_int_array_UseCount(_Underlying *_this);
                    return __MR_C_std_shared_ptr_int_array_UseCount(_UnderlyingPtr);
                }

                /// Create a new instance, taking ownership of an existing pointer.
                public unsafe Const_SharedPtr_IntArray(void *ptr) : this(null, is_owning: true)
                {
                ...
                public unsafe Const_SharedPtr_IntArray(MR.CS.Misc.InOut<int>? ptr) : this(null, is_owning: true)
                {
                ...
                public unsafe Const_SharedPtr_IntArray(MR.CS.Std._ByValue_SharedPtr_ConstVoid ownership, MR.CS.Misc.InOut<int>? ptr) : this(null, is_owning: true)
                {
            ...
            public class SharedPtr_IntArray : Const_SharedPtr_IntArray
            {
                internal unsafe SharedPtr_IntArray(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Create a new instance, taking ownership of an existing pointer.
                public unsafe SharedPtr_IntArray(void *ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_array_Construct", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_IntArray._Underlying *__MR_C_std_shared_ptr_int_array_Construct(void *ptr);
                    _UnderlyingPtr = __MR_C_std_shared_ptr_int_array_Construct(ptr);
                ...
                /// Create a new instance, storing a non-owning pointer.
                public unsafe SharedPtr_IntArray(MR.CS.Misc.InOut<int>? ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_array_ConstructNonOwning", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_IntArray._Underlying *__MR_C_std_shared_ptr_int_array_ConstructNonOwning(int *ptr);
                    int __value_ptr = ptr is not null ? ptr.Value : default(int);
                ...
                public unsafe void Assign(MR.CS.Misc.InOut<int>? ptr)
                {
                    ...
                    int __value_ptr = ptr is not null ? ptr.Value : default(int);
                    __MR_C_std_shared_ptr_int_array_AssignNonOwning(_UnderlyingPtr, ptr is not null ? &__value_ptr : null);
                    if (ptr is not null) ptr.Value = __value_ptr;
                }

                /// The aliasing constructor. Create a new instance, copying ownership from an existing shared pointer and storing an arbitrary raw pointer.
                /// The input pointer can be reinterpreted from any other `std::shared_ptr<T>` to avoid constructing a new `std::shared_ptr<void>`.
                public unsafe SharedPtr_IntArray(MR.CS.Std._ByValue_SharedPtr_ConstVoid ownership, MR.CS.Misc.InOut<int>? ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_array_ConstructAliasing", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_IntArray._Underlying *__MR_C_std_shared_ptr_int_array_ConstructAliasing(MR.CS.Misc._PassBy ownership_pass_by, MR.CS.Std.SharedPtr_ConstVoid._Underlying *ownership, int *ptr);
                    int __value_ptr = ptr is not null ? ptr.Value : default(int);
            ...
            /// * Pass an instance of `SharedPtr_IntArray`/`Const_SharedPtr_IntArray` to copy it into the function.
            /// * Pass `Move(instance)` to move it into the function. This is a more efficient form of copying that might invalidate the input object.
            ///   Be careful if your input isn't a unique reference to this object.
            /// * Pass `null` to use the default argument, assuming the parameter has a default argument (has `?` in the type).
            public class _ByValue_SharedPtr_IntArray
            {
                internal readonly Const_SharedPtr_IntArray? Value;
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_SharedPtr_IntArray() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_SharedPtr_IntArray(Const_SharedPtr_IntArray new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_SharedPtr_IntArray(Const_SharedPtr_IntArray arg) {return new(arg);}
                public _ByValue_SharedPtr_IntArray(MR.CS.Misc._Moved<SharedPtr_IntArray> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_SharedPtr_IntArray(MR.CS.Misc._Moved<SharedPtr_IntArray> arg) {return new(arg);}
            }

            /// This is used for optional parameters of class `SharedPtr_IntArray` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_SharedPtr_IntArray`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_IntArray`/`Const_SharedPtr_IntArray` directly.
            public class _InOptMut_SharedPtr_IntArray
            {
                public SharedPtr_IntArray? Opt;

                public _InOptMut_SharedPtr_IntArray() {}
                public _InOptMut_SharedPtr_IntArray(SharedPtr_IntArray value) {Opt = value;}
                public static implicit operator _InOptMut_SharedPtr_IntArray(SharedPtr_IntArray value) {return new(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_IntArray` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_SharedPtr_IntArray`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_IntArray`/`Const_SharedPtr_IntArray` to pass it to the function.
            public class _InOptConst_SharedPtr_IntArray
            {
                public Const_SharedPtr_IntArray? Opt;

                public _InOptConst_SharedPtr_IntArray() {}
                public _InOptConst_SharedPtr_IntArray(Const_SharedPtr_IntArray value) {Opt = value;}
                public static implicit operator _InOptConst_SharedPtr_IntArray(Const_SharedPtr_IntArray value) {return new(value);}
            }
        }
    }
}
