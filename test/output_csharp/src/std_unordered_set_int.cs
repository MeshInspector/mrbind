public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_UnorderedSet_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.Std.UnorderedSet_Int.ConstIterator Find(int key)
                {
                    ...
                    return new(__MR_C_std_unordered_set_int_Find(_UnderlyingPtr, &key), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.UnorderedSet_Int.ConstIterator Begin()
                {
                    ...
                    return new(__MR_C_std_unordered_set_int_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.UnorderedSet_Int.ConstIterator End()
                {
                    ...
                    return new(__MR_C_std_unordered_set_int_End(_UnderlyingPtr), is_owning: true);
                }
