public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE : MR.CS.Misc.Object<Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE>, System.IDisposable
            {
                ...
                ~Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE() {Dispose(false);}

                internal unsafe Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_function_MR_StdFunction_E_from_int_MR_StdFunction_E_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.StdFunction.E Call(int _1, MR.CS.StdFunction.E _2)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_function_MR_StdFunction_E_from_int_MR_StdFunction_E_call(_UnderlyingPtr, _1, _2);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public static unsafe implicit operator Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE(MR.CS.Std.Function_MRStdFunctionE_From_Int_MRStdFunctionE.Delegate func) {return new(func);}
            }

            /// Stores a functor of type: `MR::StdFunction::E(int, MR::StdFunction::E)`. Possibly stateful.
            /// This is the non-const half of the class.
            public class Function_MRStdFunctionE_From_Int_MRStdFunctionE : Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE
            {
                internal unsafe Function_MRStdFunctionE_From_Int_MRStdFunctionE(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Construct from a delegate.
                public unsafe Function_MRStdFunctionE_From_Int_MRStdFunctionE(Delegate func) : base(func) {}
            ...
            /// This is used as a function parameter when the underlying function receives `Function_MRStdFunctionE_From_Int_MRStdFunctionE` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `Function_MRStdFunctionE_From_Int_MRStdFunctionE`/`Const_Function_MRStdFunctionE_From_Int_MRStdFunctionE` to copy it into the function.
