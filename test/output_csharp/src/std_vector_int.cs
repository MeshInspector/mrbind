    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Vector_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe long MutableToIndex(MR.CS.Std.Vector_Int.Const_Iterator iter)
                {
                ...
                public class _InOptConst_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator _InOptConst_ConstIterator(MR.CS.Std.Vector_Int.Const_Iterator iter) {return new MR.CS.Std.Vector_Int.ConstIterator(iter);}
                }
            ...
            public class Vector_Int : Const_Vector_Int
            {
                ...
                public unsafe MR.CS.Std.Vector_Int.Iterator MutableBegin()
                {
                ...
                public unsafe bool IsMutableBegin(MR.CS.Std.Vector_Int.Const_Iterator iter)
                {
                ...
                public unsafe MR.CS.Std.Vector_Int.Iterator MutableEnd()
                {
                ...
                public unsafe bool IsMutableEnd(MR.CS.Std.Vector_Int.Const_Iterator iter)
                {
