        ...
        public static partial class Std
        {
            ...
            public class Const_Function_Void_From_StdString : MR.CS.Misc.Object<Const_Function_Void_From_StdString>, System.IDisposable
            {
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_Function_Void_From_StdString _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_function_void_from_std_string_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }

                /// Calls the stored callable.
                public unsafe void Call(string _1)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_function_void_from_std_string_call", ExactSpelling = true)]
                    extern static void __MR_C_std_function_void_from_std_string_call(_Underlying *_this, byte *_1, byte *_1_end);
                    byte[] __bytes__1 = System.Text.Encoding.UTF8.GetBytes(_1);
                    fixed (byte *__ptr__1 = __bytes__1)
                    {
                        MR.CS.Misc._Exceptions.Prepare();
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        __MR_C_std_function_void_from_std_string_call(_UnderlyingPtr, __ptr__1, __ptr__1 + __bytes__1.Length);
                    }
                }
                ...
                private protected static unsafe void _CCallWrapper(MR.CS.Std.String._Underlying *_1, void *_userdata, void **_cleanup_value)
                {
                    try
                    {
                ...
                public static unsafe implicit operator Const_Function_Void_From_StdString(MR.CS.Std.Function_Void_From_StdString.Delegate func) {return new(func);}
            }
