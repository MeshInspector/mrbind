public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Vector_ConstMRCSharpAPtr : MR.CS.Misc.Object<Const_Vector_ConstMRCSharpAPtr>, System.IDisposable
            {
                ...
                ~Const_Vector_ConstMRCSharpAPtr() {Dispose(false);}

                internal unsafe Const_Vector_ConstMRCSharpAPtr(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_Vector_ConstMRCSharpAPtr(Const_Vector_ConstMRCSharpAPtr other) : this(new _ByValue_Vector_ConstMRCSharpAPtr(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_Vector_ConstMRCSharpAPtr(Vector_ConstMRCSharpAPtr other) : this((Const_Vector_ConstMRCSharpAPtr)other) {}
                ...
                public unsafe ulong Size()
                {
                    ...
                    extern static ulong __MR_C_std_vector_const_MR_CSharp_A_ptr_size(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe ulong Capacity()
                {
                    ...
                    extern static ulong __MR_C_std_vector_const_MR_CSharp_A_ptr_capacity(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_capacity(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe ref readonly void *this[ulong i]
                {
                    get
                    {
                        ...
                        extern static void **__MR_C_std_vector_const_MR_CSharp_A_ptr_at(_Underlying *_this, ulong i);
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_at(_UnderlyingPtr, i);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return ref *__c_ret;
                    }
                }
                ...
                public unsafe void **Front()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_front(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe void **Back()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_back(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe MR.CS.Std.Vector_ConstMRCSharpAPtr.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_begin(_UnderlyingPtr);
                ...
                public unsafe bool IsBegin(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsBegin(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_is_begin_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Std.Vector_ConstMRCSharpAPtr.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_end(_UnderlyingPtr);
                    MR.CS.Std.Vector_ConstMRCSharpAPtr.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsEnd(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_is_end_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }

                /// Convert a const iterator to an index.
                public unsafe long ToIndex(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_ConstIterator iter)
                {
                    ...
                    extern static long __MR_C_std_vector_const_MR_CSharp_A_ptr_to_index(_Underlying *_this, MR.CS.Std.Vector_ConstMRCSharpAPtr.ConstIterator._Underlying *iter);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_to_index(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }

                /// Convert a mutable iterator to an index.
                public unsafe long ToIndex(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter)
                {
                    ...
                    extern static long __MR_C_std_vector_const_MR_CSharp_A_ptr_to_index_mut(_Underlying *_this, MR.CS.Std.Vector_ConstMRCSharpAPtr.Iterator._Underlying *iter);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_to_index_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator Const_ConstIterator(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter) {return new(iter);}
                    ...
                    public unsafe ref readonly void *Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return ref *__c_ret;
                    }
                    ...
                    public static unsafe long operator-(Const_ConstIterator a, MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_sub_MR_C_std_vector_const_MR_CSharp_A_ptr_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_vector_const_MR_CSharp_A_ptr_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
                ...
                public class ConstIterator : Const_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator ConstIterator(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter) {return new(iter);}
                    ...
                    public unsafe void AddAssign(long delta)
                    {
                        ...
                        extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_const_iterator_add_assign(_Underlying *_this, long delta);
                        MR.CS.Misc._Exceptions.Prepare();
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public class _InOptConst_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator _InOptConst_ConstIterator(MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator iter) {return new Const_ConstIterator(iter);}
                }
                ...
                public class Const_Iterator : MR.CS.Misc.Object<Const_Iterator>, System.IDisposable, System.IEquatable<Const_Iterator>
                {
                    ...
                    public unsafe ref void *Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return ref *__c_ret;
                    }
                    ...
                    public static unsafe long operator-(Const_Iterator a, MR.CS.Std.Vector_ConstMRCSharpAPtr.Const_Iterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_sub_MR_C_std_vector_const_MR_CSharp_A_ptr_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_Iterator a, Const_Iterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_vector_const_MR_CSharp_A_ptr_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
                ...
                public class Iterator : Const_Iterator
                {
                    ...
                    public unsafe void AddAssign(long delta)
                    {
                        ...
                        extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_iterator_add_assign(_Underlying *_this, long delta);
                        MR.CS.Misc._Exceptions.Prepare();
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            /// Generated from C++ container `std::vector<const MR::CSharp::A *>`.
            /// This is the non-const half of the class.
            public class Vector_ConstMRCSharpAPtr : Const_Vector_ConstMRCSharpAPtr
            {
                internal unsafe Vector_ConstMRCSharpAPtr(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Vector_ConstMRCSharpAPtr(Const_Vector_ConstMRCSharpAPtr other) : this(new _ByValue_Vector_ConstMRCSharpAPtr(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Vector_ConstMRCSharpAPtr(Vector_ConstMRCSharpAPtr other) : this((Const_Vector_ConstMRCSharpAPtr)other) {}
                ...
                public unsafe void Resize(ulong new_size)
                {
                    ...
                    extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_resize(_Underlying *_this, ulong new_size);
                    MR.CS.Misc._Exceptions.Prepare();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe void ResizeWithDefaultValue(ulong new_size, MR.CS.CSharp.Const_A? value)
                {
                    ...
                    extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_resize_with_default_value(_Underlying *_this, ulong new_size, MR.CS.CSharp.Const_A._Underlying *value);
                    MR.CS.Misc._Exceptions.Prepare();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe void Reserve(ulong new_capacity)
                {
                    ...
                    extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_reserve(_Underlying *_this, ulong new_capacity);
                    MR.CS.Misc._Exceptions.Prepare();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe new ref void *this[ulong i]
                {
                    get
                    {
                        ...
                        extern static void **__MR_C_std_vector_const_MR_CSharp_A_ptr_at_mut(_Underlying *_this, ulong i);
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_at_mut(_UnderlyingPtr, i);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return ref *__c_ret;
                    }
                }
                ...
                public unsafe new void **Front()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_front_mut(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe new void **Back()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_back_mut(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe void Insert(ulong position, MR.CS.CSharp.Const_A? new_elem)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_vector_const_MR_CSharp_A_ptr_insert", ExactSpelling = true)]
                    extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_insert(_Underlying *_this, ulong position, MR.CS.CSharp.Const_A._Underlying *new_elem);
                    MR.CS.Misc._Exceptions.Prepare();
                    if (new_elem is not null) _KeepAlive(new_elem);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe void Erase(ulong position)
                {
                    ...
                    extern static void __MR_C_std_vector_const_MR_CSharp_A_ptr_erase(_Underlying *_this, ulong position);
                    MR.CS.Misc._Exceptions.Prepare();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe new MR.CS.Std.Vector_ConstMRCSharpAPtr.Iterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_begin_mut(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Std.Vector_ConstMRCSharpAPtr.Iterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_vector_const_MR_CSharp_A_ptr_end_mut(_UnderlyingPtr);
                    MR.CS.Std.Vector_ConstMRCSharpAPtr.Iterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            /// This is used as a function parameter when the underlying function receives `Vector_ConstMRCSharpAPtr` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `Vector_ConstMRCSharpAPtr`/`Const_Vector_ConstMRCSharpAPtr` to copy it into the function.
            ...
            public class _ByValue_Vector_ConstMRCSharpAPtr
            {
                ...
                public static implicit operator _ByValue_Vector_ConstMRCSharpAPtr(Const_Vector_ConstMRCSharpAPtr arg) {return new(arg);}
                public _ByValue_Vector_ConstMRCSharpAPtr(MR.CS.Misc._Moved<Vector_ConstMRCSharpAPtr> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_Vector_ConstMRCSharpAPtr(MR.CS.Misc._Moved<Vector_ConstMRCSharpAPtr> arg) {return new(arg);}
            }

            /// This is used for optional parameters of class `Vector_ConstMRCSharpAPtr` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_Vector_ConstMRCSharpAPtr`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Vector_ConstMRCSharpAPtr`/`Const_Vector_ConstMRCSharpAPtr` directly.
            public class _InOptMut_Vector_ConstMRCSharpAPtr
            {
                public Vector_ConstMRCSharpAPtr? Opt;

                public _InOptMut_Vector_ConstMRCSharpAPtr() {}
                public _InOptMut_Vector_ConstMRCSharpAPtr(Vector_ConstMRCSharpAPtr value) {Opt = value;}
                public static implicit operator _InOptMut_Vector_ConstMRCSharpAPtr(Vector_ConstMRCSharpAPtr value) {return new(value);}
            }

            /// This is used for optional parameters of class `Vector_ConstMRCSharpAPtr` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_Vector_ConstMRCSharpAPtr`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Vector_ConstMRCSharpAPtr`/`Const_Vector_ConstMRCSharpAPtr` to pass it to the function.
            public class _InOptConst_Vector_ConstMRCSharpAPtr
            {
                public Const_Vector_ConstMRCSharpAPtr? Opt;

                public _InOptConst_Vector_ConstMRCSharpAPtr() {}
                public _InOptConst_Vector_ConstMRCSharpAPtr(Const_Vector_ConstMRCSharpAPtr value) {Opt = value;}
                public static implicit operator _InOptConst_Vector_ConstMRCSharpAPtr(Const_Vector_ConstMRCSharpAPtr value) {return new(value);}
            }
        }
    }
}
