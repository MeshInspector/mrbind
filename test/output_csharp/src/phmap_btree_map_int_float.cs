    ...
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_BtreeMap_Int_Float : MR.CS.Misc.Object<Const_BtreeMap_Int_Float>, System.IDisposable, IEnumerable<MR.CS.Std.Const_Pair_ConstInt_Float>
            {
                ...
                {
                    Const_BtreeMap_Int_Float _container;
                    MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_BtreeMap_Int_Float container)
                    {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_BtreeMap_Int_Float(Const_BtreeMap_Int_Float other) : this(new _ByValue_BtreeMap_Int_Float(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_BtreeMap_Int_Float(BtreeMap_Int_Float other) : this((Const_BtreeMap_Int_Float)other) {}
                ...
                public unsafe ulong Size()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool Contains(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_contains(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator Find(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_find(_UnderlyingPtr, &key);
                ...
                public unsafe MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_begin(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsBegin(MR.CS.Phmap.BtreeMap_Int_Float.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsBegin(MR.CS.Phmap.BtreeMap_Int_Float.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_is_begin_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_end(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMap_Int_Float.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Phmap.BtreeMap_Int_Float.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsEnd(MR.CS.Phmap.BtreeMap_Int_Float.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_is_end_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe MR.CS.Std.Const_Pair_ConstInt_Float Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_const_iterator_deref(_UnderlyingPtr);
                    ...
                    public unsafe int DerefKey()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_const_iterator_deref_key(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public unsafe float DerefValue()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_const_iterator_deref_value(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_phmap_btree_map_int_float_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
                ...
                public class Const_Iterator : MR.CS.Misc.Object<Const_Iterator>, System.IDisposable, System.IEquatable<Const_Iterator>
                {
                    ...
                    public unsafe MR.CS.Std.Pair_ConstInt_Float Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_iterator_deref(_UnderlyingPtr);
                    ...
                    public unsafe int DerefKey()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_iterator_deref_key(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public unsafe ref float DerefValue()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_map_int_float_iterator_deref_value(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return ref *__c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_Iterator a, Const_Iterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_phmap_btree_map_int_float_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            public class BtreeMap_Int_Float : Const_BtreeMap_Int_Float, IEnumerable<MR.CS.Std.Pair_ConstInt_Float>
            {
                ...
                {
                    BtreeMap_Int_Float _container;
                    MR.CS.Phmap.BtreeMap_Int_Float.Iterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(BtreeMap_Int_Float container)
                    {
                        _container = container;
                        _cur = _container.Begin();
                        _done = _cur == _container.End();
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public BtreeMap_Int_Float(Const_BtreeMap_Int_Float other) : this(new _ByValue_BtreeMap_Int_Float(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public BtreeMap_Int_Float(BtreeMap_Int_Float other) : this((Const_BtreeMap_Int_Float)other) {}
                ...
                public unsafe ref float FindOrConstructElem(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_find_or_construct_elem(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return ref *__c_ret;
                }
                ...
                public unsafe new MR.CS.Phmap.BtreeMap_Int_Float.Iterator Find(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_find_mut(_UnderlyingPtr, &key);
                ...
                public unsafe new MR.CS.Phmap.BtreeMap_Int_Float.Iterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_begin_mut(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMap_Int_Float.Iterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe new MR.CS.Phmap.BtreeMap_Int_Float.Iterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_map_int_float_end_mut(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMap_Int_Float.Iterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
