        ...
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_Int : MR.CS.Misc.Object<Const_SharedPtr_Int>, System.IDisposable
            {
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_SharedPtr_Int _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_int_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe int UseCount()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_int_use_count(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                /// Construct from a value.
                public static unsafe implicit operator Const_SharedPtr_Int(int value) {return new(value);}
                ...
                public static unsafe implicit operator MR.CS.Std.SharedPtr_Void(MR.CS.Std.Const_SharedPtr_Int _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_int_ConvertTo_MR_C_std_shared_ptr_void(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            public class SharedPtr_Int : Const_SharedPtr_Int
            {
                ...
                /// Construct from a value.
                public static unsafe implicit operator SharedPtr_Int(int value) {return new(value);}
            ...
            public class _ByValue_SharedPtr_Int
            {
                ...
                /// Construct from a value.
                public static unsafe implicit operator _ByValue_SharedPtr_Int(int value) {return new MR.CS.Misc._Moved<MR.CS.Std.SharedPtr_Int>(value);}
            }
            ...
            public class _InOptConst_SharedPtr_Int
            {
                ...
                /// Construct from a value.
                public static unsafe implicit operator _InOptConst_SharedPtr_Int(int value) {return new Const_SharedPtr_Int(value);}
            }
        }
    }
}
