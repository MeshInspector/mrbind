public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_List_MRStdContainersNonAssignable : MR.CS.Misc.Object<Const_List_MRStdContainersNonAssignable>, System.IDisposable, IEnumerable<MR.CS.StdContainers.Const_NonAssignable>
            {
                ...
                {
                    Const_List_MRStdContainersNonAssignable _container;
                    MR.CS.Std.List_MRStdContainersNonAssignable.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_List_MRStdContainersNonAssignable container)
                    {
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Std.List_MRStdContainersNonAssignable.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_begin(_UnderlyingPtr);
                ...
                public unsafe bool IsBegin(MR.CS.Std.List_MRStdContainersNonAssignable.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsBegin(MR.CS.Std.List_MRStdContainersNonAssignable.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_is_begin_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Std.List_MRStdContainersNonAssignable.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_end(_UnderlyingPtr);
                    MR.CS.Std.List_MRStdContainersNonAssignable.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Std.List_MRStdContainersNonAssignable.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool IsEnd(MR.CS.Std.List_MRStdContainersNonAssignable.Const_Iterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_is_end_mut(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe MR.CS.StdContainers.Const_NonAssignable Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.StdContainers.Const_NonAssignable __ret;
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_list_MR_StdContainers_NonAssignable_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
                ...
                public class Const_Iterator : MR.CS.Misc.Object<Const_Iterator>, System.IDisposable, System.IEquatable<Const_Iterator>
                {
                    ...
                    public unsafe MR.CS.StdContainers.NonAssignable Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_iterator_deref(_UnderlyingPtr);
                    ...
                    public static unsafe bool operator==(Const_Iterator a, Const_Iterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_list_MR_StdContainers_NonAssignable_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            /// Generated from C++ container `std::list<MR::StdContainers::NonAssignable>`.
            /// This is the non-const half of the class.
            public class List_MRStdContainersNonAssignable : Const_List_MRStdContainersNonAssignable, IEnumerable<MR.CS.StdContainers.NonAssignable>
            {
                public new class _Enumerator : IEnumerator<MR.CS.StdContainers.NonAssignable>
                {
                    List_MRStdContainersNonAssignable _container;
                    MR.CS.Std.List_MRStdContainersNonAssignable.Iterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(List_MRStdContainersNonAssignable container)
                    {
                        _container = container;
                        _cur = _container.Begin();
                        _done = _cur == _container.End();
                ...
                public unsafe new MR.CS.Std.List_MRStdContainersNonAssignable.Iterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_begin_mut(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Std.List_MRStdContainersNonAssignable.Iterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_list_MR_StdContainers_NonAssignable_end_mut(_UnderlyingPtr);
                    MR.CS.Std.List_MRStdContainersNonAssignable.Iterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
