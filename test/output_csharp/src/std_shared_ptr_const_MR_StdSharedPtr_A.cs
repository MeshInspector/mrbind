public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstMRStdSharedPtrA : MR.CS.Misc.Object<Const_SharedPtr_ConstMRStdSharedPtrA>, System.IDisposable
            {
                ...
                ~Const_SharedPtr_ConstMRStdSharedPtrA() {Dispose(false);}

                internal unsafe Const_SharedPtr_ConstMRStdSharedPtrA(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA other) : this(new _ByValue_SharedPtr_ConstMRStdSharedPtrA(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_ConstMRStdSharedPtrA(SharedPtr_ConstMRStdSharedPtrA other) : this((Const_SharedPtr_ConstMRStdSharedPtrA)other) {}
                ...
                /// Construct from a value.
                public static unsafe implicit operator Const_SharedPtr_ConstMRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new(value);}
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator Const_SharedPtr_ConstMRStdSharedPtrA(MR.CS.Std._ByValue_SharedPtr_MRStdSharedPtrA ptr) {return new(ptr);}
            ...
            public class SharedPtr_ConstMRStdSharedPtrA : Const_SharedPtr_ConstMRStdSharedPtrA
            {
                internal unsafe SharedPtr_ConstMRStdSharedPtrA(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA other) : this(new _ByValue_SharedPtr_ConstMRStdSharedPtrA(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_ConstMRStdSharedPtrA(SharedPtr_ConstMRStdSharedPtrA other) : this((Const_SharedPtr_ConstMRStdSharedPtrA)other) {}
                ...
                /// Construct from a value.
                public static unsafe implicit operator SharedPtr_ConstMRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new(value);}
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator SharedPtr_ConstMRStdSharedPtrA(MR.CS.Std._ByValue_SharedPtr_MRStdSharedPtrA ptr) {return new(ptr);}
            ...
            /// * Pass an instance of `SharedPtr_ConstMRStdSharedPtrA`/`Const_SharedPtr_ConstMRStdSharedPtrA` to copy it into the function.
            /// * Pass `Move(instance)` to move it into the function. This is a more efficient form of copying that might invalidate the input object.
            ///   Be careful if your input isn't a unique reference to this object.
            /// * Pass `null` to use the default argument, assuming the parameter has a default argument (has `?` in the type).
            public class _ByValue_SharedPtr_ConstMRStdSharedPtrA
            {
                #pragma warning disable CS0649
                internal readonly Const_SharedPtr_ConstMRStdSharedPtrA? Value;
                #pragma warning restore CS0649
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_SharedPtr_ConstMRStdSharedPtrA() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA arg) {return new(arg);}
                public _ByValue_SharedPtr_ConstMRStdSharedPtrA(MR.CS.Misc._Moved<SharedPtr_ConstMRStdSharedPtrA> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_SharedPtr_ConstMRStdSharedPtrA(MR.CS.Misc._Moved<SharedPtr_ConstMRStdSharedPtrA> arg) {return new(arg);}

                /// Construct from a value.
                public static unsafe implicit operator _ByValue_SharedPtr_ConstMRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new MR.CS.Misc._Moved<MR.CS.Std.SharedPtr_ConstMRStdSharedPtrA>(value);}

                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator _ByValue_SharedPtr_ConstMRStdSharedPtrA(MR.CS.Std._ByValue_SharedPtr_MRStdSharedPtrA ptr) {return new MR.CS.Misc._Moved<MR.CS.Std.SharedPtr_ConstMRStdSharedPtrA>(ptr);}
            }

            /// This is used for optional parameters of class `SharedPtr_ConstMRStdSharedPtrA` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_SharedPtr_ConstMRStdSharedPtrA`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstMRStdSharedPtrA`/`Const_SharedPtr_ConstMRStdSharedPtrA` directly.
            public class _InOptMut_SharedPtr_ConstMRStdSharedPtrA
            {
                public SharedPtr_ConstMRStdSharedPtrA? Opt;

                public _InOptMut_SharedPtr_ConstMRStdSharedPtrA() {}
                public _InOptMut_SharedPtr_ConstMRStdSharedPtrA(SharedPtr_ConstMRStdSharedPtrA value) {Opt = value;}
                public static implicit operator _InOptMut_SharedPtr_ConstMRStdSharedPtrA(SharedPtr_ConstMRStdSharedPtrA value) {return new(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_ConstMRStdSharedPtrA` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_SharedPtr_ConstMRStdSharedPtrA`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstMRStdSharedPtrA`/`Const_SharedPtr_ConstMRStdSharedPtrA` to pass it to the function.
            public class _InOptConst_SharedPtr_ConstMRStdSharedPtrA
            {
                public Const_SharedPtr_ConstMRStdSharedPtrA? Opt;

                public _InOptConst_SharedPtr_ConstMRStdSharedPtrA() {}
                public _InOptConst_SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA value) {Opt = value;}
                public static implicit operator _InOptConst_SharedPtr_ConstMRStdSharedPtrA(Const_SharedPtr_ConstMRStdSharedPtrA value) {return new(value);}

                /// Construct from a value.
                public static unsafe implicit operator _InOptConst_SharedPtr_ConstMRStdSharedPtrA(MR.CS.StdSharedPtr.Const_A value) {return new Const_SharedPtr_ConstMRStdSharedPtrA(value);}

                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator _InOptConst_SharedPtr_ConstMRStdSharedPtrA(MR.CS.Std._ByValue_SharedPtr_MRStdSharedPtrA ptr) {return new Const_SharedPtr_ConstMRStdSharedPtrA(ptr);}
            }
        }
    }
}
