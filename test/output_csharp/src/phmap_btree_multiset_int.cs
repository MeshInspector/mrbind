    ...
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_BtreeMultiset_Int : MR.CS.Misc.Object<Const_BtreeMultiset_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                public unsafe Const_BtreeMultiset_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    ...
                    extern static MR.CS.Phmap.BtreeMultiset_Int._Underlying *__MR_C_phmap_btree_multiset_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe nuint Size()
                {
                    ...
                    extern static nuint __MR_C_phmap_btree_multiset_int_size(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe nuint Count(int key)
                {
                    ...
                    extern static nuint __MR_C_phmap_btree_multiset_int_count(_Underlying *_this, int *key);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_count(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeMultiset_Int.ConstIterator Find(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_find(_UnderlyingPtr, &key);
                ...
                public unsafe MR.CS.Phmap.BtreeMultiset_Int.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_begin(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMultiset_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsBegin(MR.CS.Phmap.BtreeMultiset_Int.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeMultiset_Int.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_end(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeMultiset_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Phmap.BtreeMultiset_Int.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_multiset_int_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe int Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_multiset_int_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_phmap_btree_multiset_int_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            public class BtreeMultiset_Int : Const_BtreeMultiset_Int
            {
                ...
                /// Construct from a range of elements.
                public unsafe BtreeMultiset_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_multiset_int_ConstructFromRange", ExactSpelling = true)]
                    extern static MR.CS.Phmap.BtreeMultiset_Int._Underlying *__MR_C_phmap_btree_multiset_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe void Assign(int? ptr, nuint size)
                {
                    ...
                    extern static void __MR_C_phmap_btree_multiset_int_AssignFromRange(_Underlying *_this, int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                    int __deref_ptr = ptr.GetValueOrDefault();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
