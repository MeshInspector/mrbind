public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_BtreeMultimap_Int_Float : MR.CS.Misc.Object<Const_BtreeMultimap_Int_Float>, System.IDisposable
            {
            ...
            public class BtreeMultimap_Int_Float : Const_BtreeMultimap_Int_Float
            {
                ...
                public unsafe new MR.CS.Phmap.BtreeMultimap_Int_Float.Iterator Find(int key)
                {
                    ...
                    __ret = new(__MR_C_phmap_btree_multimap_int_float_FindMutable(_UnderlyingPtr, &key), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe new MR.CS.Phmap.BtreeMultimap_Int_Float.Iterator Begin()
                {
                    ...
                    MR.CS.Phmap.BtreeMultimap_Int_Float.Iterator __ret;
                    __ret = new(__MR_C_phmap_btree_multimap_int_float_MutableBegin(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe new MR.CS.Phmap.BtreeMultimap_Int_Float.Iterator End()
                {
                    ...
                    MR.CS.Phmap.BtreeMultimap_Int_Float.Iterator __ret;
                    __ret = new(__MR_C_phmap_btree_multimap_int_float_MutableEnd(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
