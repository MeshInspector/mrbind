    ...
    public static partial class CS
    {
        public static partial class StdStringView
        {
            ...
            public static unsafe void Set(string s)
            {
                ...
                {
                    __MR_StdStringView_Set(__ptr_s, __ptr_s + __bytes_s.Length);
                }
            }
            ...
            public static unsafe void SetWithDefault(string? s = null)
            {
                ...
                fixed (byte *__ptr_s = __bytes_s)
                {
                    __MR_StdStringView_SetWithDefault(s is not null ? __ptr_s : null, s is not null ? __ptr_s + __len_s : null);
                }
            }
            ...
            public static unsafe void ConstRef(string s)
            {
                ...
                fixed (byte *__ptr_s = __bytes_s)
                {
                    __MR_StdStringView_ConstRef(__ptr_s, __ptr_s + __bytes_s.Length);
                }
            }
            ...
            public static unsafe void RvalueRef(MR.CS.Misc._MoveRef _move_s, string s)
            {
                ...
                fixed (byte *__ptr_s = __bytes_s)
                {
                    __MR_StdStringView_RvalueRef(__ptr_s, __ptr_s + __bytes_s.Length);
                }
            }
