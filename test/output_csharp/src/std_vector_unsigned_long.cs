public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Vector_UnsignedLong : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe ulong? Front()
                {
                    ...
                    var __ret = __MR_C_std_vector_unsigned_long_Front(_UnderlyingPtr);
                ...
                public unsafe ulong? Back()
                {
                    ...
                    var __ret = __MR_C_std_vector_unsigned_long_Back(_UnderlyingPtr);
                    return __ret is not null ? *__ret : null;
                }
                ...
                public unsafe MR.CS.Std.Vector_UnsignedLong.ConstIterator Begin()
                {
                    ...
                    return new(__MR_C_std_vector_unsigned_long_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.Vector_UnsignedLong.ConstIterator End()
                {
                    ...
                    return new(__MR_C_std_vector_unsigned_long_End(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe long MutableToIndex(MR.CS.Std.Vector_UnsignedLong.Const_Iterator iter)
                {
                ...
                public class _InOptConst_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator _InOptConst_ConstIterator(MR.CS.Std.Vector_UnsignedLong.Const_Iterator iter) {return new MR.CS.Std.Vector_UnsignedLong.ConstIterator(iter);}
                }
            ...
            public class Vector_UnsignedLong : Const_Vector_UnsignedLong
            {
                ...
                public unsafe MR.CS.Misc.Ref<ulong>? MutableFront()
                {
                    ...
                    var __ret = __MR_C_std_vector_unsigned_long_MutableFront(_UnderlyingPtr);
                    return __ret is not null ? new MR.CS.Misc.Ref<ulong>(__ret) : null;
                }

                /// The last element or null if empty, mutable.
                public unsafe MR.CS.Misc.Ref<ulong>? MutableBack()
                {
                    ...
                    var __ret = __MR_C_std_vector_unsigned_long_MutableBack(_UnderlyingPtr);
                    return __ret is not null ? new MR.CS.Misc.Ref<ulong>(__ret) : null;
                }
                ...
                public unsafe MR.CS.Std.Vector_UnsignedLong.Iterator MutableBegin()
                {
                    ...
                    return new(__MR_C_std_vector_unsigned_long_MutableBegin(_UnderlyingPtr), is_owning: true);
                }

                /// Tests whether a mutable iterator is the begin iterator.
                public unsafe bool IsMutableBegin(MR.CS.Std.Vector_UnsignedLong.Const_Iterator iter)
                {
                ...
                public unsafe MR.CS.Std.Vector_UnsignedLong.Iterator MutableEnd()
                {
                    ...
                    return new(__MR_C_std_vector_unsigned_long_MutableEnd(_UnderlyingPtr), is_owning: true);
                }

                /// Tests whether a mutable iterator is the end iterator.
                public unsafe bool IsMutableEnd(MR.CS.Std.Vector_UnsignedLong.Const_Iterator iter)
                {
