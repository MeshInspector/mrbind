        ...
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstMRStdSharedPtrAArray42 : MR.CS.Misc.Object<Const_SharedPtr_ConstMRStdSharedPtrAArray42>, System.IDisposable
            {
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_SharedPtr_ConstMRStdSharedPtrAArray42 _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe int UseCount()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_use_count(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public static unsafe implicit operator MR.CS.Std.SharedPtr_ConstVoid(MR.CS.Std.Const_SharedPtr_ConstMRStdSharedPtrAArray42 _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_ConvertTo_MR_C_std_shared_ptr_const_void(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
