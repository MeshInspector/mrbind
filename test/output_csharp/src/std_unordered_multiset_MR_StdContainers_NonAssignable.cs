    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_UnorderedMultiset_MRStdContainersNonAssignable : MR.CS.Misc.Object<Const_UnorderedMultiset_MRStdContainersNonAssignable>, System.IDisposable, IEnumerable<MR.CS.StdContainers.Const_NonAssignable>
            {
                ...
                ~Const_UnorderedMultiset_MRStdContainersNonAssignable() {Dispose(false);}

                public class _Enumerator : IEnumerator<MR.CS.StdContainers.Const_NonAssignable>
                {
                    Const_UnorderedMultiset_MRStdContainersNonAssignable _container;
                    MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_UnorderedMultiset_MRStdContainersNonAssignable container)
                    {
                ...
                internal unsafe Const_UnorderedMultiset_MRStdContainersNonAssignable(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable other) : this(new _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_UnorderedMultiset_MRStdContainersNonAssignable(UnorderedMultiset_MRStdContainersNonAssignable other) : this((Const_UnorderedMultiset_MRStdContainersNonAssignable)other) {}
                ...
                public unsafe ulong Size()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe ulong Count(MR.CS.StdContainers.Const_NonAssignable key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_count(_UnderlyingPtr, key._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator Find(MR.CS.StdContainers.Const_NonAssignable key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_find(_UnderlyingPtr, key._UnderlyingPtr);
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_begin(_UnderlyingPtr);
                    MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsBegin(MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_end(_UnderlyingPtr);
                    MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Std.UnorderedMultiset_MRStdContainersNonAssignable.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe MR.CS.StdContainers.Const_NonAssignable Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_const_iterator_deref(_UnderlyingPtr);
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_unordered_multiset_MR_StdContainers_NonAssignable_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            {
                internal unsafe UnorderedMultiset_MRStdContainersNonAssignable(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable other) : this(new _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public UnorderedMultiset_MRStdContainersNonAssignable(UnorderedMultiset_MRStdContainersNonAssignable other) : this((Const_UnorderedMultiset_MRStdContainersNonAssignable)other) {}
            ...
            /// This is used as a function parameter when the underlying function receives `UnorderedMultiset_MRStdContainersNonAssignable` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `UnorderedMultiset_MRStdContainersNonAssignable`/`Const_UnorderedMultiset_MRStdContainersNonAssignable` to copy it into the function.
            /// * Pass `Move(instance)` to move it into the function. This is a more efficient form of copying that might invalidate the input object.
            ///   Be careful if your input isn't a unique reference to this object.
            /// * Pass `null` to use the default argument, assuming the parameter has a default argument (has `?` in the type).
            public class _ByValue_UnorderedMultiset_MRStdContainersNonAssignable
            {
                #pragma warning disable CS0649
                internal readonly Const_UnorderedMultiset_MRStdContainersNonAssignable? Value;
                #pragma warning restore CS0649
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_UnorderedMultiset_MRStdContainersNonAssignable() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable arg) {return new(arg);}
                public _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(MR.CS.Misc._Moved<UnorderedMultiset_MRStdContainersNonAssignable> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_UnorderedMultiset_MRStdContainersNonAssignable(MR.CS.Misc._Moved<UnorderedMultiset_MRStdContainersNonAssignable> arg) {return new(arg);}
            }

            /// This is used for optional parameters of class `UnorderedMultiset_MRStdContainersNonAssignable` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_UnorderedMultiset_MRStdContainersNonAssignable`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `UnorderedMultiset_MRStdContainersNonAssignable`/`Const_UnorderedMultiset_MRStdContainersNonAssignable` directly.
            public class _InOptMut_UnorderedMultiset_MRStdContainersNonAssignable
            {
                public UnorderedMultiset_MRStdContainersNonAssignable? Opt;

                public _InOptMut_UnorderedMultiset_MRStdContainersNonAssignable() {}
                public _InOptMut_UnorderedMultiset_MRStdContainersNonAssignable(UnorderedMultiset_MRStdContainersNonAssignable value) {Opt = value;}
                public static implicit operator _InOptMut_UnorderedMultiset_MRStdContainersNonAssignable(UnorderedMultiset_MRStdContainersNonAssignable value) {return new(value);}
            }

            /// This is used for optional parameters of class `UnorderedMultiset_MRStdContainersNonAssignable` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_UnorderedMultiset_MRStdContainersNonAssignable`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `UnorderedMultiset_MRStdContainersNonAssignable`/`Const_UnorderedMultiset_MRStdContainersNonAssignable` to pass it to the function.
            public class _InOptConst_UnorderedMultiset_MRStdContainersNonAssignable
            {
                public Const_UnorderedMultiset_MRStdContainersNonAssignable? Opt;

                public _InOptConst_UnorderedMultiset_MRStdContainersNonAssignable() {}
                public _InOptConst_UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable value) {Opt = value;}
                public static implicit operator _InOptConst_UnorderedMultiset_MRStdContainersNonAssignable(Const_UnorderedMultiset_MRStdContainersNonAssignable value) {return new(value);}
            }
        }
    }
}
