    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstInt : MR.CS.Misc.Object<Const_SharedPtr_ConstInt>, System.IDisposable
            {
                ...
                ~Const_SharedPtr_ConstInt() {Dispose(false);}

                internal unsafe Const_SharedPtr_ConstInt(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_ConstInt(Const_SharedPtr_ConstInt other) : this(new _ByValue_SharedPtr_ConstInt(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_SharedPtr_ConstInt(SharedPtr_ConstInt other) : this((Const_SharedPtr_ConstInt)other) {}
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_SharedPtr_ConstInt _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe int UseCount()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_use_count(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator Const_SharedPtr_ConstInt(MR.CS.Std._ByValue_SharedPtr_Int ptr) {return new(ptr);}
                ...
                public static unsafe implicit operator MR.CS.Std.SharedPtr_ConstVoid(MR.CS.Std.Const_SharedPtr_ConstInt _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_ConvertTo_MR_C_std_shared_ptr_const_void(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            public class SharedPtr_ConstInt : Const_SharedPtr_ConstInt
            {
                internal unsafe SharedPtr_ConstInt(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_ConstInt(Const_SharedPtr_ConstInt other) : this(new _ByValue_SharedPtr_ConstInt(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public SharedPtr_ConstInt(SharedPtr_ConstInt other) : this((Const_SharedPtr_ConstInt)other) {}
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator SharedPtr_ConstInt(MR.CS.Std._ByValue_SharedPtr_Int ptr) {return new(ptr);}
            ...
            /// This is used as a function parameter when the underlying function receives `SharedPtr_ConstInt` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `SharedPtr_ConstInt`/`Const_SharedPtr_ConstInt` to copy it into the function.
            ...
            /// This is only used mutable parameters. For const ones we have `_InOptConst_SharedPtr_ConstInt`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstInt`/`Const_SharedPtr_ConstInt` directly.
            public class _InOptMut_SharedPtr_ConstInt
            {
                public SharedPtr_ConstInt? Opt;

                public _InOptMut_SharedPtr_ConstInt() {}
                public _InOptMut_SharedPtr_ConstInt(SharedPtr_ConstInt value) {Opt = value;}
                public static implicit operator _InOptMut_SharedPtr_ConstInt(SharedPtr_ConstInt value) {return new(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_ConstInt` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_SharedPtr_ConstInt`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstInt`/`Const_SharedPtr_ConstInt` to pass it to the function.
            public class _InOptConst_SharedPtr_ConstInt
            {
                public Const_SharedPtr_ConstInt? Opt;
