    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Multiset_Float : MR.CS.Misc.Object<Const_Multiset_Float>, System.IDisposable, IEnumerable<float>
            {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_Multiset_Float(Const_Multiset_Float other) : this(new _ByValue_Multiset_Float(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_Multiset_Float(Multiset_Float other) : this((Const_Multiset_Float)other) {}
                ...
                public unsafe ulong Size()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe bool Empty()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe ulong Count(float key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_count(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public unsafe MR.CS.Std.Multiset_Float.ConstIterator Find(float key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_find(_UnderlyingPtr, &key);
                ...
                public unsafe MR.CS.Std.Multiset_Float.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_begin(_UnderlyingPtr);
                    MR.CS.Std.Multiset_Float.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsBegin(MR.CS.Std.Multiset_Float.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Std.Multiset_Float.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_end(_UnderlyingPtr);
                    MR.CS.Std.Multiset_Float.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                public unsafe bool IsEnd(MR.CS.Std.Multiset_Float.Const_ConstIterator iter)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_multiset_float_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe float Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_multiset_float_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_std_multiset_float_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            public class Multiset_Float : Const_Multiset_Float
            {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Multiset_Float(Const_Multiset_Float other) : this(new _ByValue_Multiset_Float(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Multiset_Float(Multiset_Float other) : this((Const_Multiset_Float)other) {}
