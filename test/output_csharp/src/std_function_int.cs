    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Function_Int : MR.CS.Misc.Object<Const_Function_Int>, System.IDisposable
            {
                ...
                public unsafe Const_Function_Int(MR.CS.Std._ByValue_Function_Int other) : this(null, is_owning: true)
                {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_Function_Int(Const_Function_Int other) : this(new _ByValue_Function_Int(other)) {}
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_Function_Int _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_function_int_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_function_int_call", ExactSpelling = true)]
                    extern static int __MR_C_std_function_int_call(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_function_int_call(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                public static unsafe implicit operator Const_Function_Int(MR.CS.Std.Function_Int.Delegate func) {return new(func);}
            }
            ...
            public class Function_Int : Const_Function_Int
            {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public unsafe Function_Int(MR.CS.Std._ByValue_Function_Int other) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_function_int_ConstructFromAnother", ExactSpelling = true)]
                    extern static MR.CS.Std.Function_Int._Underlying *__MR_C_std_function_int_ConstructFromAnother(MR.CS.Misc._PassBy other_pass_by, MR.CS.Std.Function_Int._Underlying *other);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Function_Int(Const_Function_Int other) : this(new _ByValue_Function_Int(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Function_Int(Function_Int other) : this((Const_Function_Int)other) {}

                /// Assigns the contents from another instance. Both objects remain alive after the call.
                public unsafe void Assign(MR.CS.Std._ByValue_Function_Int other)
                {
            ...
            public class _ByValue_Function_Int
            {
                #pragma warning disable CS0649
                internal readonly Const_Function_Int? Value;
                #pragma warning restore CS0649
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_Function_Int() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_Function_Int(Const_Function_Int new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_Function_Int(Const_Function_Int arg) {return new(arg);}
                public _ByValue_Function_Int(MR.CS.Misc._Moved<Function_Int> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                public static implicit operator _ByValue_Function_Int(MR.CS.Misc._Moved<Function_Int> arg) {return new(arg);}

                public static unsafe implicit operator _ByValue_Function_Int(MR.CS.Std.Function_Int.Delegate func) {return new Function_Int(func);}}

            /// This is used for optional parameters of class `Function_Int` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_Function_Int`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Function_Int`/`Const_Function_Int` directly.
            public class _InOptMut_Function_Int
            {
                public Function_Int? Opt;

                public _InOptMut_Function_Int() {}
                public _InOptMut_Function_Int(Function_Int value) {Opt = value;}
                public static implicit operator _InOptMut_Function_Int(Function_Int value) {return new(value);}
            }

            /// This is used for optional parameters of class `Function_Int` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_Function_Int`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Function_Int`/`Const_Function_Int` to pass it to the function.
            public class _InOptConst_Function_Int
            {
                public Const_Function_Int? Opt;

                public _InOptConst_Function_Int() {}
                public _InOptConst_Function_Int(Const_Function_Int value) {Opt = value;}
                public static implicit operator _InOptConst_Function_Int(Const_Function_Int value) {return new(value);}

                public static unsafe implicit operator _InOptConst_Function_Int(MR.CS.Std.Function_Int.Delegate func) {return new Function_Int(func);}}
        }
    }
}
