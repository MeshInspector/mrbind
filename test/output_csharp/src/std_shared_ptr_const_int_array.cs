public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstIntArray : MR.CS.Misc.Object<Const_SharedPtr_ConstIntArray>, System.IDisposable
            {
                ...
                public static unsafe implicit operator bool(MR.CS.Std.Const_SharedPtr_ConstIntArray _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_array_has_value(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe int this[long i]
                {
                    get
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_std_shared_ptr_const_int_array_at(_UnderlyingPtr, i);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }
                }
                ...
                public unsafe int UseCount()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_array_use_count(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }

                /// Construct an array of the specified size.
                public unsafe Const_SharedPtr_ConstIntArray(ulong size) : this(null, is_owning: true)
                {
                    ...
                    extern static MR.CS.Std.SharedPtr_ConstIntArray._Underlying *__MR_C_std_shared_ptr_const_int_array_ConstructFromSize(ulong size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public static unsafe implicit operator MR.CS.Std.SharedPtr_ConstVoid(MR.CS.Std.Const_SharedPtr_ConstIntArray _this)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_std_shared_ptr_const_int_array_ConvertTo_MR_C_std_shared_ptr_const_void(_this._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
            ...
            public class SharedPtr_ConstIntArray : Const_SharedPtr_ConstIntArray
            {
                ...
                /// Construct an array of the specified size.
                public unsafe SharedPtr_ConstIntArray(ulong size) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_const_int_array_ConstructFromSize", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_ConstIntArray._Underlying *__MR_C_std_shared_ptr_const_int_array_ConstructFromSize(ulong size);
                    MR.CS.Misc._Exceptions.Prepare();
