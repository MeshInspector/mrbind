public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstIntArray : MR.CS.Misc.Object, System.IDisposable
            {
                internal struct _Underlying; // Represents the underlying C++ type.

                internal unsafe _Underlying *_UnderlyingPtr;

                internal unsafe Const_SharedPtr_ConstIntArray(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                ~Const_SharedPtr_ConstIntArray() {Dispose(false);}
                ...
                public unsafe int? Get()
                {
                    ...
                    var __ret = __MR_C_std_shared_ptr_const_int_array_Get(_UnderlyingPtr);
                    return __ret is not null ? *__ret : null;
                }

                /// Returns an element from the stored array. The stored pointer must not be null.
                public unsafe int At(long i)
                {
                ...
                public unsafe Const_SharedPtr_ConstIntArray(void *ptr) : this(null, is_owning: true)
                {
                ...
                public unsafe Const_SharedPtr_ConstIntArray(int? ptr) : this(null, is_owning: true)
                {
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator Const_SharedPtr_ConstIntArray(MR.CS.Std._ByValue_SharedPtr_IntArray ptr) {return new(ptr);}
                ...
                public unsafe Const_SharedPtr_ConstIntArray(MR.CS.Std._ByValue_SharedPtr_ConstVoid ownership, int? ptr) : this(null, is_owning: true)
                {
            ...
            public class SharedPtr_ConstIntArray : Const_SharedPtr_ConstIntArray
            {
                internal unsafe SharedPtr_ConstIntArray(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Create a new instance, taking ownership of an existing pointer.
                public unsafe SharedPtr_ConstIntArray(void *ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_const_int_array_Construct", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_ConstIntArray._Underlying *__MR_C_std_shared_ptr_const_int_array_Construct(void *ptr);
                    _UnderlyingPtr = __MR_C_std_shared_ptr_const_int_array_Construct(ptr);
                ...
                /// Create a new instance, storing a non-owning pointer.
                public unsafe SharedPtr_ConstIntArray(int? ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_const_int_array_ConstructNonOwning", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_ConstIntArray._Underlying *__MR_C_std_shared_ptr_const_int_array_ConstructNonOwning(int *ptr);
                    int __deref_ptr = ptr.GetValueOrDefault();
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator SharedPtr_ConstIntArray(MR.CS.Std._ByValue_SharedPtr_IntArray ptr) {return new(ptr);}
                ...
                /// The aliasing constructor. Create a new instance, copying ownership from an existing shared pointer and storing an arbitrary raw pointer.
                /// The input pointer can be reinterpreted from any other `std::shared_ptr<T>` to avoid constructing a new `std::shared_ptr<void>`.
                public unsafe SharedPtr_ConstIntArray(MR.CS.Std._ByValue_SharedPtr_ConstVoid ownership, int? ptr) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_const_int_array_ConstructAliasing", ExactSpelling = true)]
                    extern static MR.CS.Std.SharedPtr_ConstIntArray._Underlying *__MR_C_std_shared_ptr_const_int_array_ConstructAliasing(MR.CS.Misc._PassBy ownership_pass_by, MR.CS.Std.SharedPtr_ConstVoid._Underlying *ownership, int *ptr);
                    int __deref_ptr = ptr.GetValueOrDefault();
            ...
            /// This is used as a function parameter when the underlying function receives `SharedPtr_ConstIntArray` by value.
            /// Usage:
            /// * Pass `new()` to default-construct the instance.
            /// * Pass an instance of `SharedPtr_ConstIntArray`/`Const_SharedPtr_ConstIntArray` to copy it into the function.
            /// * Pass `Move(instance)` to move it into the function. This is a more efficient form of copying that might invalidate the input object.
            ///   Be careful if your input isn't a unique reference to this object.
            /// * Pass `null` to use the default argument, assuming the parameter has a default argument (has `?` in the type).
            public class _ByValue_SharedPtr_ConstIntArray
            {
                internal readonly Const_SharedPtr_ConstIntArray? Value;
                internal readonly MR.CS.Misc._PassBy PassByMode;
                public _ByValue_SharedPtr_ConstIntArray() {PassByMode = MR.CS.Misc._PassBy.default_construct;}
                public _ByValue_SharedPtr_ConstIntArray(Const_SharedPtr_ConstIntArray new_value) {Value = new_value; PassByMode = MR.CS.Misc._PassBy.copy;}
                public static implicit operator _ByValue_SharedPtr_ConstIntArray(Const_SharedPtr_ConstIntArray arg) {return new(arg);}
                public _ByValue_SharedPtr_ConstIntArray(MR.CS.Misc._Moved<SharedPtr_ConstIntArray> moved) {Value = moved.Value; PassByMode = MR.CS.Misc._PassBy.move;}
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator _ByValue_SharedPtr_ConstIntArray(MR.CS.Std._ByValue_SharedPtr_IntArray ptr) {return new MR.CS.Std.SharedPtr_ConstIntArray(ptr);}
            }

            /// This is used for optional parameters of class `SharedPtr_ConstIntArray` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_SharedPtr_ConstIntArray`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstIntArray`/`Const_SharedPtr_ConstIntArray` directly.
            public class _InOptMut_SharedPtr_ConstIntArray
            {
                public SharedPtr_ConstIntArray? Opt;

                public _InOptMut_SharedPtr_ConstIntArray() {}
                public _InOptMut_SharedPtr_ConstIntArray(SharedPtr_ConstIntArray value) {Opt = value;}
                public static implicit operator _InOptMut_SharedPtr_ConstIntArray(SharedPtr_ConstIntArray value) {return new(value);}
            }

            /// This is used for optional parameters of class `SharedPtr_ConstIntArray` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_SharedPtr_ConstIntArray`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `SharedPtr_ConstIntArray`/`Const_SharedPtr_ConstIntArray` to pass it to the function.
            public class _InOptConst_SharedPtr_ConstIntArray
            {
                public Const_SharedPtr_ConstIntArray? Opt;

                public _InOptConst_SharedPtr_ConstIntArray() {}
                public _InOptConst_SharedPtr_ConstIntArray(Const_SharedPtr_ConstIntArray value) {Opt = value;}
