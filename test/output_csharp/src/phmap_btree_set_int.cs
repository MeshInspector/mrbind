public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_BtreeSet_Int : MR.CS.Misc.Object<Const_BtreeSet_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                {
                    Const_BtreeSet_Int _container;
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_BtreeSet_Int container)
                    {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public Const_BtreeSet_Int(Const_BtreeSet_Int other) : this(new _ByValue_BtreeSet_Int(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public Const_BtreeSet_Int(BtreeSet_Int other) : this((Const_BtreeSet_Int)other) {}

                /// Construct from a range of elements.
                public unsafe Const_BtreeSet_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_ConstructFromRange", ExactSpelling = true)]
                    extern static MR.CS.Phmap.BtreeSet_Int._Underlying *__MR_C_phmap_btree_set_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe nuint Size()
                {
                    ...
                    extern static nuint __MR_C_phmap_btree_set_int_size(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_size(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_empty", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_set_int_empty(_Underlying *_this);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_empty(_UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe bool Contains(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_contains(_UnderlyingPtr, &key);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator Find(int key)
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_find(_UnderlyingPtr, &key);
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator __ret;
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator Begin()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_begin(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_is_begin", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_set_int_is_begin(_Underlying *_this, MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator._Underlying *iter);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_is_begin(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator End()
                {
                    ...
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_end(_UnderlyingPtr);
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator __ret;
                    __ret = new(__c_ret, is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_is_end", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_set_int_is_end(_Underlying *_this, MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator._Underlying *iter);
                    MR.CS.Misc._Exceptions.Prepare();
                    var __c_ret = __MR_C_phmap_btree_set_int_is_end(_UnderlyingPtr, iter._UnderlyingPtr);
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
                    return __c_ret != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe int Deref()
                    {
                        ...
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_phmap_btree_set_int_const_iterator_deref(_UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return *__c_ret;
                    }

                    /// Increments a const iterator.
                    public static unsafe ConstIterator operator++(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator _this)
                    {
                        [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_const_iterator_incr", ExactSpelling = true)]
                        extern static void __MR_C_phmap_btree_set_int_const_iterator_incr(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator._Underlying *_this);
                        ConstIterator __this_copy = new(_this);
                        MR.CS.Misc._Exceptions.Prepare();
                        __MR_C_phmap_btree_set_int_const_iterator_incr(__this_copy._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __this_copy;
                    }
                    ...
                    public static unsafe ConstIterator operator--(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator _this)
                    {
                        ...
                        extern static void __MR_C_phmap_btree_set_int_const_iterator_decr(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator._Underlying *_this);
                        ConstIterator __this_copy = new(_this);
                        MR.CS.Misc._Exceptions.Prepare();
                        __MR_C_phmap_btree_set_int_const_iterator_decr(__this_copy._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __this_copy;
                    }
                    ...
                    {
                        [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_equal_MR_C_phmap_btree_set_int_const_iterator", ExactSpelling = true)]
                        extern static byte __MR_C_equal_MR_C_phmap_btree_set_int_const_iterator(MR.CS.Phmap.BtreeSet_Int.ConstIterator._Underlying *a, MR.CS.Phmap.BtreeSet_Int.ConstIterator._Underlying *b);
                        MR.CS.Misc._Exceptions.Prepare();
                        var __c_ret = __MR_C_equal_MR_C_phmap_btree_set_int_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr);
                        MR.CS.Misc._Exceptions.ThrowIfNeeded();
                        return __c_ret != 0;
                    }
            ...
            public class BtreeSet_Int : Const_BtreeSet_Int
            {
                ...
                /// Constructs a copy of another instance. The source remains alive.
                public BtreeSet_Int(Const_BtreeSet_Int other) : this(new _ByValue_BtreeSet_Int(other)) {}

                /// Constructs a copy of another instance. The source remains alive.
                public BtreeSet_Int(BtreeSet_Int other) : this((Const_BtreeSet_Int)other) {}
                ...
                /// Construct from a range of elements.
                public unsafe BtreeSet_Int(int? ptr, nuint size) : this(null, is_owning: true)
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_set_int_ConstructFromRange", ExactSpelling = true)]
                    extern static MR.CS.Phmap.BtreeSet_Int._Underlying *__MR_C_phmap_btree_set_int_ConstructFromRange(int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                ...
                public unsafe void Assign(int? ptr, nuint size)
                {
                    ...
                    extern static void __MR_C_phmap_btree_set_int_AssignFromRange(_Underlying *_this, int *ptr, nuint size);
                    MR.CS.Misc._Exceptions.Prepare();
                    int __deref_ptr = ptr.GetValueOrDefault();
                    MR.CS.Misc._Exceptions.ThrowIfNeeded();
