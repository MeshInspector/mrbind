...
$CXX test/build/source/MR/*.cpp -fPIC -shared -o test/build/libbleh$EXT_SHARED -Itest/build/include -Itest/build/source -Itest -std=c++20 -Wall -Wextra -pedantic-errors -Wdeprecated -Wextra-semi -Wimplicit-fallthrough -Wconversion -Wno-implicit-int-float-conversion
