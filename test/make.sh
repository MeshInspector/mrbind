...
build/Debug/mrbind test/input/all.h --format=json --ignore :: --allow MR -o test/build/parsed.json -- -xc++-header -std=c++20 -Wall -Wextra -pedantic-errors -fparse-all-comments -Itest
