...
echo '#include <mrbind/helpers/adjust_size_t.h>' >test/input/all.h
...
$CXX test/output_c/source/*.cpp test/output_c/source/MR/*.cpp -fPIC -shared -o test/output_c/libbleh$EXT_SHARED -Itest/output_c/include -Itest/output_c/source -Itest -std=c++23 -Werror -Wall -Wextra -pedantic-errors -Wdeprecated -Wextra-semi -Wimplicit-fallthrough -Wconversion -Wno-implicit-int-float-conversion -isystemtest/input/parallel-hashmap -Iinclude -includemrbind/helpers/adjust_size_t.h
