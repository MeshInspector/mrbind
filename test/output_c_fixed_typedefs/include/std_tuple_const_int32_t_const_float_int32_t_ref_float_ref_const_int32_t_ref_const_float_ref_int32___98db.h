...
// The reference to the parameter `_0` might be preserved in the return value.
...
// The reference to the parameter `_4` might be preserved in the return value.
// Parameter `_5` can not be null. It is a single object.
// The reference to the parameter `_5` might be preserved in the return value.
// Parameter `_6` can not be null. It is a single object.
// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
//   but if your pointer is owning, you must still destroy it manually later.
// The reference to the parameter `_6` might be preserved in the return value.
// Parameter `_7` can not be null. It is a single object.
// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
//   but if your pointer is owning, you must still destroy it manually later.
// The reference to the parameter `_7` might be preserved in the return value.
// Parameter `_8` can not be null. It is a single object.
// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
//   but if your pointer is owning, you must still destroy it manually later.
// The reference to the parameter `_8` might be preserved in the return value.
// Parameter `_9` can not be null. It is a single object.
// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
//   but if your pointer is owning, you must still destroy it manually later.
// The reference to the parameter `_9` might be preserved in the return value.
