...
typedef struct MR_C_std_shared_ptr_const_int32_t MR_C_std_shared_ptr_const_int32_t; // Defined below in this file.
...
MR_C_API void MR_C_std_shared_ptr_const_int32_t_Construct(const int32_t *ptr);
