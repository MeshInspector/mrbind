...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_void_from_std_string_has_value(const MR_C_std_function_void_from_std_string *_this);

// Destroys the stored callable, making this instance null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_void_from_std_string_reset(MR_C_std_function_void_from_std_string *_this);

// Calls the stored callable.
// Parameter `_this` can not be null. It is a single object.
// Parameter `_1` can not be null.
// If `_1_end` is null, then `_1` is assumed to be null-terminated.
MR_C_API void MR_C_std_function_void_from_std_string_call(const MR_C_std_function_void_from_std_string *_this, const char *_1, const char *_1_end);
...
MR_C_API MR_C_std_function_void_from_std_string *MR_C_std_function_void_from_std_string_ConstructStateless(void (*func)(MR_C_std_string *_1));
...
MR_C_API MR_C_std_function_void_from_std_string *MR_C_std_function_void_from_std_string_ConstructEx(void (*func)(MR_C_std_string *_1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_void_from_std_string_AssignEx(MR_C_std_function_void_from_std_string *_this, void (*func)(MR_C_std_string *_1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_STD_STRING_H_2)
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_STD_STRING_H_2)
