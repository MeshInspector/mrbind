#ifndef MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H
#define MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H
...
#endif // MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H_2)
#define MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <std_string.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_OPTIONAL_STD_STRING_H_2)
