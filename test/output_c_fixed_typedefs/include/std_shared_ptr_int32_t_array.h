...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_array_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_int32_t_array *MR_C_std_shared_ptr_int32_t_array_Construct(int32_t *ptr);
...
// The reference to the parameter `ptr` might be preserved in the return value.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_array_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_int32_t_array *MR_C_std_shared_ptr_int32_t_array_ConstructNonOwning(int32_t *ptr);
...
// When this function is called, the parameter `_this` will drop any object references it had previously.
MR_C_API void MR_C_std_shared_ptr_int32_t_array_AssignNonOwning(MR_C_std_shared_ptr_int32_t_array *_this, int32_t *ptr);
...
// The reference to the parameter `ptr` might be preserved in the return value.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_array_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_int32_t_array *MR_C_std_shared_ptr_int32_t_array_ConstructAliasing(MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, int32_t *ptr);
...
#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_ARRAY_H_2)
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_ARRAY_H_2
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_ARRAY_H_2)
