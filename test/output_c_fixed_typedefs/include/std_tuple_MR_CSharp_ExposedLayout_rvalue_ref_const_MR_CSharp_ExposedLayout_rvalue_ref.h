#ifndef MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H
#define MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H
...
#endif // MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H_2)
#define MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_csharp.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_TUPLE_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_CONST_MR_CSHARP_EXPOSEDLAYOUT_RVALUE_REF_H_2)
