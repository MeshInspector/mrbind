#ifndef MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H
#define MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H
...
MR_C_API void MR_C_std_unique_ptr_MR_StdUniquePtr_A_array_Destroy(const MR_C_std_unique_ptr_MR_StdUniquePtr_A_array *_this);

// Destroys a heap-allocated array of `MR_C_std_unique_ptr_MR_StdUniquePtr_A_array`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_unique_ptr_MR_StdUniquePtr_A_array_DestroyArray(const MR_C_std_unique_ptr_MR_StdUniquePtr_A_array *_this);
...
#endif // MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H_2)
#define MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_std_unique_ptr.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_UNIQUE_PTR_MR_STDUNIQUEPTR_A_ARRAY_H_2)
