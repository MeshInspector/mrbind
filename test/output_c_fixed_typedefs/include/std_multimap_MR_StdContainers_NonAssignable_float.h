#ifndef MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H
#define MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H
...
typedef struct MR_C_std_multimap_MR_StdContainers_NonAssignable_float MR_C_std_multimap_MR_StdContainers_NonAssignable_float;

// Read-only iterator for `MR_C_std_multimap_MR_StdContainers_NonAssignable_float`.
// Supported `MR_C_PassBy` modes: `MR_C_PassBy_DefaultConstruct`, `MR_C_PassBy_Copy`, `MR_C_PassBy_Move` (and `MR_C_PassBy_DefaultArgument` and `MR_C_PassBy_NoObject` if supported by the callee).
typedef struct MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator;

// Mutable iterator for `MR_C_std_multimap_MR_StdContainers_NonAssignable_float`.
// Supported `MR_C_PassBy` modes: `MR_C_PassBy_DefaultConstruct`, `MR_C_PassBy_Copy`, `MR_C_PassBy_Move` (and `MR_C_PassBy_DefaultArgument` and `MR_C_PassBy_NoObject` if supported by the callee).
typedef struct MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator;
...
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_DestroyArray()`.
// Use `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_OffsetMutablePtr()` and `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_DefaultConstructArray(size_t num_elems);

// Constructs a copy of another instance. The source remains alive.
// The reference to the parameter `other` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it had previously.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_multimap_MR_StdContainers_NonAssignable_float *other);
...
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_Destroy(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float *_this);

// Destroys a heap-allocated array of `MR_C_std_multimap_MR_StdContainers_NonAssignable_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_DestroyArray(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_multimap_MR_StdContainers_NonAssignable_float *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_OffsetPtr(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_OffsetMutablePtr(MR_C_std_multimap_MR_StdContainers_NonAssignable_float *ptr, ptrdiff_t i);
...
// Constructs an empty (default-constructed) instance.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_DestroyArray()`.
// Use `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_OffsetMutablePtr()` and `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_DefaultConstructArray(size_t num_elems);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it had previously.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_ConstructFromAnother(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *other);
...
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_Destroy(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *_this);

// Destroys a heap-allocated array of `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_DestroyArray(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_OffsetPtr(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator_OffsetMutablePtr(MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *ptr, ptrdiff_t i);
...
// Constructs an empty (default-constructed) instance.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_DestroyArray()`.
// Use `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_OffsetMutablePtr()` and `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_DefaultConstructArray(size_t num_elems);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it had previously.
MR_C_API MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_ConstructFromAnother(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *other);
...
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_Destroy(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *_this);

// Destroys a heap-allocated array of `MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_DestroyArray(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator_OffsetPtr(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *ptr, ptrdiff_t i);
...
MR_C_API bool MR_C_equal_MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *a, const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_const_iterator *b);
...
// Parameter `a` can not be null. It is a single object.
// Parameter `b` can not be null. It is a single object.
MR_C_API bool MR_C_equal_MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator(const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *a, const MR_C_std_multimap_MR_StdContainers_NonAssignable_float_iterator *b);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H_2)
#define MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H_2
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_MULTIMAP_MR_STDCONTAINERS_NONASSIGNABLE_FLOAT_H_2)
