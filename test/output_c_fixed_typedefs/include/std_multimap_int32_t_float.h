...
typedef struct MR_C_std_multimap_int32_t_float MR_C_std_multimap_int32_t_float; // Defined below in this file.
typedef struct MR_C_std_multimap_int32_t_float_const_iterator MR_C_std_multimap_int32_t_float_const_iterator; // Defined below in this file.
typedef struct MR_C_std_multimap_int32_t_float_iterator MR_C_std_multimap_int32_t_float_iterator; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API bool MR_C_std_multimap_int32_t_float_IsEmpty(const MR_C_std_multimap_int32_t_float *_this);
...
MR_C_API bool MR_C_std_multimap_int32_t_float_IsBegin(const MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_const_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_multimap_int32_t_float_IsMutableBegin(MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_multimap_int32_t_float_IsEnd(const MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_const_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_multimap_int32_t_float_IsMutableEnd(MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_iterator *iter);
...
/// Parameter `iter` can not be null.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_multimap_int32_t_float_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_multimap_int32_t_float_const_iterator *MR_C_std_multimap_int32_t_float_const_iterator_FromMutable(const MR_C_std_multimap_int32_t_float_iterator *iter);
