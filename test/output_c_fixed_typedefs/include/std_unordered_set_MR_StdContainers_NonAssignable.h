#ifndef MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H
#define MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_unordered_set_MR_StdContainers_NonAssignable_empty(const MR_C_std_unordered_set_MR_StdContainers_NonAssignable *_this);
...
MR_C_API bool MR_C_std_unordered_set_MR_StdContainers_NonAssignable_is_begin(const MR_C_std_unordered_set_MR_StdContainers_NonAssignable *_this, const MR_C_std_unordered_set_MR_StdContainers_NonAssignable_const_iterator *iter);
...
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_std_unordered_set_MR_StdContainers_NonAssignable_is_end(const MR_C_std_unordered_set_MR_StdContainers_NonAssignable *_this, const MR_C_std_unordered_set_MR_StdContainers_NonAssignable_const_iterator *iter);
...
MR_C_API bool MR_C_equal_MR_C_std_unordered_set_MR_StdContainers_NonAssignable_const_iterator(const MR_C_std_unordered_set_MR_StdContainers_NonAssignable_const_iterator *a, const MR_C_std_unordered_set_MR_StdContainers_NonAssignable_const_iterator *b);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H_2)
#define MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_std_containers.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_UNORDERED_SET_MR_STDCONTAINERS_NONASSIGNABLE_H_2)
