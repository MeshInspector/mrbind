...
// Parameter `_this` can not be null. It is a single object.
MR_C_API const MR_CSharp_E1 *MR_C_expected_MR_CSharp_E1_float_GetValue(const MR_C_expected_MR_CSharp_E1_float *_this);

// If this instance represents an error, returns the stored `float`. Otherwise null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API const float *MR_C_expected_MR_CSharp_E1_float_GetError(const MR_C_expected_MR_CSharp_E1_float *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API MR_CSharp_E1 *MR_C_expected_MR_CSharp_E1_float_GetMutableValue(MR_C_expected_MR_CSharp_E1_float *_this);

// If this instance represents an error, returns the stored `float`. Otherwise null. This version returns a mutable pointer.
// Parameter `_this` can not be null. It is a single object.
MR_C_API float *MR_C_expected_MR_CSharp_E1_float_GetMutableError(MR_C_expected_MR_CSharp_E1_float *_this);
