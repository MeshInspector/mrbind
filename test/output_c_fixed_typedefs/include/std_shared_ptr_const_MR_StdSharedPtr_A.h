#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_has_value(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_use_count(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_reset(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_ConstructFromValue(const MR_StdSharedPtr_A *value);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Construct(const MR_StdSharedPtr_A *ptr);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_ConstructNonOwning(const MR_StdSharedPtr_A *ptr);
...
// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_AssignNonOwning(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this, const MR_StdSharedPtr_A *ptr);

// Create a new instance from a non-const pointer to the same type.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_ConstructFromMutable(MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_MR_StdSharedPtr_A *ptr);

// Overwrite the existing instance with a non-const pointer to the same type.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_AssignFromMutable(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this, MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_MR_StdSharedPtr_A *ptr);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_ConstructAliasing(MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, const MR_StdSharedPtr_A *ptr);
...
// The reference to the parameter `ptr` might be preserved in this object.
// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_AssignAliasing(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this, MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, const MR_StdSharedPtr_A *ptr);
...
MR_C_API MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_void_ConstructFrom_MR_C_std_shared_ptr_const_MR_StdSharedPtr_A(MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_other);

// Overwrites an existing `std::shared_ptr<void>` to point to the same object as this instance.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_void_AssignFrom_MR_C_std_shared_ptr_const_MR_StdSharedPtr_A(MR_C_std_shared_ptr_const_void *_this, MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_other);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H_2)
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H_2
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_H_2)
