...
MR_C_API MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this);
...
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this, MR_C_std_shared_ptr_const_void *_target);
