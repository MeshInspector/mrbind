#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_const_void_has_value(const MR_C_std_shared_ptr_const_void *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_const_void_use_count(const MR_C_std_shared_ptr_const_void *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_void_reset(MR_C_std_shared_ptr_const_void *_this);
...
#endif // MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H_2)
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <std_shared_ptr_void.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_VOID_H_2)
