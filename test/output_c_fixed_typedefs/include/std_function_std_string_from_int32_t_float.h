...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_std_string_from_int32_t_float_has_value(const MR_C_std_function_std_string_from_int32_t_float *_this);

// Destroys the stored callable, making this instance null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_std_string_from_int32_t_float_reset(MR_C_std_function_std_string_from_int32_t_float *_this);
...
MR_C_API MR_C_std_string *MR_C_std_function_std_string_from_int32_t_float_call(const MR_C_std_function_std_string_from_int32_t_float *_this, int32_t _1, float _2);
...
MR_C_API MR_C_std_function_std_string_from_int32_t_float *MR_C_std_function_std_string_from_int32_t_float_ConstructStateless(MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int32_t _1, float _2));

// Assign a stateless function.
// Parameter `_this` can not be null. It is a single object.
// Callback parameter `_return_pass_by` is an output parameter. It will never be null, and initially points to a zeroed variable.
MR_C_API void MR_C_std_function_std_string_from_int32_t_float_Assign(MR_C_std_function_std_string_from_int32_t_float *_this, MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int32_t _1, float _2));
...
MR_C_API MR_C_std_function_std_string_from_int32_t_float *MR_C_std_function_std_string_from_int32_t_float_ConstructEx(MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int32_t _1, float _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_std_string_from_int32_t_float_AssignEx(MR_C_std_function_std_string_from_int32_t_float *_this, MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int32_t _1, float _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_STD_STRING_FROM_INT32_T_FLOAT_H_2)
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_STD_STRING_FROM_INT32_T_FLOAT_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <std_string.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_STD_STRING_FROM_INT32_T_FLOAT_H_2)
