#ifndef MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_INT32_T_INT32_T_H
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_INT32_T_INT32_T_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_void_from_int32_t_int32_t_has_value(const MR_C_std_function_void_from_int32_t_int32_t *_this);

// Destroys the stored callable, making this instance null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_void_from_int32_t_int32_t_reset(MR_C_std_function_void_from_int32_t_int32_t *_this);

// Calls the stored callable.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_void_from_int32_t_int32_t_call(const MR_C_std_function_void_from_int32_t_int32_t *_this, int32_t _1, int32_t _2);

// Construct a stateless function.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_void_from_int32_t_int32_t_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_ConstructStateless(void (*func)(int32_t _1, int32_t _2));
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_void_from_int32_t_int32_t_AssignEx(MR_C_std_function_void_from_int32_t_int32_t *_this, void (*func)(int32_t _1, int32_t _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_INT32_T_INT32_T_H
