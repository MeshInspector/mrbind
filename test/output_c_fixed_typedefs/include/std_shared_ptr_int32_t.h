#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_H
...
MR_C_API MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_shared_ptr_int32_t_DestroyArray()`.
// Use `MR_C_std_shared_ptr_int32_t_OffsetMutablePtr()` and `MR_C_std_shared_ptr_int32_t_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_DefaultConstructArray(size_t num_elems);

// Constructs a copy of another instance. The source remains alive.
// The reference to the parameter `other` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_int32_t *other);

// Assigns the contents from another instance. Both objects remain alive after the call.
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `other` might be preserved in this object.
// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_shared_ptr_int32_t_AssignFromAnother(MR_C_std_shared_ptr_int32_t *_this, MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_int32_t *other);

// Destroys a heap-allocated instance of `MR_C_std_shared_ptr_int32_t`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_shared_ptr_int32_t_Destroy(const MR_C_std_shared_ptr_int32_t *_this);

// Destroys a heap-allocated array of `MR_C_std_shared_ptr_int32_t`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_shared_ptr_int32_t_DestroyArray(const MR_C_std_shared_ptr_int32_t *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_OffsetPtr(const MR_C_std_shared_ptr_int32_t *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_OffsetMutablePtr(MR_C_std_shared_ptr_int32_t *ptr, ptrdiff_t i);

// Returns the stored pointer, possibly null.
// Parameter `_this` can not be null. It is a single object.
// The reference to this object might be preserved as the return value.
MR_C_API int32_t *MR_C_std_shared_ptr_int32_t_get(const MR_C_std_shared_ptr_int32_t *_this);

// Returns true if non-null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_int32_t_has_value(const MR_C_std_shared_ptr_int32_t *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_int32_t_use_count(const MR_C_std_shared_ptr_int32_t *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_int32_t_reset(MR_C_std_shared_ptr_int32_t *_this);

// Construct from a value.
// The reference to the parameter `value` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_int32_t *MR_C_std_shared_ptr_int32_t_ConstructFromValue(int32_t value);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_int32_t_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t *_this);
...
MR_C_API void MR_C_std_shared_ptr_int32_t_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t *_this, MR_C_std_shared_ptr_void *_target);
