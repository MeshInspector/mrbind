#ifndef MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H
...
typedef struct MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1;

// Constructs an empty (default-constructed) instance.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_DestroyArray()`.
// Use `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_OffsetMutablePtr()` and `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_DefaultConstructArray(size_t num_elems);

// Constructs a copy of another instance. The source remains alive.
// The reference to the parameter `other` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *other);

// Assigns the contents from another instance. Both objects remain alive after the call.
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `other` might be preserved in this object.
// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_AssignFromAnother(MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this, MR_C_PassBy other_pass_by, MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *other);

// Destroys a heap-allocated instance of `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_Destroy(const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this);

// Destroys a heap-allocated array of `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_DestroyArray(const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_OffsetPtr(const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_OffsetMutablePtr(MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *ptr, ptrdiff_t i);

// Returns true if this instance stores a callable, as opposed to being null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_has_value(const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this);

// Destroys the stored callable, making this instance null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_reset(MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this);

// Calls the stored callable.
// Parameter `_this` can not be null. It is a single object.
MR_C_API MR_CSharp_E1 MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_call(const MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this, MR_CSharp_E1 _1);

// Construct a stateless function.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_ConstructStateless(MR_CSharp_E1 (*func)(MR_CSharp_E1 _1));

// Assign a stateless function.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_Assign(MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this, MR_CSharp_E1 (*func)(MR_CSharp_E1 _1));
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1_AssignEx(MR_C_std_function_MR_CSharp_E1_from_MR_CSharp_E1 *_this, MR_CSharp_E1 (*func)(MR_CSharp_E1 _1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H_2)
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_csharp.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_CSHARP_E1_FROM_MR_CSHARP_E1_H_2)
