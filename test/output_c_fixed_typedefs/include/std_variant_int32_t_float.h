#ifndef MR_C_DETAIL_INCLUDED_STD_VARIANT_INT32_T_FLOAT_H
#define MR_C_DETAIL_INCLUDED_STD_VARIANT_INT32_T_FLOAT_H
...
typedef struct MR_C_std_variant_int32_t_float MR_C_std_variant_int32_t_float;
...
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_variant_int32_t_float_DestroyArray()`.
// Use `MR_C_std_variant_int32_t_float_OffsetMutablePtr()` and `MR_C_std_variant_int32_t_float_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_DefaultConstructArray(size_t num_elems);
...
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_ConstructFromAnother(const MR_C_std_variant_int32_t_float *other);
...
MR_C_API void MR_C_std_variant_int32_t_float_Destroy(const MR_C_std_variant_int32_t_float *_this);

// Destroys a heap-allocated array of `MR_C_std_variant_int32_t_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_variant_int32_t_float_DestroyArray(const MR_C_std_variant_int32_t_float *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_OffsetPtr(const MR_C_std_variant_int32_t_float *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_OffsetMutablePtr(MR_C_std_variant_int32_t_float *ptr, ptrdiff_t i);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_variant_int32_t_float_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it had previously.
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_ConstructAs_int32_t(int32_t value);

// Constructs the variant storing the element 1, of type `float`.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_variant_int32_t_float_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it had previously.
MR_C_API MR_C_std_variant_int32_t_float *MR_C_std_variant_int32_t_float_ConstructAs_float(float value);
...
#endif // MR_C_DETAIL_INCLUDED_STD_VARIANT_INT32_T_FLOAT_H
