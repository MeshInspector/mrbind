...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_MR_CSharp_SA_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SA *_this);
...
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SA_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_CSharp_SA *_this, MR_C_std_shared_ptr_void *_target);
