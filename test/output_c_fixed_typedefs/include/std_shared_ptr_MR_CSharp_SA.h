#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H
...
typedef struct MR_C_std_shared_ptr_MR_CSharp_SA MR_C_std_shared_ptr_MR_CSharp_SA;
...
MR_C_API MR_C_std_shared_ptr_MR_CSharp_SA *MR_C_std_shared_ptr_MR_CSharp_SA_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_shared_ptr_MR_CSharp_SA_DestroyArray()`.
// Use `MR_C_std_shared_ptr_MR_CSharp_SA_OffsetMutablePtr()` and `MR_C_std_shared_ptr_MR_CSharp_SA_OffsetPtr()` to access the array elements.
...
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SA_Destroy(const MR_C_std_shared_ptr_MR_CSharp_SA *_this);

// Destroys a heap-allocated array of `MR_C_std_shared_ptr_MR_CSharp_SA`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_shared_ptr_MR_CSharp_SA_DestroyArray(const MR_C_std_shared_ptr_MR_CSharp_SA *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_shared_ptr_MR_CSharp_SA *MR_C_std_shared_ptr_MR_CSharp_SA_OffsetPtr(const MR_C_std_shared_ptr_MR_CSharp_SA *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_shared_ptr_MR_CSharp_SA *MR_C_std_shared_ptr_MR_CSharp_SA_OffsetMutablePtr(MR_C_std_shared_ptr_MR_CSharp_SA *ptr, ptrdiff_t i);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_MR_CSharp_SA_UseCount(const MR_C_std_shared_ptr_MR_CSharp_SA *_this);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_MR_CSharp_SA_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_MR_CSharp_SA *MR_C_std_shared_ptr_MR_CSharp_SA_Construct(MR_CSharp_SA *ptr);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_void_ConstructFrom_MR_C_std_shared_ptr_MR_CSharp_SA(MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_MR_CSharp_SA *_other);

// Overwrites an existing `std::shared_ptr<void>` to point to the same object as this instance.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_void_AssignFrom_MR_C_std_shared_ptr_MR_CSharp_SA(MR_C_std_shared_ptr_void *_this, MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_MR_CSharp_SA *_other);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H_2)
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H_2
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_CSHARP_SA_H_2)
