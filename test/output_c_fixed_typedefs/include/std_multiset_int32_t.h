...
typedef struct MR_C_std_multiset_int32_t MR_C_std_multiset_int32_t; // Defined below in this file.
typedef struct MR_C_std_multiset_int32_t_const_iterator MR_C_std_multiset_int32_t_const_iterator; // Defined below in this file.
