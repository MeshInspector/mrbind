#ifndef MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H
#define MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H
...
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `value` might be preserved in this object in element `c`.
// When this function is called, this object will drop object references it held previously in `c`.
...
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `value` might be preserved in this object in element `d`.
// When this function is called, this object will drop object references it held previously in `d`.
...
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `value` might be preserved in this object in element `f`.
// When this function is called, this object will drop object references it held previously in `f`.
...
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `value` might be preserved in this object in element `g`.
// When this function is called, this object will drop object references it held previously in `g`.
...
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `value` might be preserved in this object in element `h`.
// When this function is called, this object will drop object references it held previously in `h`.
...
// The reference to the parameter `g` might be preserved in the constructed object.
// The reference to the parameter `h` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_Aggregates_C_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_Aggregates_C *MR_Aggregates_C_ConstructFrom(int32_t a, int32_t b, int32_t c, int32_t d, int32_t e, int32_t f, int32_t g, int32_t h);
...
// When this function is called, this object will drop object references it held previously in `j`.
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_Aggregates_E_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_Aggregates_E *MR_Aggregates_E_ConstructFrom(int32_t a, int32_t b, int32_t c, int32_t d, int32_t e, int32_t f, int32_t g, int32_t h, int32_t i, const MR_Aggregates_NonDefaultConstructible *j);
...
#endif // MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H_2)
#define MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <std_string.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_MR_TEST_AGGREGATES_H_2)
