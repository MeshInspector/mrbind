...
// The reference to the parameter `y` might be preserved in the return value.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_Aggregates_A_Destroy()` to free it when you're done using it.
...
// The reference to the parameter `e` might be preserved in the return value.
// The reference to the parameter `f` might be preserved in the return value.
// The reference to the parameter `g` might be preserved in the return value.
// The reference to the parameter `h` might be preserved in the return value.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_Aggregates_C_Destroy()` to free it when you're done using it.
...
// The reference to the parameter `j` might be preserved in the return value.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_Aggregates_E_Destroy()` to free it when you're done using it.
