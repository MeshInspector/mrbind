...
// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const int32_t *MR_CSharp_A_Get_a(const MR_CSharp_A *_this);

// Modifies a member variable of class `MR::CSharp::A` named `a`.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_CSharp_A_Set_a(MR_CSharp_A *_this, int32_t value);

// Returns a mutable pointer to a member variable of class `MR::CSharp::A` named `a`.
// Parameter `_this` can not be null. It is a single object.
// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API int32_t *MR_CSharp_A_GetMutable_a(MR_CSharp_A *_this);
