...
MR_C_API MR_C_expected_int32_t_float *MR_CSharp_test_class_expected(const MR_C_expected_int32_t_float *a, const MR_C_expected_int32_t_float *b);
...
// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API MR_C_expected_int32_t_float *MR_CSharp_test_class_expected_ref(MR_C_expected_int32_t_float *a, MR_C_expected_int32_t_float *b);
...
// Parameter `b` has a default argument: `default_expected`, pass a null pointer to use it.
// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const MR_C_expected_int32_t_float *MR_CSharp_test_class_expected_cref(const MR_C_expected_int32_t_float *a, const MR_C_expected_int32_t_float *b);
...
MR_C_API MR_C_expected_int32_t_float *MR_CSharp_test_class_expected_ptr(MR_C_expected_int32_t_float *a, MR_C_expected_int32_t_float *b, MR_C_expected_int32_t_float *const *c);

// Generated from function `MR::CSharp::test_class_expected_cptr`.
// Parameter `b` defaults to a null pointer in C++.
// Parameter `c` has a default argument: `&default_expected`, pass a null pointer to use it.
MR_C_API const MR_C_expected_int32_t_float *MR_CSharp_test_class_expected_cptr(const MR_C_expected_int32_t_float *a, const MR_C_expected_int32_t_float *b, const MR_C_expected_int32_t_float *const *c);
