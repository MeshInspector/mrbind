...
typedef struct MR_TypedefsInTemplates_A_int32_t MR_TypedefsInTemplates_A_int32_t; // Defined below in this file.
typedef struct MR_TypedefsInTemplates_B_int32_t MR_TypedefsInTemplates_B_int32_t; // Defined below in this file.
typedef struct MR_TypedefsInTemplates_B_int32_t_BB_float MR_TypedefsInTemplates_B_int32_t_BB_float; // Defined below in this file.
