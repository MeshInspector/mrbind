#ifndef MR_C_DETAIL_INCLUDED_MR_TEST_LIFETIME_INFERENCE_H
#define MR_C_DETAIL_INCLUDED_MR_TEST_LIFETIME_INFERENCE_H
...
MR_C_API int32_t *MR_LifetimeInference_begin_MR_LifetimeInference_A(MR_LifetimeInference_A *a);

// Generated from function `MR::LifetimeInference::end`.
// Parameter `a` can not be null. It is a single object.
// The reference to the parameter `a` might be preserved in the return value.
MR_C_API int32_t *MR_LifetimeInference_end_MR_LifetimeInference_A(MR_LifetimeInference_A *a);
...
MR_C_API int32_t *MR_LifetimeInference_begin_MR_LifetimeInference_B(MR_LifetimeInference_B *b);

// Generated from function `MR::LifetimeInference::end`.
// Parameter `b` can not be null. It is a single object.
// The reference to the parameter `b` might be preserved in the return value.
MR_C_API int32_t *MR_LifetimeInference_end_MR_LifetimeInference_B(MR_LifetimeInference_B *b);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_LifetimeInference_C_Destroy()` to free it when you're done using it.
MR_C_API MR_LifetimeInference_C *MR_LifetimeInference_C_Construct(MR_LifetimeInference_A *_1, int32_t *_2, int32_t _3);
...
#endif // MR_C_DETAIL_INCLUDED_MR_TEST_LIFETIME_INFERENCE_H
