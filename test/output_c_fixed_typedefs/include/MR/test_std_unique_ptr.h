...
typedef struct MR_C_std_unique_ptr_int32_t_array MR_C_std_unique_ptr_int32_t_array; // Defined in `#include <std_unique_ptr_int32_t_array.h>`.
...
MR_C_API int32_t *MR_StdUniquePtr_GetInt(void);
...
MR_C_API void MR_StdUniquePtr_SetInt(int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntConstRef`.
/// Parameter `_1` can not be null.
MR_C_API void MR_StdUniquePtr_SetIntConstRef(const MR_C_std_unique_ptr_int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntDefTrivial`.
/// Parameter `_1` should point to a single object rather than to an array.
/// Parameter `_1` takes ownership of the passed pointer (if not null), and will later call `MR_C_Free()` on it automatically.
/// Parameter `_1` defaults to a null pointer in C++.
MR_C_API void MR_StdUniquePtr_SetIntDefTrivial(int32_t *_1);
...
MR_C_API void MR_StdUniquePtr_SetIntDef(int32_t *const *_1);

/// Generated from function `MR::StdUniquePtr::SetIntLvalueRef`.
/// Parameter `_1` can not be null.
MR_C_API void MR_StdUniquePtr_SetIntLvalueRef(MR_C_std_unique_ptr_int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntLvalueConstRef`.
/// Parameter `_1` can not be null.
MR_C_API void MR_StdUniquePtr_SetIntLvalueConstRef(const MR_C_std_unique_ptr_int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntRvalueRef`.
/// Parameter `_1` should point to a single object rather than to an array.
/// Parameter `_1` takes ownership of the passed pointer (if not null), and will later call `MR_C_Free()` on it automatically.
MR_C_API void MR_StdUniquePtr_SetIntRvalueRef(int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntRvalueConstRef`.
/// Parameter `_1` should point to a single object rather than to an array.
/// Parameter `_1` takes ownership of the passed pointer (if not null), and will later call `MR_C_Free()` on it automatically.
MR_C_API void MR_StdUniquePtr_SetIntRvalueConstRef(int32_t *_1);
...
MR_C_API int32_t *MR_StdUniquePtr_GetIntArr(void);
...
MR_C_API void MR_StdUniquePtr_SetIntArr(int32_t *_1);

/// Generated from function `MR::StdUniquePtr::SetIntArrDefTrivial`.
/// Parameter `_1` can point to an array.
/// Parameter `_1` takes ownership of the passed pointer (if not null), and will later call `MR_C_FreeArray()` on it automatically.
/// Parameter `_1` defaults to a null pointer in C++.
MR_C_API void MR_StdUniquePtr_SetIntArrDefTrivial(int32_t *_1);
...
/// Parameter `_1` has a default argument: `std::make_unique<int[]>(42)`, pass a null pointer to use it.
MR_C_API void MR_StdUniquePtr_SetIntArrDef(int32_t *const *_1);
...
/// The returned pointer is owning! If not null, it must be deallocated using `MR_C_Free().
MR_C_API const int32_t *MR_StdUniquePtr_GetConstInt(void);

/// Generated from function `MR::StdUniquePtr::GetConstIntArr`.
/// The returned pointer is owning! If not null, it must be deallocated using `MR_C_FreeArray().
MR_C_API const int32_t *MR_StdUniquePtr_GetConstIntArr(void);
