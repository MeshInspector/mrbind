...
// The reference to the parameter `value` might be preserved in this object in element `z`.
// When this function is called, this object will drop object references it had previously in `z`.
