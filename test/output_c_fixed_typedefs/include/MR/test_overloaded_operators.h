...
MR_C_API int32_t MR_C_plus_MR_OverloadedOps_A(MR_OverloadedOps_A *_this, const MR_OverloadedOps_A *_1);
...
/// Parameter `_this` can not be null.
/// Parameter `_1` can not be null.
MR_C_API int32_t MR_C_minus_MR_OverloadedOps_A(MR_OverloadedOps_A *_this, const MR_OverloadedOps_A *_1);
...
/// Parameter `_this` can not be null.
/// Parameter `_1` can not be null.
MR_C_API int32_t MR_OverloadedOps_A_plus_assign(MR_OverloadedOps_A *_this, const MR_OverloadedOps_A *_1);

// Minus assign.
/// Generated from a method of class `MR::OverloadedOps::A` named `operator-=`.
/// Parameter `_this` can not be null.
/// Parameter `_1` can not be null.
MR_C_API int32_t MR_OverloadedOps_A_minus_assign(MR_OverloadedOps_A *_this, const MR_OverloadedOps_A *_1);
...
/// Parameter `_this` can not be null.
/// Parameter `_1` can not be null.
MR_C_API int32_t MR_OverloadedOps_A_at(MR_OverloadedOps_A *_this, const MR_OverloadedOps_A *_1);
...
MR_C_API int32_t MR_C_plus_MR_OverloadedOps_B(const MR_OverloadedOps_B *_1, const MR_OverloadedOps_B *_2);
...
/// Parameter `_1` can not be null.
/// Parameter `_2` can not be null.
MR_C_API int32_t MR_C_minus_MR_OverloadedOps_B(const MR_OverloadedOps_B *_1, const MR_OverloadedOps_B *_2);
...
/// Parameter `_1` can not be null.
/// Parameter `_2` can not be null.
MR_C_API int32_t MR_C_plus_assign_MR_OverloadedOps_B(const MR_OverloadedOps_B *_1, const MR_OverloadedOps_B *_2);

// Minus assign.
/// Generated from function `MR::OverloadedOps::operator-=`.
/// Parameter `_1` can not be null.
/// Parameter `_2` can not be null.
MR_C_API int32_t MR_C_minus_assign_MR_OverloadedOps_B(const MR_OverloadedOps_B *_1, const MR_OverloadedOps_B *_2);
