#ifndef MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H
#define MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_optional_MR_StdOptional_A_has_value(const MR_C_std_optional_MR_StdOptional_A *_this);
...
// Parameter `_this` can not be null. It is a single object.
// The reference to this object might be preserved as the return value.
MR_C_API MR_StdOptional_A *MR_C_std_optional_MR_StdOptional_A_value_mut(MR_C_std_optional_MR_StdOptional_A *_this);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H_2)
#define MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_std_optional.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_OPTIONAL_MR_STDOPTIONAL_A_H_2)
