#ifndef MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H
...
MR_C_API MR_C_std_function_void_from_MR_StdFunction_A *MR_C_std_function_void_from_MR_StdFunction_A_ConstructWithDataPtr(void (*func)(MR_StdFunction_A *_1, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
//   If `*_this_userdata` is     null and `_other_userdata` is non-null, a copy of the functor is being constructed. Perform copying if needed and write the new userdata to `*_this_userdata`.
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
MR_C_API void MR_C_std_function_void_from_MR_StdFunction_A_AssignWithDataPtr(MR_C_std_function_void_from_MR_StdFunction_A *_this, void (*func)(MR_StdFunction_A *_1, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H_2)
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_std_function.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_VOID_FROM_MR_STDFUNCTION_A_H_2)
