...
MR_B_API MR_SeparateB *MR_SeparateB_DefaultConstruct(void);
...
MR_B_API MR_SeparateB *MR_SeparateB_DefaultConstructArray(size_t num_elems);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_SeparateB_Destroy()` to free it when you're done using it.
MR_B_API MR_SeparateB *MR_SeparateB_ConstructFromAnother(const MR_SeparateB *_other);
...
MR_B_API MR_SeparateB *MR_SeparateB_AssignFromAnother(MR_SeparateB *_this, const MR_SeparateB *_other);
