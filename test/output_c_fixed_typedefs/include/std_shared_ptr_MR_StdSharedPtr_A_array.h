#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_has_value(const MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_use_count(const MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_reset(MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *_this);

// Construct an array of the specified size.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_ConstructFromSize(size_t size);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *_this);
...
MR_C_API void MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_StdSharedPtr_A_array *_this, MR_C_std_shared_ptr_void *_target);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H_2)
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H_2
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_MR_STDSHAREDPTR_A_ARRAY_H_2)
