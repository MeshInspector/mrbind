#ifndef MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H
#define MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_vector_MR_CSharp_ExposedLayout_empty(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this);
...
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_resize_with_default_value(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, size_t new_size, const MR_CSharp_ExposedLayout *value);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_shrink_to_fit(MR_C_std_vector_MR_CSharp_ExposedLayout *_this);
...
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_push_back(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, MR_CSharp_ExposedLayout new_elem);

// Removes one element from the end.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_pop_back(MR_C_std_vector_MR_CSharp_ExposedLayout *_this);
...
// The reference to the parameter `new_elem` might be preserved in this object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_insert_at_mutable_iter(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *position, MR_CSharp_ExposedLayout new_elem);

// Erases the element at the specified position.
// Parameter `_this` can not be null. It is a single object.
// Parameter `position` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_erase_at_mutable_iter(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *position);

// Inserts a new element right before the specified position. This version takes the position in form of a const iterator, that's the only difference.
// Parameter `_this` can not be null. It is a single object.
// Parameter `position` can not be null. It is a single object.
// The reference to the parameter `new_elem` might be preserved in this object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_insert_at_iter(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *position, MR_CSharp_ExposedLayout new_elem);

// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
// Parameter `_this` can not be null. It is a single object.
// Parameter `position` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_erase_at_iter(MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *position);
...
MR_C_API bool MR_C_std_vector_MR_CSharp_ExposedLayout_is_begin(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *iter);
...
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_std_vector_MR_CSharp_ExposedLayout_is_begin_mut(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *iter);
...
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_std_vector_MR_CSharp_ExposedLayout_is_end(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *iter);
...
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_std_vector_MR_CSharp_ExposedLayout_is_end_mut(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *iter);

// Convert a const iterator to an index.
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API ptrdiff_t MR_C_std_vector_MR_CSharp_ExposedLayout_to_index(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *iter);

// Convert a mutable iterator to an index.
// Parameter `_this` can not be null. It is a single object.
// Parameter `iter` can not be null. It is a single object.
MR_C_API ptrdiff_t MR_C_std_vector_MR_CSharp_ExposedLayout_to_index_mut(const MR_C_std_vector_MR_CSharp_ExposedLayout *_this, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *iter);
...
// Parameter `iter` can not be null. It is a single object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator_from_mutable(const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *iter);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator_add_assign(MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *_this, ptrdiff_t delta);

// Computes the signed difference between two const iterators. Completes in constant time.
// Parameter `a` can not be null. It is a single object.
// Parameter `b` can not be null. It is a single object.
MR_C_API ptrdiff_t MR_C_sub_MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator(const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *a, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *b);

// Compares two const iterators for equality.
// Parameter `a` can not be null. It is a single object.
// Parameter `b` can not be null. It is a single object.
MR_C_API bool MR_C_equal_MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator(const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *a, const MR_C_std_vector_MR_CSharp_ExposedLayout_const_iterator *b);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_vector_MR_CSharp_ExposedLayout_iterator_add_assign(MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *_this, ptrdiff_t delta);

// Computes the signed difference between two mutable iterators. Completes in constant time.
// Parameter `a` can not be null. It is a single object.
// Parameter `b` can not be null. It is a single object.
MR_C_API ptrdiff_t MR_C_sub_MR_C_std_vector_MR_CSharp_ExposedLayout_iterator(const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *a, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *b);

// Compares two mutable iterators for equality.
// Parameter `a` can not be null. It is a single object.
// Parameter `b` can not be null. It is a single object.
MR_C_API bool MR_C_equal_MR_C_std_vector_MR_CSharp_ExposedLayout_iterator(const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *a, const MR_C_std_vector_MR_CSharp_ExposedLayout_iterator *b);

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H_2)
#define MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_csharp.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_CSHARP_EXPOSEDLAYOUT_H_2)
