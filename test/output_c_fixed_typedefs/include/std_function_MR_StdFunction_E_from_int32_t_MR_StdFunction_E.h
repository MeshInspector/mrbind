...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_MR_StdFunction_E_from_int32_t_MR_StdFunction_E_has_value(const MR_C_std_function_MR_StdFunction_E_from_int32_t_MR_StdFunction_E *_this);
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_MR_StdFunction_E_from_int32_t_MR_StdFunction_E_AssignEx(MR_C_std_function_MR_StdFunction_E_from_int32_t_MR_StdFunction_E *_this, MR_StdFunction_E (*func)(int32_t _1, MR_StdFunction_E _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_E_FROM_INT32_T_MR_STDFUNCTION_E_H_2)
...
#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_E_FROM_INT32_T_MR_STDFUNCTION_E_H_2)
