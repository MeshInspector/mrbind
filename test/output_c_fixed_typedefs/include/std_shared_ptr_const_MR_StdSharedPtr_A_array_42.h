...
#if !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_ARRAY_42_H_2)
...
#endif // !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_ARRAY_42_H_2)
