...
#if !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_STDCONTAINERS_NONDEFAULTCONSTRUCTIBLE_H_2)
...
#endif // !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_VECTOR_MR_STDCONTAINERS_NONDEFAULTCONSTRUCTIBLE_H_2)
