...
typedef struct MR_C_std_vector_uint64_t MR_C_std_vector_uint64_t; // Defined below in this file.
typedef struct MR_C_std_vector_uint64_t_const_iterator MR_C_std_vector_uint64_t_const_iterator; // Defined below in this file.
typedef struct MR_C_std_vector_uint64_t_iterator MR_C_std_vector_uint64_t_iterator; // Defined below in this file.
...
MR_C_API void MR_C_std_vector_uint64_t_ResizeWithDefaultValue(MR_C_std_vector_uint64_t *_this, size_t new_size, const uint64_t *value);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_uint64_t_PushBack(MR_C_std_vector_uint64_t *_this, uint64_t new_elem);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_uint64_t_Insert(MR_C_std_vector_uint64_t *_this, size_t position, uint64_t new_elem);
...
MR_C_API void MR_C_std_vector_uint64_t_InsertAtMutableIter(MR_C_std_vector_uint64_t *_this, const MR_C_std_vector_uint64_t_iterator *position, uint64_t new_elem);
...
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_vector_uint64_t_InsertAtIter(MR_C_std_vector_uint64_t *_this, const MR_C_std_vector_uint64_t_const_iterator *position, uint64_t new_elem);
