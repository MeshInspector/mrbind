...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_const_int32_t_array_has_value(const MR_C_std_shared_ptr_const_int32_t_array *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_const_int32_t_array_reset(MR_C_std_shared_ptr_const_int32_t_array *_this);

// Construct an array of the specified size.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_const_int32_t_array_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_const_int32_t_array *MR_C_std_shared_ptr_const_int32_t_array_ConstructFromSize(size_t size);
...
MR_C_API MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_int32_t_array_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int32_t_array *_this);
...
MR_C_API void MR_C_std_shared_ptr_const_int32_t_array_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int32_t_array *_this, MR_C_std_shared_ptr_const_void *_target);
