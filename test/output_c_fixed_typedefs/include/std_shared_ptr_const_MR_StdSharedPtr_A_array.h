...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_UseCount(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array *_this);
...
MR_C_API void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_Construct(const MR_StdSharedPtr_A *ptr);
...
#if !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_ARRAY_H_2)
...
#endif // !defined(MR_C_DETAIL_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_CONST_MR_STDSHAREDPTR_A_ARRAY_H_2)
