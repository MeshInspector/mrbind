#ifndef MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_MR_StdFunction_A_has_value(const MR_C_std_function_MR_StdFunction_A *_this);

// Destroys the stored callable, making this instance null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_MR_StdFunction_A_reset(MR_C_std_function_MR_StdFunction_A *_this);
...
MR_C_API MR_StdFunction_A *MR_C_std_function_MR_StdFunction_A_call(const MR_C_std_function_MR_StdFunction_A *_this);
...
MR_C_API MR_C_std_function_MR_StdFunction_A *MR_C_std_function_MR_StdFunction_A_ConstructStateless(MR_StdFunction_A *(*func)(MR_C_PassBy *_return_pass_by));
...
//   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
//   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_MR_StdFunction_A_AssignEx(MR_C_std_function_MR_StdFunction_A *_this, MR_StdFunction_A *(*func)(MR_C_PassBy *_return_pass_by, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));

#ifdef __cplusplus
} // extern "C"
#endif

#endif // MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H

#if !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H_2)
#define MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H_2

// Convenience includes for types mentioned in this header. They are here at the bottom to make circular includes harmless.

#include <MR/test_std_function.h>

#endif // !defined(MR_C_DISABLE_CONVENIENCE_INCLUDES) && !defined(MR_C_DETAIL_INCLUDED_STD_FUNCTION_MR_STDFUNCTION_A_H_2)
