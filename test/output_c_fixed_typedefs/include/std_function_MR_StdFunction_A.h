...
MR_C_API MR_C_std_function_MR_StdFunction_A *MR_C_std_function_MR_StdFunction_A_ConstructWithDataPtr(MR_StdFunction_A *(*func)(MR_C_PassBy *_return_pass_by, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
