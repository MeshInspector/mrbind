#ifndef MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_ARRAY_42_H
#define MR_C_DETAIL_INCLUDED_STD_SHARED_PTR_INT32_T_ARRAY_42_H
...
typedef struct MR_C_std_shared_ptr_int32_t_array_42 MR_C_std_shared_ptr_int32_t_array_42;
...
MR_C_API MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_DefaultConstruct(void);

// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
// The array must be destroyed using `MR_C_std_shared_ptr_int32_t_array_42_DestroyArray()`.
// Use `MR_C_std_shared_ptr_int32_t_array_42_OffsetMutablePtr()` and `MR_C_std_shared_ptr_int32_t_array_42_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_DefaultConstructArray(size_t num_elems);

// Constructs a copy of another instance. The source remains alive.
// The reference to the parameter `other` might be preserved in the constructed object.
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_array_42_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_int32_t_array_42 *other);

// Assigns the contents from another instance. Both objects remain alive after the call.
// Parameter `_this` can not be null. It is a single object.
// The reference to the parameter `other` might be preserved in this object.
// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_shared_ptr_int32_t_array_42_AssignFromAnother(MR_C_std_shared_ptr_int32_t_array_42 *_this, MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_int32_t_array_42 *other);

// Destroys a heap-allocated instance of `MR_C_std_shared_ptr_int32_t_array_42`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_shared_ptr_int32_t_array_42_Destroy(const MR_C_std_shared_ptr_int32_t_array_42 *_this);

// Destroys a heap-allocated array of `MR_C_std_shared_ptr_int32_t_array_42`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_shared_ptr_int32_t_array_42_DestroyArray(const MR_C_std_shared_ptr_int32_t_array_42 *_this);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_OffsetPtr(const MR_C_std_shared_ptr_int32_t_array_42 *ptr, ptrdiff_t i);

// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_OffsetMutablePtr(MR_C_std_shared_ptr_int32_t_array_42 *ptr, ptrdiff_t i);

// Returns the stored pointer, possibly null.
// Parameter `_this` can not be null. It is a single object.
// The reference to this object might be preserved as the return value.
MR_C_API int32_t *MR_C_std_shared_ptr_int32_t_array_42_get(const MR_C_std_shared_ptr_int32_t_array_42 *_this);

// Returns true if non-null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_int32_t_array_42_has_value(const MR_C_std_shared_ptr_int32_t_array_42 *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_int32_t_array_42_use_count(const MR_C_std_shared_ptr_int32_t_array_42 *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_int32_t_array_42_reset(MR_C_std_shared_ptr_int32_t_array_42 *_this);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int32_t_array_42_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_shared_ptr_int32_t_array_42 *MR_C_std_shared_ptr_int32_t_array_42_Construct(int32_t *ptr);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_int32_t_array_42_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t_array_42 *_this);
...
MR_C_API void MR_C_std_shared_ptr_int32_t_array_42_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t_array_42 *_this, MR_C_std_shared_ptr_void *_target);
