...
// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_MR_StdSharedPtr_A_has_value(const MR_C_std_shared_ptr_MR_StdSharedPtr_A *_this);
...
// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_MR_StdSharedPtr_A_use_count(const MR_C_std_shared_ptr_MR_StdSharedPtr_A *_this);

// Resets the pointer to null.
// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_MR_StdSharedPtr_A_reset(MR_C_std_shared_ptr_MR_StdSharedPtr_A *_this);
...
// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_MR_StdSharedPtr_A_Destroy()` to free it when you're done using it.
// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_MR_StdSharedPtr_A *MR_C_std_shared_ptr_MR_StdSharedPtr_A_ConstructFromValue(const MR_StdSharedPtr_A *value);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_MR_StdSharedPtr_A_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_StdSharedPtr_A *_this);
...
MR_C_API void MR_C_std_shared_ptr_MR_StdSharedPtr_A_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_MR_StdSharedPtr_A *_this, MR_C_std_shared_ptr_void *_target);
