...
{
    (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::unordered_map<MR::StdContainers::NonAssignable, float>) MRBINDC_CLASSARG_COPY(other, (std::unordered_map<MR::StdContainers::NonAssignable, float>), std::unordered_map<MR::StdContainers::NonAssignable, float>) MRBINDC_CLASSARG_MOVE(other, (std::unordered_map<MR::StdContainers::NonAssignable, float>), std::unordered_map<MR::StdContainers::NonAssignable, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::unordered_map<MR::StdContainers::NonAssignable, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::unordered_map<MR::StdContainers::NonAssignable, float>) MRBINDC_CLASSARG_END(other, std::unordered_map<MR::StdContainers::NonAssignable, float>))
    );
}
...
{
    return (_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}
...
{
    return (_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}
...
{
    (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}
...
{
    return &((_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *(const MR::StdContainers::NonAssignable *)(key) : throw std::runtime_error("Parameter `key` can not be null."))]);
}
...
{
    return (_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const MR::StdContainers::NonAssignable *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator((_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const MR::StdContainers::NonAssignable *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator((_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}
...
{
    return (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}
...
{
    return (_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator((_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}
...
{
    return (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator(std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator(
        (other ? std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator(*(std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator_FromMutable(const MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_iterator *iter)
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_const_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(
        (iter ? std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(*(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_std_unordered_map_MR_StdContainers_NonAssignable_float_iterator *)new std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(
        (other ? std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(*(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator(*(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    return (const MR_StdContainers_NonAssignable *)&((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}
...
{
    ++(_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    return (const MR_StdContainers_NonAssignable *)&((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}
...
{
    ++(_this ? *(std::unordered_map<MR::StdContainers::NonAssignable, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
