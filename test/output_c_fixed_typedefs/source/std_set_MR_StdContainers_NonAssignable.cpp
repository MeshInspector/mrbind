...
{
    (_this ? *(std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::set<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_COPY(other, (std::set<MR::StdContainers::NonAssignable>), std::set<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_MOVE(other, (std::set<MR::StdContainers::NonAssignable>), std::set<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::set<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::set<MR::StdContainers::NonAssignable>) MRBINDC_CLASSARG_END(other, std::set<MR::StdContainers::NonAssignable>))
    );
}
...
{
    return (_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_std_set_MR_StdContainers_NonAssignable_IsEmpty(const MR_C_std_set_MR_StdContainers_NonAssignable *_this)
{
    return (_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_std_set_MR_StdContainers_NonAssignable_Clear(MR_C_std_set_MR_StdContainers_NonAssignable *_this)
{
    (_this ? *(std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}
...
{
    return (_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_std_set_MR_StdContainers_NonAssignable_const_iterator *)new std::set<MR::StdContainers::NonAssignable>::const_iterator((_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const MR::StdContainers::NonAssignable *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    (_this ? *(std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
...
{
    return (MR_C_std_set_MR_StdContainers_NonAssignable_const_iterator *)new std::set<MR::StdContainers::NonAssignable>::const_iterator((_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const std::set<MR::StdContainers::NonAssignable>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_set_MR_StdContainers_NonAssignable_const_iterator *)new std::set<MR::StdContainers::NonAssignable>::const_iterator((_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}
...
{
    return (_this ? *(const std::set<MR::StdContainers::NonAssignable> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const std::set<MR::StdContainers::NonAssignable>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_set_MR_StdContainers_NonAssignable_const_iterator *)new std::set<MR::StdContainers::NonAssignable>::const_iterator(std::set<MR::StdContainers::NonAssignable>::const_iterator(
        (other ? std::set<MR::StdContainers::NonAssignable>::const_iterator(*(std::set<MR::StdContainers::NonAssignable>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::set<MR::StdContainers::NonAssignable>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::set<MR::StdContainers::NonAssignable>::const_iterator(*(std::set<MR::StdContainers::NonAssignable>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    return (const MR_StdContainers_NonAssignable *)&(*(_this ? *(const std::set<MR::StdContainers::NonAssignable>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}
...
{
    ++(_this ? *(std::set<MR::StdContainers::NonAssignable>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
