...
namespace
{
    struct _functor_MR_C_std_function_MR_StdFunction_A
    {
        ...
        _functor_MR_C_std_function_MR_StdFunction_A(FuncPtr _func, void *_userdata, UserdataCbPtr _userdata_cb) : _func(_func), _userdata(_userdata), _userdata_cb(_userdata_cb) {}

        _functor_MR_C_std_function_MR_StdFunction_A(const _functor_MR_C_std_function_MR_StdFunction_A &other) : _func(other._func), _userdata_cb(other._userdata_cb)
        {
        ...
        _functor_MR_C_std_function_MR_StdFunction_A(_functor_MR_C_std_function_MR_StdFunction_A &&other) noexcept : _func(other._func), _userdata(other._userdata), _userdata_cb(other._userdata_cb)
        {
            other._func = nullptr;
...
{
    return (MR_C_std_function_MR_StdFunction_A *)new std::function<MR::StdFunction::A(void)>(func ? std::function<MR::StdFunction::A(void)>(_functor_MR_C_std_function_MR_StdFunction_A{func, userdata, userdata_callback}) : nullptr);
}
...
void MR_C_std_function_MR_StdFunction_A_AssignWithDataPtr(MR_C_std_function_MR_StdFunction_A *_this, MR_StdFunction_A *(*func)(MR_C_PassBy *_return_pass_by, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    ...
    _self = _functor_MR_C_std_function_MR_StdFunction_A{func, userdata, userdata_callback};
}
