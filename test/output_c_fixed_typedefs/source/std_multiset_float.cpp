...
{
    MRBINDC_CLASSARG_GUARD(other, std::multiset<float>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::multiset<float>) MRBINDC_CLASSARG_COPY(other, (std::multiset<float>), std::multiset<float>) MRBINDC_CLASSARG_MOVE(other, (std::multiset<float>), std::multiset<float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::multiset<float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::multiset<float>) MRBINDC_CLASSARG_END(other, std::multiset<float>))
    );
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float> *)(_this)) = std::multiset<float>(ptr, ptr + size);
}

size_t MR_C_std_multiset_float_size(const MR_C_std_multiset_float *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).size();
}

bool MR_C_std_multiset_float_empty(const MR_C_std_multiset_float *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).empty();
}

void MR_C_std_multiset_float_clear(MR_C_std_multiset_float *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float> *)(_this)).clear();
}

size_t MR_C_std_multiset_float_count(const MR_C_std_multiset_float *_this, const float *key)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).count(
...
{
    return (MR_C_std_multiset_float_const_iterator *)new std::multiset<float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_std_multiset_float_const_iterator *)new std::multiset<float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<float>::const_iterator *)(iter));
}

MR_C_std_multiset_float_const_iterator *MR_C_std_multiset_float_end(const MR_C_std_multiset_float *_this)
{
    return (MR_C_std_multiset_float_const_iterator *)new std::multiset<float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).cend());
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<float>::const_iterator *)(iter));
}
...
{
    return (MR_C_std_multiset_float_const_iterator *)new std::multiset<float>::const_iterator(std::multiset<float>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<float>::const_iterator(*(std::multiset<float>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<float>::const_iterator(*(std::multiset<float>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<float>::const_iterator *)(_this)));
}

void MR_C_std_multiset_float_const_iterator_incr(MR_C_std_multiset_float_const_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<float>::const_iterator *)(_this));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::multiset<float>::const_iterator(*(std::multiset<float>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::multiset<float>::const_iterator(*(std::multiset<float>::const_iterator *)b));
}
