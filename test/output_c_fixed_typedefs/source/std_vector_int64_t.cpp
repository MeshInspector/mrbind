...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_COPY(other, (std::vector<MR_C_int64_t>), std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_MOVE(other, (std::vector<MR_C_int64_t>), std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<MR_C_int64_t>) MRBINDC_CLASSARG_END(other, std::vector<MR_C_int64_t>))
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) = std::vector<MR_C_int64_t>(ptr, ptr + size);
}

size_t MR_C_std_vector_int64_t_Size(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_std_vector_int64_t_IsEmpty(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_std_vector_int64_t_Resize(MR_C_std_vector_int64_t *_this, size_t new_size)
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).resize(
        new_size
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

size_t MR_C_std_vector_int64_t_Capacity(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).capacity();
}

void MR_C_std_vector_int64_t_Reserve(MR_C_std_vector_int64_t *_this, size_t new_capacity)
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).reserve(
        new_capacity
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).shrink_to_fit();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_At(const MR_C_std_vector_int64_t *_this, size_t i)
{
    return &((_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).at(
        i
    ));
}
...
{
    return &((_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).at(
        i
    ));
}
...
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? nullptr : &(_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).front();
}

MR_C_int64_t *MR_C_std_vector_int64_t_MutableFront(MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? nullptr : &(_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).front();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_Back(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? nullptr : &(_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).back();
}

MR_C_int64_t *MR_C_std_vector_int64_t_MutableBack(MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? nullptr : &(_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).back();
}

const MR_C_int64_t *MR_C_std_vector_int64_t_Data(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).data();
}

MR_C_int64_t *MR_C_std_vector_int64_t_MutableData(MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).data();
}

void MR_C_std_vector_int64_t_PushBack(MR_C_std_vector_int64_t *_this, MR_C_int64_t new_elem)
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).push_back(
        new_elem
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).pop_back();
}

void MR_C_std_vector_int64_t_Insert(MR_C_std_vector_int64_t *_this, size_t position, MR_C_int64_t new_elem)
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert((_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() + ptrdiff_t(position), new_elem);
}

void MR_C_std_vector_int64_t_Erase(MR_C_std_vector_int64_t *_this, size_t position)
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).erase((_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() + ptrdiff_t(position));
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        (position ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)position) : throw std::runtime_error("Parameter `position` can not be null.")),
        new_elem
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).erase(
        (position ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)position) : throw std::runtime_error("Parameter `position` can not be null."))
    );
}
...
{
    (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        (position ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)position) : throw std::runtime_error("Parameter `position` can not be null.")),
        new_elem
    );
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator((_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const std::vector<MR_C_int64_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_MutableBegin(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator((_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}

bool MR_C_std_vector_int64_t_IsMutableBegin(MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_iterator *iter)
{
    return (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const std::vector<MR_C_int64_t>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_End(const MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator((_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_std_vector_int64_t_IsEnd(const MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_const_iterator *iter)
{
    return (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const std::vector<MR_C_int64_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_MutableEnd(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator((_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}

bool MR_C_std_vector_int64_t_IsMutableEnd(MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_iterator *iter)
{
    return (_this ? *(std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const std::vector<MR_C_int64_t>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (iter ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null.")) - (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin();
}
...
{
    return (iter ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null.")) - (_this ? *(const std::vector<MR_C_int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin();
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(std::vector<MR_C_int64_t>::const_iterator(
        (other ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::vector<MR_C_int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_const_iterator_FromMutable(const MR_C_std_vector_int64_t_iterator *iter)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<MR_C_int64_t>::const_iterator(std::vector<MR_C_int64_t>::iterator(
        (iter ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<MR_C_int64_t>::iterator(std::vector<MR_C_int64_t>::iterator(
        (other ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::vector<MR_C_int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    return &(*(_this ? *(const std::vector<MR_C_int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_std_vector_int64_t_const_iterator_Incr(MR_C_std_vector_int64_t_const_iterator *_this)
{
    ++(_this ? *(std::vector<MR_C_int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    (_this ? *(std::vector<MR_C_int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) += delta;
}
...
{
    return (b ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)b) : throw std::runtime_error("Parameter `b` can not be null.")) - (a ? std::vector<MR_C_int64_t>::const_iterator(*(std::vector<MR_C_int64_t>::const_iterator *)a) : throw std::runtime_error("Parameter `a` can not be null."));
}

MR_C_int64_t *MR_C_std_vector_int64_t_iterator_Deref(const MR_C_std_vector_int64_t_iterator *_this)
{
    return &(*(_this ? *(const std::vector<MR_C_int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_std_vector_int64_t_iterator_Incr(MR_C_std_vector_int64_t_iterator *_this)
{
    ++(_this ? *(std::vector<MR_C_int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    (_this ? *(std::vector<MR_C_int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) += delta;
}
...
{
    return (b ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)b) : throw std::runtime_error("Parameter `b` can not be null.")) - (a ? std::vector<MR_C_int64_t>::iterator(*(std::vector<MR_C_int64_t>::iterator *)a) : throw std::runtime_error("Parameter `a` can not be null."));
}
