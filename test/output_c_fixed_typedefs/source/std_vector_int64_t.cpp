...
{
    return (MR_C_std_vector_int64_t *)new std::vector<int64_t>(std::vector<int64_t>());
}

MR_C_std_vector_int64_t *MR_C_std_vector_int64_t_DefaultConstructArray(size_t num_elems)
{
    return (MR_C_std_vector_int64_t *)(new std::vector<int64_t>[num_elems]{});
}
...
{
    return (MR_C_std_vector_int64_t *)new std::vector<int64_t>(std::vector<int64_t>(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<int64_t>) MRBINDC_CLASSARG_COPY(other, (std::vector<int64_t>), std::vector<int64_t>) MRBINDC_CLASSARG_MOVE(other, (std::vector<int64_t>), std::vector<int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<int64_t>) MRBINDC_CLASSARG_END(other, std::vector<int64_t>))
    ));
}
...
{
    (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::vector<int64_t>) MRBINDC_CLASSARG_COPY(other, (std::vector<int64_t>), std::vector<int64_t>) MRBINDC_CLASSARG_MOVE(other, (std::vector<int64_t>), std::vector<int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::vector<int64_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::vector<int64_t>) MRBINDC_CLASSARG_END(other, std::vector<int64_t>))
    );
}
...
{
    delete ((const std::vector<int64_t> *)_this);
}
...
{
    return (const MR_C_std_vector_int64_t *)(((const std::vector<int64_t> *)ptr) + i);
}
...
{
    return (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}
...
void MR_C_std_vector_int64_t_ResizeWithDefaultValue(MR_C_std_vector_int64_t *_this, size_t new_size, const int64_t *value)
{
    (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).resize(
        new_size,
        (value ? *(const int64_t *)(value) : throw std::runtime_error("Parameter `value` can not be null."))
    );
}

void MR_C_std_vector_int64_t_Clear(MR_C_std_vector_int64_t *_this)
{
    (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

size_t MR_C_std_vector_int64_t_Capacity(const MR_C_std_vector_int64_t *_this)
{
    return (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).capacity();
}

void MR_C_std_vector_int64_t_Reserve(MR_C_std_vector_int64_t *_this, size_t new_capacity)
{
    (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).reserve(
        new_capacity
    );
}
...
{
    return (const int64_t *)&((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).at(
        i
    ));
}
...
{
    return (int64_t *)&((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).at(
        i
    ));
}
...
{
    return (const int64_t *)((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? &(_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).front() : nullptr);
}

int64_t *MR_C_std_vector_int64_t_MutableFront(MR_C_std_vector_int64_t *_this)
{
    return (int64_t *)((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? &(_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).front() : nullptr);
}

const int64_t *MR_C_std_vector_int64_t_Back(const MR_C_std_vector_int64_t *_this)
{
    return (const int64_t *)((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? &(_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).back() : nullptr);
}

int64_t *MR_C_std_vector_int64_t_MutableBack(MR_C_std_vector_int64_t *_this)
{
    return (int64_t *)((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty() ? &(_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).back() : nullptr);
}

const int64_t *MR_C_std_vector_int64_t_Data(const MR_C_std_vector_int64_t *_this)
{
    return (const int64_t *)((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).data());
}

int64_t *MR_C_std_vector_int64_t_MutableData(MR_C_std_vector_int64_t *_this)
{
    return (int64_t *)((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).data());
}
...
{
    (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).erase(
        (position ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)position) : throw std::runtime_error("Parameter `position` can not be null."))
    );
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<int64_t>::const_iterator((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const std::vector<int64_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_MutableBegin(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<int64_t>::iterator((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}

bool MR_C_std_vector_int64_t_IsMutableBegin(MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_iterator *iter)
{
    return (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const std::vector<int64_t>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_End(const MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<int64_t>::const_iterator((_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_std_vector_int64_t_IsEnd(const MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_const_iterator *iter)
{
    return (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const std::vector<int64_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_MutableEnd(MR_C_std_vector_int64_t *_this)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<int64_t>::iterator((_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}

bool MR_C_std_vector_int64_t_IsMutableEnd(MR_C_std_vector_int64_t *_this, const MR_C_std_vector_int64_t_iterator *iter)
{
    return (_this ? *(std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const std::vector<int64_t>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (iter ? std::vector<int64_t>::const_iterator(*(std::vector<int64_t>::const_iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null.")) - (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin();
}
...
{
    return (iter ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null.")) - (_this ? *(const std::vector<int64_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin();
}

MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_const_iterator_DefaultConstruct(void)
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<int64_t>::const_iterator(std::vector<int64_t>::const_iterator());
}

MR_C_std_vector_int64_t_const_iterator *MR_C_std_vector_int64_t_const_iterator_DefaultConstructArray(size_t num_elems)
{
    return (MR_C_std_vector_int64_t_const_iterator *)(new std::vector<int64_t>::const_iterator[num_elems]{});
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<int64_t>::const_iterator(std::vector<int64_t>::const_iterator(
        (other ? std::vector<int64_t>::const_iterator(*(std::vector<int64_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::vector<int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::vector<int64_t>::const_iterator(*(std::vector<int64_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    delete ((const std::vector<int64_t>::const_iterator *)_this);
}
...
{
    return (const MR_C_std_vector_int64_t_const_iterator *)(((const std::vector<int64_t>::const_iterator *)ptr) + i);
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)(((std::vector<int64_t>::const_iterator *)ptr) + i);
}
...
{
    return (MR_C_std_vector_int64_t_const_iterator *)new std::vector<int64_t>::const_iterator(std::vector<int64_t>::iterator(
        (iter ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_iterator_DefaultConstruct(void)
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<int64_t>::iterator(std::vector<int64_t>::iterator());
}

MR_C_std_vector_int64_t_iterator *MR_C_std_vector_int64_t_iterator_DefaultConstructArray(size_t num_elems)
{
    return (MR_C_std_vector_int64_t_iterator *)(new std::vector<int64_t>::iterator[num_elems]{});
}
...
{
    return (MR_C_std_vector_int64_t_iterator *)new std::vector<int64_t>::iterator(std::vector<int64_t>::iterator(
        (other ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::vector<int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    delete ((const std::vector<int64_t>::iterator *)_this);
}
...
{
    return (const MR_C_std_vector_int64_t_iterator *)(((const std::vector<int64_t>::iterator *)ptr) + i);
}
...
{
    return (const int64_t *)&(*(_this ? *(const std::vector<int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_std_vector_int64_t_const_iterator_Incr(MR_C_std_vector_int64_t_const_iterator *_this)
{
    ++(_this ? *(std::vector<int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    (_this ? *(std::vector<int64_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) += delta;
}
...
{
    return (int64_t *)&(*(_this ? *(const std::vector<int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_std_vector_int64_t_iterator_Incr(MR_C_std_vector_int64_t_iterator *_this)
{
    ++(_this ? *(std::vector<int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    (_this ? *(std::vector<int64_t>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) += delta;
}
...
{
    return (b ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)b) : throw std::runtime_error("Parameter `b` can not be null.")) - (a ? std::vector<int64_t>::iterator(*(std::vector<int64_t>::iterator *)a) : throw std::runtime_error("Parameter `a` can not be null."));
}
