...
bool MR_C_std_shared_ptr_int32_t_array_has_value(const MR_C_std_shared_ptr_int32_t_array *_this)
{
...
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int32_t[]> *)(_this))[i]);
}

int MR_C_std_shared_ptr_int32_t_array_use_count(const MR_C_std_shared_ptr_int32_t_array *_this)
{
    return int(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int32_t[]> *)(_this)).use_count());
}

void MR_C_std_shared_ptr_int32_t_array_reset(MR_C_std_shared_ptr_int32_t_array *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int32_t[]> *)(_this)).reset();
}

MR_C_std_shared_ptr_int32_t_array *MR_C_std_shared_ptr_int32_t_array_ConstructFromSize(size_t size)
{
    return (MR_C_std_shared_ptr_int32_t_array *)new std::shared_ptr<int32_t[]>(std::make_shared<int32_t[]>(
        size
    ));
}
...
MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_int32_t_array_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t_array *_this)
{
...
void MR_C_std_shared_ptr_int32_t_array_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int32_t_array *_this, MR_C_std_shared_ptr_void *_target)
{
