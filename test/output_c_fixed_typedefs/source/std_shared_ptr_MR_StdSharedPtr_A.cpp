...
MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_void_ConstructFrom_MR_C_std_shared_ptr_MR_StdSharedPtr_A(MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_MR_StdSharedPtr_A *_other)
{
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<MR::StdSharedPtr::A>);
...
void MR_C_std_shared_ptr_void_AssignFrom_MR_C_std_shared_ptr_MR_StdSharedPtr_A(MR_C_std_shared_ptr_void *_this, MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_MR_StdSharedPtr_A *_other)
{
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<MR::StdSharedPtr::A>);
