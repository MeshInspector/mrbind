...
bool MR_C_std_function_int32_t_has_value(const MR_C_std_function_int32_t *_this)
{
    return bool(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::function<int32_t(void)> *)(_this)));
}

void MR_C_std_function_int32_t_reset(MR_C_std_function_int32_t *_this)
{
...
namespace
{
    struct _functor_MR_C_std_function_int32_t
    {
        ...
        _functor_MR_C_std_function_int32_t(FuncPtr _func, void *_userdata, PostcallCbPtr _postcall_cb, UserdataCbPtr _userdata_cb) : _func(_func), _userdata(_userdata), _postcall_cb(_postcall_cb), _userdata_cb(_userdata_cb) {}

        _functor_MR_C_std_function_int32_t(const _functor_MR_C_std_function_int32_t &other) : _func(other._func), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
        ...
        _functor_MR_C_std_function_int32_t(_functor_MR_C_std_function_int32_t &&other) noexcept : _func(other._func), _userdata(other._userdata), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
            other._func = nullptr;
        ...
        auto operator()(void) -> int32_t
        {
            ...
            {
                _functor_MR_C_std_function_int32_t *_self = nullptr;
                void *_value = nullptr;
                ~_cleanup_guard_type()
                {
...
MR_C_std_function_int32_t *MR_C_std_function_int32_t_ConstructEx(int32_t (*func)(void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    return (MR_C_std_function_int32_t *)new std::function<int32_t(void)>(func ? std::function<int32_t(void)>(_functor_MR_C_std_function_int32_t{func, userdata, postcall_callback, userdata_callback}) : nullptr);
}

void MR_C_std_function_int32_t_AssignEx(MR_C_std_function_int32_t *_this, int32_t (*func)(void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    auto &_self = ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::function<int32_t(void)> *)(_this));
    if (!func)
    {
    ...
    _self = _functor_MR_C_std_function_int32_t{func, userdata, postcall_callback, userdata_callback};
}
