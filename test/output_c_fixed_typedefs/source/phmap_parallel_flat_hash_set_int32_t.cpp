...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::parallel_flat_hash_set<int32_t>);
    return (MR_C_phmap_parallel_flat_hash_set_int32_t *)new phmap::parallel_flat_hash_set<int32_t>(phmap::parallel_flat_hash_set<int32_t>(
...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::parallel_flat_hash_set<int32_t>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::parallel_flat_hash_set<int32_t>) MRBINDC_CLASSARG_COPY(other, (phmap::parallel_flat_hash_set<int32_t>), phmap::parallel_flat_hash_set<int32_t>) MRBINDC_CLASSARG_MOVE(other, (phmap::parallel_flat_hash_set<int32_t>), phmap::parallel_flat_hash_set<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::parallel_flat_hash_set<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::parallel_flat_hash_set<int32_t>) MRBINDC_CLASSARG_END(other, phmap::parallel_flat_hash_set<int32_t>))
    );
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t> *)(_this)) = phmap::parallel_flat_hash_set<int32_t>(ptr, ptr + size);
}

size_t MR_C_phmap_parallel_flat_hash_set_int32_t_size(const MR_C_phmap_parallel_flat_hash_set_int32_t *_this)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).size();
}

bool MR_C_phmap_parallel_flat_hash_set_int32_t_empty(const MR_C_phmap_parallel_flat_hash_set_int32_t *_this)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).empty();
}

void MR_C_phmap_parallel_flat_hash_set_int32_t_clear(MR_C_phmap_parallel_flat_hash_set_int32_t *_this)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t> *)(_this)).clear();
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).contains(
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *)new phmap::parallel_flat_hash_set<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).find(
        ((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *key)
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *)new phmap::parallel_flat_hash_set<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).cbegin());
}

bool MR_C_phmap_parallel_flat_hash_set_int32_t_is_begin(const MR_C_phmap_parallel_flat_hash_set_int32_t *_this, const MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *iter)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).cbegin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *)new phmap::parallel_flat_hash_set<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).cend());
}

bool MR_C_phmap_parallel_flat_hash_set_int32_t_is_end(const MR_C_phmap_parallel_flat_hash_set_int32_t *_this, const MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *iter)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t> *)(_this)).cend() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *)new phmap::parallel_flat_hash_set<int32_t>::const_iterator(phmap::parallel_flat_hash_set<int32_t>::const_iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), phmap::parallel_flat_hash_set<int32_t>::const_iterator(*(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), phmap::parallel_flat_hash_set<int32_t>::const_iterator(*(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int32_t>::const_iterator *)(_this)));
}
...
{
    ++((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)(_this));
}

bool MR_C_equal_MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator(const MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *a, const MR_C_phmap_parallel_flat_hash_set_int32_t_const_iterator *b)
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), phmap::parallel_flat_hash_set<int32_t>::const_iterator(*(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), phmap::parallel_flat_hash_set<int32_t>::const_iterator(*(phmap::parallel_flat_hash_set<int32_t>::const_iterator *)b));
}
