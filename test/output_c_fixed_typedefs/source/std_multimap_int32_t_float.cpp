...
{
    (_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::multimap<int32_t, float>) MRBINDC_CLASSARG_COPY(other, (std::multimap<int32_t, float>), std::multimap<int32_t, float>) MRBINDC_CLASSARG_MOVE(other, (std::multimap<int32_t, float>), std::multimap<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::multimap<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::multimap<int32_t, float>) MRBINDC_CLASSARG_END(other, std::multimap<int32_t, float>))
    );
}
...
{
    return (_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_std_multimap_int32_t_float_IsEmpty(const MR_C_std_multimap_int32_t_float *_this)
{
    return (_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_std_multimap_int32_t_float_Clear(MR_C_std_multimap_int32_t_float *_this)
{
    (_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

size_t MR_C_std_multimap_int32_t_float_Count(const MR_C_std_multimap_int32_t_float *_this, const int32_t *key)
{
    return (_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).count(
...
{
    return (MR_C_std_multimap_int32_t_float_const_iterator *)new std::multimap<int32_t, float>::const_iterator((_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}

MR_C_std_multimap_int32_t_float_iterator *MR_C_std_multimap_int32_t_float_FindMutable(MR_C_std_multimap_int32_t_float *_this, const int32_t *key)
{
    return (MR_C_std_multimap_int32_t_float_iterator *)new std::multimap<int32_t, float>::iterator((_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_std_multimap_int32_t_float_const_iterator *)new std::multimap<int32_t, float>::const_iterator((_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}

bool MR_C_std_multimap_int32_t_float_IsBegin(const MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_const_iterator *iter)
{
    return (_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const std::multimap<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_multimap_int32_t_float_iterator *MR_C_std_multimap_int32_t_float_MutableBegin(MR_C_std_multimap_int32_t_float *_this)
{
    return (MR_C_std_multimap_int32_t_float_iterator *)new std::multimap<int32_t, float>::iterator((_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}

bool MR_C_std_multimap_int32_t_float_IsMutableBegin(MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_iterator *iter)
{
    return (_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const std::multimap<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_multimap_int32_t_float_const_iterator *)new std::multimap<int32_t, float>::const_iterator((_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_std_multimap_int32_t_float_IsEnd(const MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_const_iterator *iter)
{
    return (_this ? *(const std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const std::multimap<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_std_multimap_int32_t_float_iterator *MR_C_std_multimap_int32_t_float_MutableEnd(MR_C_std_multimap_int32_t_float *_this)
{
    return (MR_C_std_multimap_int32_t_float_iterator *)new std::multimap<int32_t, float>::iterator((_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}

bool MR_C_std_multimap_int32_t_float_IsMutableEnd(MR_C_std_multimap_int32_t_float *_this, const MR_C_std_multimap_int32_t_float_iterator *iter)
{
    return (_this ? *(std::multimap<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const std::multimap<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_std_multimap_int32_t_float_const_iterator *)new std::multimap<int32_t, float>::const_iterator(std::multimap<int32_t, float>::const_iterator(
        (other ? std::multimap<int32_t, float>::const_iterator(*(std::multimap<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::multimap<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::multimap<int32_t, float>::const_iterator(*(std::multimap<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
MR_C_std_multimap_int32_t_float_const_iterator *MR_C_std_multimap_int32_t_float_const_iterator_FromMutable(const MR_C_std_multimap_int32_t_float_iterator *iter)
{
    return (MR_C_std_multimap_int32_t_float_const_iterator *)new std::multimap<int32_t, float>::const_iterator(std::multimap<int32_t, float>::iterator(
        (iter ? std::multimap<int32_t, float>::iterator(*(std::multimap<int32_t, float>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_std_multimap_int32_t_float_iterator *)new std::multimap<int32_t, float>::iterator(std::multimap<int32_t, float>::iterator(
        (other ? std::multimap<int32_t, float>::iterator(*(std::multimap<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(std::multimap<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::multimap<int32_t, float>::iterator(*(std::multimap<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
const int32_t *MR_C_std_multimap_int32_t_float_const_iterator_DerefKey(const MR_C_std_multimap_int32_t_float_const_iterator *_this)
{
    return (const int32_t *)&((_this ? *(const std::multimap<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}

const float *MR_C_std_multimap_int32_t_float_const_iterator_DerefValue(const MR_C_std_multimap_int32_t_float_const_iterator *_this)
{
    return &((_this ? *(const std::multimap<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_std_multimap_int32_t_float_const_iterator_Incr(MR_C_std_multimap_int32_t_float_const_iterator *_this)
{
    ++(_this ? *(std::multimap<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
const int32_t *MR_C_std_multimap_int32_t_float_iterator_DerefKey(const MR_C_std_multimap_int32_t_float_iterator *_this)
{
    return (const int32_t *)&((_this ? *(const std::multimap<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}

float *MR_C_std_multimap_int32_t_float_iterator_DerefValue(const MR_C_std_multimap_int32_t_float_iterator *_this)
{
    return &((_this ? *(const std::multimap<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_std_multimap_int32_t_float_iterator_Incr(MR_C_std_multimap_int32_t_float_iterator *_this)
{
    ++(_this ? *(std::multimap<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
