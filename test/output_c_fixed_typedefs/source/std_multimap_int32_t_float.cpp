...
{
    return &((_this ? *(const std::multimap<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const std::multimap<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
