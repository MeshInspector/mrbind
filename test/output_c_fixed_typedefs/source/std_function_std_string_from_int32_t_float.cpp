...
namespace
{
    struct _functor_MR_C_std_function_std_string_from_int32_t_float
    {
        ...
        _functor_MR_C_std_function_std_string_from_int32_t_float(FuncPtr _func, void *_userdata, UserdataCbPtr _userdata_cb) : _func(_func), _userdata(_userdata), _userdata_cb(_userdata_cb) {}

        _functor_MR_C_std_function_std_string_from_int32_t_float(const _functor_MR_C_std_function_std_string_from_int32_t_float &other) : _func(other._func), _userdata_cb(other._userdata_cb)
        {
        ...
        _functor_MR_C_std_function_std_string_from_int32_t_float(_functor_MR_C_std_function_std_string_from_int32_t_float &&other) noexcept : _func(other._func), _userdata(other._userdata), _userdata_cb(other._userdata_cb)
        {
            other._func = nullptr;
...
{
    return (MR_C_std_function_std_string_from_int32_t_float *)new std::function<std::string(int32_t, float)>(func ? std::function<std::string(int32_t, float)>(_functor_MR_C_std_function_std_string_from_int32_t_float{func, userdata, userdata_callback}) : nullptr);
}
...
void MR_C_std_function_std_string_from_int32_t_float_AssignWithDataPtr(MR_C_std_function_std_string_from_int32_t_float *_this, const char *(*func)(const char **_return_end, int32_t _1, float _2, void *_userdata), void *userdata, void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    ...
    _self = _functor_MR_C_std_function_std_string_from_int32_t_float{func, userdata, userdata_callback};
}
