...
{
    (_this ? *(phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::btree_set<int32_t>) MRBINDC_CLASSARG_COPY(other, (phmap::btree_set<int32_t>), phmap::btree_set<int32_t>) MRBINDC_CLASSARG_MOVE(other, (phmap::btree_set<int32_t>), phmap::btree_set<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::btree_set<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::btree_set<int32_t>) MRBINDC_CLASSARG_END(other, phmap::btree_set<int32_t>))
    );
}
...
{
    (_this ? *(phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) = phmap::btree_set<int32_t>(ptr, ptr + size);
}

size_t MR_C_phmap_btree_set_int32_t_Size(const MR_C_phmap_btree_set_int32_t *_this)
{
    return (_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_phmap_btree_set_int32_t_IsEmpty(const MR_C_phmap_btree_set_int32_t *_this)
{
    return (_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_btree_set_int32_t_Clear(MR_C_phmap_btree_set_int32_t *_this)
{
    (_this ? *(phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

bool MR_C_phmap_btree_set_int32_t_Contains(const MR_C_phmap_btree_set_int32_t *_this, const int32_t *key)
{
    return (_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_phmap_btree_set_int32_t_const_iterator *)new phmap::btree_set<int32_t>::const_iterator((_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *key : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_btree_set_int32_t_const_iterator *)new phmap::btree_set<int32_t>::const_iterator((_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}

bool MR_C_phmap_btree_set_int32_t_IsBegin(const MR_C_phmap_btree_set_int32_t *_this, const MR_C_phmap_btree_set_int32_t_const_iterator *iter)
{
    return (_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::btree_set<int32_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_btree_set_int32_t_const_iterator *MR_C_phmap_btree_set_int32_t_End(const MR_C_phmap_btree_set_int32_t *_this)
{
    return (MR_C_phmap_btree_set_int32_t_const_iterator *)new phmap::btree_set<int32_t>::const_iterator((_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_phmap_btree_set_int32_t_IsEnd(const MR_C_phmap_btree_set_int32_t *_this, const MR_C_phmap_btree_set_int32_t_const_iterator *iter)
{
    return (_this ? *(const phmap::btree_set<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::btree_set<int32_t>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_btree_set_int32_t_const_iterator *)new phmap::btree_set<int32_t>::const_iterator(phmap::btree_set<int32_t>::const_iterator(
        (other ? phmap::btree_set<int32_t>::const_iterator(*(phmap::btree_set<int32_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_set<int32_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::btree_set<int32_t>::const_iterator(*(phmap::btree_set<int32_t>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    return &(*(_this ? *(const phmap::btree_set<int32_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_phmap_btree_set_int32_t_const_iterator_Incr(MR_C_phmap_btree_set_int32_t_const_iterator *_this)
{
    ++(_this ? *(phmap::btree_set<int32_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
