...
int MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_42_UseCount(const MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_42 *_this)
{
    return int((_this ? *(const std::shared_ptr<MR::StdSharedPtr::A[42]> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).use_count());
}
