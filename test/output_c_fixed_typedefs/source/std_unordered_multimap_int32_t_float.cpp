...
{
    MRBINDC_CLASSARG_GUARD(other, std::unordered_multimap<int32_t, float>);
    return (MR_C_std_unordered_multimap_int32_t_float *)new std::unordered_multimap<int32_t, float>(std::unordered_multimap<int32_t, float>(
...
{
    MRBINDC_CLASSARG_GUARD(other, std::unordered_multimap<int32_t, float>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::unordered_multimap<int32_t, float>) MRBINDC_CLASSARG_COPY(other, (std::unordered_multimap<int32_t, float>), std::unordered_multimap<int32_t, float>) MRBINDC_CLASSARG_MOVE(other, (std::unordered_multimap<int32_t, float>), std::unordered_multimap<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::unordered_multimap<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::unordered_multimap<int32_t, float>) MRBINDC_CLASSARG_END(other, std::unordered_multimap<int32_t, float>))
    );
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).size();
}

bool MR_C_std_unordered_multimap_int32_t_float_empty(const MR_C_std_unordered_multimap_int32_t_float *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).empty();
}

void MR_C_std_unordered_multimap_int32_t_float_clear(MR_C_std_unordered_multimap_int32_t_float *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float> *)(_this)).clear();
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).count(
...
{
    return (MR_C_std_unordered_multimap_int32_t_float_const_iterator *)new std::unordered_multimap<int32_t, float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}

MR_C_std_unordered_multimap_int32_t_float_iterator *MR_C_std_unordered_multimap_int32_t_float_find_mut(MR_C_std_unordered_multimap_int32_t_float *_this, const int32_t *key)
{
    return (MR_C_std_unordered_multimap_int32_t_float_iterator *)new std::unordered_multimap<int32_t, float>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}
...
{
    return (MR_C_std_unordered_multimap_int32_t_float_const_iterator *)new std::unordered_multimap<int32_t, float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).cbegin());
}

bool MR_C_std_unordered_multimap_int32_t_float_is_begin(const MR_C_std_unordered_multimap_int32_t_float *_this, const MR_C_std_unordered_multimap_int32_t_float_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::const_iterator *)(iter));
}

MR_C_std_unordered_multimap_int32_t_float_iterator *MR_C_std_unordered_multimap_int32_t_float_begin_mut(MR_C_std_unordered_multimap_int32_t_float *_this)
{
    return (MR_C_std_unordered_multimap_int32_t_float_iterator *)new std::unordered_multimap<int32_t, float>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float> *)(_this)).begin());
}

bool MR_C_std_unordered_multimap_int32_t_float_is_begin_mut(const MR_C_std_unordered_multimap_int32_t_float *_this, const MR_C_std_unordered_multimap_int32_t_float_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).begin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::iterator *)(iter));
}
...
{
    return (MR_C_std_unordered_multimap_int32_t_float_const_iterator *)new std::unordered_multimap<int32_t, float>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).cend());
}

bool MR_C_std_unordered_multimap_int32_t_float_is_end(const MR_C_std_unordered_multimap_int32_t_float *_this, const MR_C_std_unordered_multimap_int32_t_float_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::const_iterator *)(iter));
}

MR_C_std_unordered_multimap_int32_t_float_iterator *MR_C_std_unordered_multimap_int32_t_float_end_mut(MR_C_std_unordered_multimap_int32_t_float *_this)
{
    return (MR_C_std_unordered_multimap_int32_t_float_iterator *)new std::unordered_multimap<int32_t, float>::iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float> *)(_this)).end());
}

bool MR_C_std_unordered_multimap_int32_t_float_is_end_mut(const MR_C_std_unordered_multimap_int32_t_float *_this, const MR_C_std_unordered_multimap_int32_t_float_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float> *)(_this)).end() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::iterator *)(iter));
}
...
{
    return (MR_C_std_unordered_multimap_int32_t_float_const_iterator *)new std::unordered_multimap<int32_t, float>::const_iterator(std::unordered_multimap<int32_t, float>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::unordered_multimap<int32_t, float>::const_iterator(*(std::unordered_multimap<int32_t, float>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::unordered_multimap<int32_t, float>::const_iterator(*(std::unordered_multimap<int32_t, float>::const_iterator *)other))
    );
}
...
MR_C_std_unordered_multimap_int32_t_float_const_iterator *MR_C_std_unordered_multimap_int32_t_float_const_iterator_from_mutable(const MR_C_std_unordered_multimap_int32_t_float_iterator *iter)
{
    return (MR_C_std_unordered_multimap_int32_t_float_const_iterator *)new std::unordered_multimap<int32_t, float>::const_iterator(std::unordered_multimap<int32_t, float>::iterator(
        ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), std::unordered_multimap<int32_t, float>::iterator(*(std::unordered_multimap<int32_t, float>::iterator *)iter))
    ));
}
...
{
    return (MR_C_std_unordered_multimap_int32_t_float_iterator *)new std::unordered_multimap<int32_t, float>::iterator(std::unordered_multimap<int32_t, float>::iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::unordered_multimap<int32_t, float>::iterator(*(std::unordered_multimap<int32_t, float>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float>::iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::unordered_multimap<int32_t, float>::iterator(*(std::unordered_multimap<int32_t, float>::iterator *)other))
    );
}
...
const MR_C_std_pair_const_int32_t_float *MR_C_std_unordered_multimap_int32_t_float_const_iterator_deref(const MR_C_std_unordered_multimap_int32_t_float_const_iterator *_this)
{
    return (const MR_C_std_pair_const_int32_t_float *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::const_iterator *)(_this)));
}

const int32_t *MR_C_std_unordered_multimap_int32_t_float_const_iterator_deref_key(const MR_C_std_unordered_multimap_int32_t_float_const_iterator *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::const_iterator *)(_this))->first);
}

const float *MR_C_std_unordered_multimap_int32_t_float_const_iterator_deref_value(const MR_C_std_unordered_multimap_int32_t_float_const_iterator *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::const_iterator *)(_this))->second);
}
...
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float>::const_iterator *)(_this));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::unordered_multimap<int32_t, float>::const_iterator(*(std::unordered_multimap<int32_t, float>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::unordered_multimap<int32_t, float>::const_iterator(*(std::unordered_multimap<int32_t, float>::const_iterator *)b));
}
...
{
    return (MR_C_std_pair_const_int32_t_float *)std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::iterator *)(_this)));
}

const int32_t *MR_C_std_unordered_multimap_int32_t_float_iterator_deref_key(const MR_C_std_unordered_multimap_int32_t_float_iterator *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::iterator *)(_this))->first);
}

float *MR_C_std_unordered_multimap_int32_t_float_iterator_deref_value(const MR_C_std_unordered_multimap_int32_t_float_iterator *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::unordered_multimap<int32_t, float>::iterator *)(_this))->second);
}

void MR_C_std_unordered_multimap_int32_t_float_iterator_incr(MR_C_std_unordered_multimap_int32_t_float_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::unordered_multimap<int32_t, float>::iterator *)(_this));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::unordered_multimap<int32_t, float>::iterator(*(std::unordered_multimap<int32_t, float>::iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::unordered_multimap<int32_t, float>::iterator(*(std::unordered_multimap<int32_t, float>::iterator *)b));
}
