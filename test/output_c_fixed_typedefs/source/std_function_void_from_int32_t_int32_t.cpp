...
MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_DefaultConstruct(void)
{
    return (MR_C_std_function_void_from_int32_t_int32_t *)new std::function<void(int32_t, int32_t)>(std::function<void(int32_t, int32_t)>());
}

MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_DefaultConstructArray(size_t num_elems)
{
    return (MR_C_std_function_void_from_int32_t_int32_t *)(new std::function<void(int32_t, int32_t)>[num_elems]{});
}

MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_function_void_from_int32_t_int32_t *other)
{
...
void MR_C_std_function_void_from_int32_t_int32_t_Destroy(const MR_C_std_function_void_from_int32_t_int32_t *_this)
{
    delete ((const std::function<void(int32_t, int32_t)> *)_this);
}

void MR_C_std_function_void_from_int32_t_int32_t_DestroyArray(const MR_C_std_function_void_from_int32_t_int32_t *_this)
{
    delete[] ((const std::function<void(int32_t, int32_t)> *)_this);
}

const MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_OffsetPtr(const MR_C_std_function_void_from_int32_t_int32_t *ptr, ptrdiff_t i)
{
    return (const MR_C_std_function_void_from_int32_t_int32_t *)(((const std::function<void(int32_t, int32_t)> *)ptr) + i);
}

MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_OffsetMutablePtr(MR_C_std_function_void_from_int32_t_int32_t *ptr, ptrdiff_t i)
{
...
MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_ConstructStateless(void (*func)(int32_t _1, int32_t _2))
{
    return (MR_C_std_function_void_from_int32_t_int32_t *)new std::function<void(int32_t, int32_t)>(func ? std::function<void(int32_t, int32_t)>([_f = func](int32_t _1, int32_t _2) -> void
    {
        _f(
            _1,
            _2
...
namespace
{
    struct _functor_MR_C_std_function_void_from_int32_t_int32_t
    {
        using FuncPtr = void (*)(int32_t _1, int32_t _2, void *_userdata, void **_cleanup_value);
        ...
        _functor_MR_C_std_function_void_from_int32_t_int32_t(FuncPtr _func, void *_userdata, PostcallCbPtr _postcall_cb, UserdataCbPtr _userdata_cb) : _func(_func), _userdata(_userdata), _postcall_cb(_postcall_cb), _userdata_cb(_userdata_cb) {}

        _functor_MR_C_std_function_void_from_int32_t_int32_t(const _functor_MR_C_std_function_void_from_int32_t_int32_t &other) : _func(other._func), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
        ...
        _functor_MR_C_std_function_void_from_int32_t_int32_t(_functor_MR_C_std_function_void_from_int32_t_int32_t &&other) noexcept : _func(other._func), _userdata(other._userdata), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
            other._func = nullptr;
        ...
        _functor_MR_C_std_function_void_from_int32_t_int32_t &operator=(const _functor_MR_C_std_function_void_from_int32_t_int32_t &other)
        {
        ...
        _functor_MR_C_std_function_void_from_int32_t_int32_t &operator=(_functor_MR_C_std_function_void_from_int32_t_int32_t &&other) noexcept
        {
            _func = other._func;
            _userdata = other._userdata;
            _postcall_cb = other._postcall_cb;
        ...
        ~_functor_MR_C_std_function_void_from_int32_t_int32_t()
        {
        ...
        auto operator()(int32_t _1, int32_t _2) -> void
        {
            ...
            {
                _functor_MR_C_std_function_void_from_int32_t_int32_t *_self = nullptr;
                void *_value = nullptr;
                ~_cleanup_guard_type()
                {
...
MR_C_std_function_void_from_int32_t_int32_t *MR_C_std_function_void_from_int32_t_int32_t_ConstructEx(void (*func)(int32_t _1, int32_t _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    return (MR_C_std_function_void_from_int32_t_int32_t *)new std::function<void(int32_t, int32_t)>(func ? std::function<void(int32_t, int32_t)>(_functor_MR_C_std_function_void_from_int32_t_int32_t{func, userdata, postcall_callback, userdata_callback}) : nullptr);
}
...
void MR_C_std_function_void_from_int32_t_int32_t_AssignEx(MR_C_std_function_void_from_int32_t_int32_t *_this, void (*func)(int32_t _1, int32_t _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata))
{
    ...
    _self = _functor_MR_C_std_function_void_from_int32_t_int32_t{func, userdata, postcall_callback, userdata_callback};
}
