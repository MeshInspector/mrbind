...
{
    (_this ? *(std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_COPY(other, (std::variant<int32_t, float, std::string>), std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_MOVE(other, (std::variant<int32_t, float, std::string>), std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_END(other, std::variant<int32_t, float, std::string>))
    );
}
...
{
    return (_this ? *(const std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).index();
}
...
{
    return (MR_C_std_variant_int32_t_float_std_string *)new std::variant<int32_t, float, std::string>(std::variant<int32_t, float, std::string>(std::in_place_index<2>, (value ? (value_end ? std::string(value, value_end) : std::string(value)) : throw std::runtime_error("Parameter `value` can not be null."))));
}
...
{
    auto &_self = (_this ? *(std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
    if (_self.index() == 0)
...
{
    return std::get_if<1>(&(_this ? *(const std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

float *MR_C_std_variant_int32_t_float_std_string_GetMutable_float(MR_C_std_variant_int32_t_float_std_string *_this)
{
    return std::get_if<1>(&(_this ? *(std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}
...
{
    return (const MR_C_std_string *)(std::get_if<2>(&(_this ? *(const std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))));
}
...
{
    return (MR_C_std_string *)(std::get_if<2>(&(_this ? *(std::variant<int32_t, float, std::string> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))));
}
