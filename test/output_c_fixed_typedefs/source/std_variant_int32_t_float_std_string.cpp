...
{
    MRBINDC_CLASSARG_GUARD(other, std::variant<int32_t, float, std::string>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::variant<int32_t, float, std::string> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_COPY(other, (std::variant<int32_t, float, std::string>), std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_MOVE(other, (std::variant<int32_t, float, std::string>), std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::variant<int32_t, float, std::string>) MRBINDC_CLASSARG_END(other, std::variant<int32_t, float, std::string>))
    );
}
...
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::variant<int32_t, float, std::string> *)(_this)).index();
}
...
{
    return (MR_C_std_variant_int32_t_float_std_string *)new std::variant<int32_t, float, std::string>(std::variant<int32_t, float, std::string>(std::in_place_index<2>, ((value ? void() : MRBINDC_THROW("Parameter `value` can not be null.", void)), (value_end ? std::string(value, value_end) : std::string(value)))));
}
...
{
    auto &_self = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::variant<int32_t, float, std::string> *)(_this));
    if (_self.index() == 0)
...
{
    return std::get_if<0>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::variant<int32_t, float, std::string> *)(_this)));
}

int32_t *MR_C_std_variant_int32_t_float_std_string_get_int32_t_mut(MR_C_std_variant_int32_t_float_std_string *_this)
{
    return std::get_if<0>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::variant<int32_t, float, std::string> *)(_this)));
}

const float *MR_C_std_variant_int32_t_float_std_string_get_float(const MR_C_std_variant_int32_t_float_std_string *_this)
{
    return std::get_if<1>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::variant<int32_t, float, std::string> *)(_this)));
}

float *MR_C_std_variant_int32_t_float_std_string_get_float_mut(MR_C_std_variant_int32_t_float_std_string *_this)
{
    return std::get_if<1>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::variant<int32_t, float, std::string> *)(_this)));
}
...
{
    return (const MR_C_std_string *)(std::get_if<2>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::variant<int32_t, float, std::string> *)(_this))));
}
...
{
    return (MR_C_std_string *)(std::get_if<2>(&((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::variant<int32_t, float, std::string> *)(_this))));
}
