...
{
    (_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::flat_hash_map<int32_t, float>) MRBINDC_CLASSARG_COPY(other, (phmap::flat_hash_map<int32_t, float>), phmap::flat_hash_map<int32_t, float>) MRBINDC_CLASSARG_MOVE(other, (phmap::flat_hash_map<int32_t, float>), phmap::flat_hash_map<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::flat_hash_map<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::flat_hash_map<int32_t, float>) MRBINDC_CLASSARG_END(other, phmap::flat_hash_map<int32_t, float>))
    );
}
...
{
    return (_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_phmap_flat_hash_map_int32_t_float_IsEmpty(const MR_C_phmap_flat_hash_map_int32_t_float *_this)
{
    return (_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_flat_hash_map_int32_t_float_Clear(MR_C_phmap_flat_hash_map_int32_t_float *_this)
{
    (_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}
...
{
    return &((_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))]);
}
...
{
    return (_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *)new phmap::flat_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_iterator *)new phmap::flat_hash_map<int32_t, float>::iterator((_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *)new phmap::flat_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_iterator *)new phmap::flat_hash_map<int32_t, float>::iterator((_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}
...
{
    return (_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const phmap::flat_hash_map<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *)new phmap::flat_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}
...
{
    return (_this ? *(const phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_iterator *)new phmap::flat_hash_map<int32_t, float>::iterator((_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}
...
{
    return (_this ? *(phmap::flat_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const phmap::flat_hash_map<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *)new phmap::flat_hash_map<int32_t, float>::const_iterator(phmap::flat_hash_map<int32_t, float>::const_iterator(
        (other ? phmap::flat_hash_map<int32_t, float>::const_iterator(*(phmap::flat_hash_map<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::flat_hash_map<int32_t, float>::const_iterator(*(phmap::flat_hash_map<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *MR_C_phmap_flat_hash_map_int32_t_float_const_iterator_FromMutable(const MR_C_phmap_flat_hash_map_int32_t_float_iterator *iter)
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_const_iterator *)new phmap::flat_hash_map<int32_t, float>::const_iterator(phmap::flat_hash_map<int32_t, float>::iterator(
        (iter ? phmap::flat_hash_map<int32_t, float>::iterator(*(phmap::flat_hash_map<int32_t, float>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_flat_hash_map_int32_t_float_iterator *)new phmap::flat_hash_map<int32_t, float>::iterator(phmap::flat_hash_map<int32_t, float>::iterator(
        (other ? phmap::flat_hash_map<int32_t, float>::iterator(*(phmap::flat_hash_map<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::flat_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::flat_hash_map<int32_t, float>::iterator(*(phmap::flat_hash_map<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
{
    return (const int32_t *)&((_this ? *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}
...
{
    ++(_this ? *(phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    return (const int32_t *)&((_this ? *(const phmap::flat_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const phmap::flat_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_phmap_flat_hash_map_int32_t_float_iterator_Incr(MR_C_phmap_flat_hash_map_int32_t_float_iterator *_this)
{
    ++(_this ? *(phmap::flat_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
