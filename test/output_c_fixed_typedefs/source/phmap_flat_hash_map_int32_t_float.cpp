...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::flat_hash_map<int32_t, float> *)(_this))[((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *key)]);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this))->first);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int32_t, float>::const_iterator *)(_this))->second);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int32_t, float>::iterator *)(_this))->first);
}
...
{
    return &(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::flat_hash_map<int32_t, float>::iterator *)(_this))->second);
}
