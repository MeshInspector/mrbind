...
{
    return (MR_C_std_deque_int32_t_const_iterator *)new std::deque<int32_t>::const_iterator(std::deque<int32_t>::const_iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::deque<int32_t>::const_iterator(*(std::deque<int32_t>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::deque<int32_t>::const_iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::deque<int32_t>::const_iterator(*(std::deque<int32_t>::const_iterator *)other))
    );
}
...
{
    return (MR_C_std_deque_int32_t_iterator *)new std::deque<int32_t>::iterator(std::deque<int32_t>::iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::deque<int32_t>::iterator(*(std::deque<int32_t>::iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::deque<int32_t>::iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), std::deque<int32_t>::iterator(*(std::deque<int32_t>::iterator *)other))
    );
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::deque<int32_t>::const_iterator(*(std::deque<int32_t>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::deque<int32_t>::const_iterator(*(std::deque<int32_t>::const_iterator *)b));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::deque<int32_t>::iterator(*(std::deque<int32_t>::iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::deque<int32_t>::iterator(*(std::deque<int32_t>::iterator *)b));
}
