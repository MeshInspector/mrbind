...
{
    return &((_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *key : throw std::runtime_error("Parameter `key` can not be null."))]);
}
...
{
    return &((_this ? *(const phmap::node_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const phmap::node_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
