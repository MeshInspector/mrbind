...
{
    (_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::node_hash_map<int32_t, float>) MRBINDC_CLASSARG_COPY(other, (phmap::node_hash_map<int32_t, float>), phmap::node_hash_map<int32_t, float>) MRBINDC_CLASSARG_MOVE(other, (phmap::node_hash_map<int32_t, float>), phmap::node_hash_map<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::node_hash_map<int32_t, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::node_hash_map<int32_t, float>) MRBINDC_CLASSARG_END(other, phmap::node_hash_map<int32_t, float>))
    );
}
...
{
    return (_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_phmap_node_hash_map_int32_t_float_IsEmpty(const MR_C_phmap_node_hash_map_int32_t_float *_this)
{
    return (_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_node_hash_map_int32_t_float_Clear(MR_C_phmap_node_hash_map_int32_t_float *_this)
{
    (_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

float *MR_C_phmap_node_hash_map_int32_t_float_FindOrConstructElem(MR_C_phmap_node_hash_map_int32_t_float *_this, const int32_t *key)
{
    return &((_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))]);
}
...
{
    return (_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_phmap_node_hash_map_int32_t_float_const_iterator *)new phmap::node_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}

MR_C_phmap_node_hash_map_int32_t_float_iterator *MR_C_phmap_node_hash_map_int32_t_float_FindMutable(MR_C_phmap_node_hash_map_int32_t_float *_this, const int32_t *key)
{
    return (MR_C_phmap_node_hash_map_int32_t_float_iterator *)new phmap::node_hash_map<int32_t, float>::iterator((_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_node_hash_map_int32_t_float_const_iterator *)new phmap::node_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}

bool MR_C_phmap_node_hash_map_int32_t_float_IsBegin(const MR_C_phmap_node_hash_map_int32_t_float *_this, const MR_C_phmap_node_hash_map_int32_t_float_const_iterator *iter)
{
    return (_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::node_hash_map<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_node_hash_map_int32_t_float_iterator *MR_C_phmap_node_hash_map_int32_t_float_MutableBegin(MR_C_phmap_node_hash_map_int32_t_float *_this)
{
    return (MR_C_phmap_node_hash_map_int32_t_float_iterator *)new phmap::node_hash_map<int32_t, float>::iterator((_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}

bool MR_C_phmap_node_hash_map_int32_t_float_IsMutableBegin(MR_C_phmap_node_hash_map_int32_t_float *_this, const MR_C_phmap_node_hash_map_int32_t_float_iterator *iter)
{
    return (_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const phmap::node_hash_map<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_node_hash_map_int32_t_float_const_iterator *)new phmap::node_hash_map<int32_t, float>::const_iterator((_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_phmap_node_hash_map_int32_t_float_IsEnd(const MR_C_phmap_node_hash_map_int32_t_float *_this, const MR_C_phmap_node_hash_map_int32_t_float_const_iterator *iter)
{
    return (_this ? *(const phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::node_hash_map<int32_t, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_node_hash_map_int32_t_float_iterator *MR_C_phmap_node_hash_map_int32_t_float_MutableEnd(MR_C_phmap_node_hash_map_int32_t_float *_this)
{
    return (MR_C_phmap_node_hash_map_int32_t_float_iterator *)new phmap::node_hash_map<int32_t, float>::iterator((_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}

bool MR_C_phmap_node_hash_map_int32_t_float_IsMutableEnd(MR_C_phmap_node_hash_map_int32_t_float *_this, const MR_C_phmap_node_hash_map_int32_t_float_iterator *iter)
{
    return (_this ? *(phmap::node_hash_map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const phmap::node_hash_map<int32_t, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_node_hash_map_int32_t_float_const_iterator *)new phmap::node_hash_map<int32_t, float>::const_iterator(phmap::node_hash_map<int32_t, float>::const_iterator(
        (other ? phmap::node_hash_map<int32_t, float>::const_iterator(*(phmap::node_hash_map<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::node_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::node_hash_map<int32_t, float>::const_iterator(*(phmap::node_hash_map<int32_t, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
MR_C_phmap_node_hash_map_int32_t_float_const_iterator *MR_C_phmap_node_hash_map_int32_t_float_const_iterator_FromMutable(const MR_C_phmap_node_hash_map_int32_t_float_iterator *iter)
{
    return (MR_C_phmap_node_hash_map_int32_t_float_const_iterator *)new phmap::node_hash_map<int32_t, float>::const_iterator(phmap::node_hash_map<int32_t, float>::iterator(
        (iter ? phmap::node_hash_map<int32_t, float>::iterator(*(phmap::node_hash_map<int32_t, float>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_node_hash_map_int32_t_float_iterator *)new phmap::node_hash_map<int32_t, float>::iterator(phmap::node_hash_map<int32_t, float>::iterator(
        (other ? phmap::node_hash_map<int32_t, float>::iterator(*(phmap::node_hash_map<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::node_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::node_hash_map<int32_t, float>::iterator(*(phmap::node_hash_map<int32_t, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}
...
const int32_t *MR_C_phmap_node_hash_map_int32_t_float_const_iterator_DerefKey(const MR_C_phmap_node_hash_map_int32_t_float_const_iterator *_this)
{
    return (const int32_t *)&((_this ? *(const phmap::node_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}

const float *MR_C_phmap_node_hash_map_int32_t_float_const_iterator_DerefValue(const MR_C_phmap_node_hash_map_int32_t_float_const_iterator *_this)
{
    return &((_this ? *(const phmap::node_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}
...
{
    ++(_this ? *(phmap::node_hash_map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}

const int32_t *MR_C_phmap_node_hash_map_int32_t_float_iterator_DerefKey(const MR_C_phmap_node_hash_map_int32_t_float_iterator *_this)
{
    return (const int32_t *)&((_this ? *(const phmap::node_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}

float *MR_C_phmap_node_hash_map_int32_t_float_iterator_DerefValue(const MR_C_phmap_node_hash_map_int32_t_float_iterator *_this)
{
    return &((_this ? *(const phmap::node_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_phmap_node_hash_map_int32_t_float_iterator_Incr(MR_C_phmap_node_hash_map_int32_t_float_iterator *_this)
{
    ++(_this ? *(phmap::node_hash_map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
