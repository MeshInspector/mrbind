...
{
    return (MR_C_std_optional_int32_t *)new std::optional<int32_t>(std::optional<int32_t>(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::optional<int32_t>(*(std::optional<int32_t> *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::optional<int32_t> *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::optional<int32_t>(*(std::optional<int32_t> *)other))
    );
}
...
bool MR_C_std_optional_int32_t_has_value(const MR_C_std_optional_int32_t *_this)
{
    return bool(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::optional<int32_t> *)(_this)));
}

const int32_t *MR_C_std_optional_int32_t_value(const MR_C_std_optional_int32_t *_this)
{
    auto &_self = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::optional<int32_t> *)(_this));
    return _self ? &*_self : nullptr;
}

int32_t *MR_C_std_optional_int32_t_value_mut(MR_C_std_optional_int32_t *_this)
{
    auto &_self = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::optional<int32_t> *)(_this));
    return _self ? &*_self : nullptr;
}
