...
{
    return &((_this ? *(std::map<int32_t, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *(const int32_t *)(key) : throw std::runtime_error("Parameter `key` can not be null."))]);
}
...
{
    return (const int32_t *)&((_this ? *(const std::map<int32_t, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return (const int32_t *)&((_this ? *(const std::map<int32_t, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
