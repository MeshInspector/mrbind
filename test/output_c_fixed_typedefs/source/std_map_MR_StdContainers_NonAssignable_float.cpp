...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).begin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::iterator *)(iter));
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::map<MR::StdContainers::NonAssignable, float> *)(_this)).end() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const std::map<MR::StdContainers::NonAssignable, float>::iterator *)(iter));
}
