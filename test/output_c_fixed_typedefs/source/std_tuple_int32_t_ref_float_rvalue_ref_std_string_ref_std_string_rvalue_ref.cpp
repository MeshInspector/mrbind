...
{
    return std::addressof(std::get<0>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t &, float &&, std::string &, std::string &&> *)(_this))));
}
...
{
    return std::addressof(mrbindc_details::unmove(std::get<1>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t &, float &&, std::string &, std::string &&> *)(_this)))));
}
...
{
    return (MR_C_std_string *)std::addressof(std::get<2>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t &, float &&, std::string &, std::string &&> *)(_this))));
}
...
{
    return (MR_C_std_string *)std::addressof(mrbindc_details::unmove(std::get<3>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t &, float &&, std::string &, std::string &&> *)(_this)))));
}
