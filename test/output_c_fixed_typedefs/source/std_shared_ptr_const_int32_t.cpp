...
bool MR_C_std_shared_ptr_const_int32_t_has_value(const MR_C_std_shared_ptr_const_int32_t *_this)
{
...
void MR_C_std_shared_ptr_const_int32_t_reset(MR_C_std_shared_ptr_const_int32_t *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const int32_t> *)(_this)).reset();
}

MR_C_std_shared_ptr_const_int32_t *MR_C_std_shared_ptr_const_int32_t_ConstructFromValue(int32_t value)
{
    return (MR_C_std_shared_ptr_const_int32_t *)new std::shared_ptr<const int32_t>(std::make_shared<const int32_t>(
        value
    ));
}
...
MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_int32_t_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int32_t *_this)
{
...
void MR_C_std_shared_ptr_const_int32_t_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_int32_t *_this, MR_C_std_shared_ptr_const_void *_target)
{
