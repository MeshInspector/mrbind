...
{
    return (MR_C_std_tuple_int32_t_float *)new std::tuple<int32_t, float>(std::tuple<int32_t, float>(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::tuple<int32_t, float>(*(std::tuple<int32_t, float> *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::tuple<int32_t, float> *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::tuple<int32_t, float>(*(std::tuple<int32_t, float> *)other))
    );
}
...
{
    return std::addressof(std::get<0>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t, float> *)(_this))));
}

int32_t *MR_C_std_tuple_int32_t_float_get_int32_t_mut(MR_C_std_tuple_int32_t_float *_this)
{
    return std::addressof(std::get<0>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::tuple<int32_t, float> *)(_this))));
}

const float *MR_C_std_tuple_int32_t_float_get_float(const MR_C_std_tuple_int32_t_float *_this)
{
    return std::addressof(std::get<1>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::tuple<int32_t, float> *)(_this))));
}

float *MR_C_std_tuple_int32_t_float_get_float_mut(MR_C_std_tuple_int32_t_float *_this)
{
    return std::addressof(std::get<1>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::tuple<int32_t, float> *)(_this))));
}
