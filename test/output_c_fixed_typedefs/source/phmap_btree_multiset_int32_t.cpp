...
{
    (_this ? *(phmap::btree_multiset<int32_t> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")) = phmap::btree_multiset<int32_t>(ptr, ptr + size);
}
...
{
    return &(*(_this ? *(const phmap::btree_multiset<int32_t>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}
