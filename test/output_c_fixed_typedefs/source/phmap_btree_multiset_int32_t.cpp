...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::btree_multiset<int32_t>);
    return (MR_C_phmap_btree_multiset_int32_t *)new phmap::btree_multiset<int32_t>(phmap::btree_multiset<int32_t>(
...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::btree_multiset<int32_t>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_COPY(other, (phmap::btree_multiset<int32_t>), phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_MOVE(other, (phmap::btree_multiset<int32_t>), phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_END(other, phmap::btree_multiset<int32_t>))
    );
}
...
MR_C_phmap_btree_multiset_int32_t *MR_C_phmap_btree_multiset_int32_t_ConstructFromRange(const int32_t *ptr, size_t size)
{
    return (MR_C_phmap_btree_multiset_int32_t *)new phmap::btree_multiset<int32_t>(phmap::btree_multiset<int32_t>(ptr, ptr + size));
}

void MR_C_phmap_btree_multiset_int32_t_AssignFromRange(MR_C_phmap_btree_multiset_int32_t *_this, const int32_t *ptr, size_t size)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t> *)(_this)) = phmap::btree_multiset<int32_t>(ptr, ptr + size);
}

size_t MR_C_phmap_btree_multiset_int32_t_size(const MR_C_phmap_btree_multiset_int32_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).size();
}

bool MR_C_phmap_btree_multiset_int32_t_empty(const MR_C_phmap_btree_multiset_int32_t *_this)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).empty();
}

void MR_C_phmap_btree_multiset_int32_t_clear(MR_C_phmap_btree_multiset_int32_t *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t> *)(_this)).clear();
}

size_t MR_C_phmap_btree_multiset_int32_t_count(const MR_C_phmap_btree_multiset_int32_t *_this, const int32_t *key)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).count(
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).cbegin());
}

bool MR_C_phmap_btree_multiset_int32_t_is_begin(const MR_C_phmap_btree_multiset_int32_t *_this, const MR_C_phmap_btree_multiset_int32_t_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const phmap::btree_multiset<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).cend());
}

bool MR_C_phmap_btree_multiset_int32_t_is_end(const MR_C_phmap_btree_multiset_int32_t *_this, const MR_C_phmap_btree_multiset_int32_t_const_iterator *iter)
{
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const phmap::btree_multiset<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(phmap::btree_multiset<int32_t>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const phmap::btree_multiset<int32_t>::const_iterator *)(_this)));
}

void MR_C_phmap_btree_multiset_int32_t_const_iterator_incr(MR_C_phmap_btree_multiset_int32_t_const_iterator *_this)
{
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(phmap::btree_multiset<int32_t>::const_iterator *)(_this));
}
...
{
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)b));
}
