...
{
    MRBINDC_CLASSARG_GUARD(other, phmap::btree_multiset<int32_t>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::btree_multiset<int32_t> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_COPY(other, (phmap::btree_multiset<int32_t>), phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_MOVE(other, (phmap::btree_multiset<int32_t>), phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::btree_multiset<int32_t>) MRBINDC_CLASSARG_END(other, phmap::btree_multiset<int32_t>))
    );
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::btree_multiset<int32_t> *)(_this)) = phmap::btree_multiset<int32_t>(ptr, ptr + size);
}

size_t MR_C_phmap_btree_multiset_int32_t_size(const MR_C_phmap_btree_multiset_int32_t *_this)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).size();
}

bool MR_C_phmap_btree_multiset_int32_t_empty(const MR_C_phmap_btree_multiset_int32_t *_this)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).empty();
}

void MR_C_phmap_btree_multiset_int32_t_clear(MR_C_phmap_btree_multiset_int32_t *_this)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::btree_multiset<int32_t> *)(_this)).clear();
}

size_t MR_C_phmap_btree_multiset_int32_t_count(const MR_C_phmap_btree_multiset_int32_t *_this, const int32_t *key)
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).count(
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).find(
        ((key ? void() : throw std::runtime_error("Parameter `key` can not be null.")), *key)
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::btree_multiset<int32_t> *)(_this)).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).cbegin());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).cbegin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::btree_multiset<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).cend());
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t> *)(_this)).cend() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::btree_multiset<int32_t>::const_iterator *)(iter));
}
...
{
    return (MR_C_phmap_btree_multiset_int32_t_const_iterator *)new phmap::btree_multiset<int32_t>::const_iterator(phmap::btree_multiset<int32_t>::const_iterator(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)other))
    ));
}
...
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(phmap::btree_multiset<int32_t>::const_iterator *)(_this)).operator=(
        ((other ? void() : throw std::runtime_error("Parameter `other` can not be null.")), phmap::btree_multiset<int32_t>::const_iterator(*(phmap::btree_multiset<int32_t>::const_iterator *)other))
    );
}
...
{
    return std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_multiset<int32_t>::const_iterator *)(_this)));
}
