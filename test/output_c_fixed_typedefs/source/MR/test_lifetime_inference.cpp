...
const int32_t *MR_LifetimeInference_A_Get_x(const MR_LifetimeInference_A *_this)
{
...
void MR_LifetimeInference_A_Set_x(MR_LifetimeInference_A *_this, int32_t value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::LifetimeInference::A *)(_this)).x = value;
}

int32_t *MR_LifetimeInference_A_GetMutable_x(MR_LifetimeInference_A *_this)
{
...
MR_LifetimeInference_A *MR_LifetimeInference_A_ConstructFrom(int32_t x)
{
    return (MR_LifetimeInference_A *)new MR::LifetimeInference::A(MR::LifetimeInference::A{
        x
    });
...
int32_t *MR_LifetimeInference_end_MR_LifetimeInference_A(MR_LifetimeInference_A *a)
{
...
const int32_t *MR_LifetimeInference_B_Get_x(const MR_LifetimeInference_B *_this)
{
...
void MR_LifetimeInference_B_Set_x(MR_LifetimeInference_B *_this, int32_t value)
{
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::LifetimeInference::B *)(_this)).x = value;
}

int32_t *MR_LifetimeInference_B_GetMutable_x(MR_LifetimeInference_B *_this)
{
...
MR_LifetimeInference_B *MR_LifetimeInference_B_ConstructFrom(int32_t x)
{
    return (MR_LifetimeInference_B *)new MR::LifetimeInference::B(MR::LifetimeInference::B{
        x
    });
...
int32_t *MR_LifetimeInference_begin_MR_LifetimeInference_B(MR_LifetimeInference_B *b)
{
    return begin(
...
int32_t *MR_LifetimeInference_end_MR_LifetimeInference_B(MR_LifetimeInference_B *b)
{
    return end(
        ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), *(MR::LifetimeInference::B *)(b))
    );
...
MR_LifetimeInference_C *MR_LifetimeInference_C_Construct(MR_LifetimeInference_A *_1, int32_t *_2, int32_t _3)
{
    return (MR_LifetimeInference_C *)new MR::LifetimeInference::C(MR::LifetimeInference::C(
