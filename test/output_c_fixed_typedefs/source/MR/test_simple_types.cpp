...
void MR_TestSimpleTypes_SetIntPtrDef(int32_t *const *_1)
{
    ::MR::TestSimpleTypes::SetIntPtrDef(
        (_1 ? *_1 : static_cast<int32_t *>(&MR::TestSimpleTypes::global_int))
    );
}
...
void MR_TestSimpleTypes_SetVoidPtrDef(void *const *_1)
{
    ::MR::TestSimpleTypes::SetVoidPtrDef(
        (_1 ? *_1 : static_cast<void *>(&MR::TestSimpleTypes::global_int))
    );
}
...
void MR_TestSimpleTypes_SetConstVoidPtrDef(const void *const *_1)
{
    ::MR::TestSimpleTypes::SetConstVoidPtrDef(
        (_1 ? *_1 : static_cast<const void *>(&MR::TestSimpleTypes::global_int))
    );
}
...
void MR_TestSimpleTypes_SetVoidPtrPtrDef(void **const *_1)
{
    ::MR::TestSimpleTypes::SetVoidPtrPtrDef(
        (_1 ? *_1 : static_cast<void **>(&MR::TestSimpleTypes::global_void_ptr))
    );
}
...
void MR_TestSimpleTypes_SetEnumPtrDef(MR_TestSimpleTypes_E *const *_1)
{
    ::MR::TestSimpleTypes::SetEnumPtrDef(
        (_1 ? (MR::TestSimpleTypes::E *)(*_1) : static_cast<MR::TestSimpleTypes::E *>(&MR::TestSimpleTypes::global_enum))
    );
}
...
void MR_TestSimpleTypes_SetEnum2PtrDef(MR_TestSimpleTypes_E2 *const *_1)
{
    ::MR::TestSimpleTypes::SetEnum2PtrDef(
        (_1 ? (MR::TestSimpleTypes::E2 *)(*_1) : static_cast<MR::TestSimpleTypes::E2 *>(&MR::TestSimpleTypes::global_enum2))
    );
}
...
MR_TestSimpleTypes_ClassTemplate_uint64_t *MR_TestSimpleTypes_ClassTemplate_uint64_t_ConstructFromAnother(const MR_TestSimpleTypes_ClassTemplate_uint64_t *_other)
{
    return (MR_TestSimpleTypes_ClassTemplate_uint64_t *)new MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t>(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t>(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t>(*(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)_other))
    ));
}
...
{
    return (MR_TestSimpleTypes_ClassTemplate_uint64_t *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)(_this)).operator=(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t>(*(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)_other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)(_this)).foo<MR_C_uint64_t>();
}

void MR_TestSimpleTypes_ClassTemplate_uint64_t_foo_int32_t(MR_TestSimpleTypes_ClassTemplate_uint64_t *_this)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::TestSimpleTypes::ClassTemplate<MR_C_uint64_t> *)(_this)).foo<int32_t>();
}
