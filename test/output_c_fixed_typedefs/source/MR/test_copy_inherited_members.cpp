...
const int32_t *MR_CopyInheritedMembers_A_Get_StaticField(void)
{
    return std::addressof(MR::CopyInheritedMembers::A::StaticField);
}

void MR_CopyInheritedMembers_A_Set_StaticField(int32_t value)
{
    MR::CopyInheritedMembers::A::StaticField = value;
}

int32_t *MR_CopyInheritedMembers_A_GetMutable_StaticField(void)
{
    return std::addressof(MR::CopyInheritedMembers::A::StaticField);
}

const int32_t *MR_CopyInheritedMembers_A_Get_Field(const MR_CopyInheritedMembers_A *_this)
{
...
void MR_CopyInheritedMembers_A_Set_Field(MR_CopyInheritedMembers_A *_this, int32_t value)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::CopyInheritedMembers::A *)(_this)).Field = value;
}

int32_t *MR_CopyInheritedMembers_A_GetMutable_Field(MR_CopyInheritedMembers_A *_this)
{
...
MR_CopyInheritedMembers_A *MR_CopyInheritedMembers_A_ConstructFrom(int32_t Field)
{
    return (MR_CopyInheritedMembers_A *)new MR::CopyInheritedMembers::A(MR::CopyInheritedMembers::A{
        Field
    });
...
int32_t MR_CopyInheritedMembers_A_ConvertTo_int32_t(MR_CopyInheritedMembers_A *_this)
{
    return (int32_t)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::CopyInheritedMembers::A *)(_this)));
}
...
const int32_t *MR_CopyInheritedMembers_B_Get_StaticField(void)
{
    return std::addressof(MR::CopyInheritedMembers::B::StaticField);
}

void MR_CopyInheritedMembers_B_Set_StaticField(int32_t value)
{
    MR::CopyInheritedMembers::B::StaticField = value;
}

int32_t *MR_CopyInheritedMembers_B_GetMutable_StaticField(void)
{
    return std::addressof(MR::CopyInheritedMembers::B::StaticField);
}

const int32_t *MR_CopyInheritedMembers_B_Get_Field(const MR_CopyInheritedMembers_B *_this)
{
...
void MR_CopyInheritedMembers_B_Set_Field(MR_CopyInheritedMembers_B *_this, int32_t value)
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::CopyInheritedMembers::B *)(_this)).Field = value;
}

int32_t *MR_CopyInheritedMembers_B_GetMutable_Field(MR_CopyInheritedMembers_B *_this)
{
...
MR_CopyInheritedMembers_B *MR_CopyInheritedMembers_B_ConstructFrom(int32_t Field)
{
    return (MR_CopyInheritedMembers_B *)new MR::CopyInheritedMembers::B(MR::CopyInheritedMembers::B{
        Field
    });
...
int32_t MR_CopyInheritedMembers_B_ConvertTo_int32_t(MR_CopyInheritedMembers_B *_this)
{
    return (int32_t)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::CopyInheritedMembers::B *)(_this)));
}
