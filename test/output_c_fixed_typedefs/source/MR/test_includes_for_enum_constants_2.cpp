...
{
    return (MR_IncludesForEnumConstants_A_MR_IncludesForEnumConstants_E_e1 *)&(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(MR::IncludesForEnumConstants::A<MR::IncludesForEnumConstants::E::e1> *)(_this)).operator=(
        ((_other ? void() : throw std::runtime_error("Parameter `_other` can not be null.")), MR::IncludesForEnumConstants::A<MR::IncludesForEnumConstants::E::e1>(*(MR::IncludesForEnumConstants::A<MR::IncludesForEnumConstants::E::e1> *)_other))
    ));
}
