...
{
    return (MR_OmittingTargsAndQuals_A_int32_t *)new MR::OmittingTargsAndQuals::A<int32_t>(MR::OmittingTargsAndQuals::A<int32_t>(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<int32_t>(*(MR::OmittingTargsAndQuals::A<int32_t> *)_other))
    ));
}
...
{
    return (MR_OmittingTargsAndQuals_A_int32_t *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<int32_t> *)(_this)).operator=(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<int32_t>(*(MR::OmittingTargsAndQuals::A<int32_t> *)_other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<int32_t> *)(_this)).operator+();
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<int32_t> *)(_this)).operator-(
        ((_1 ? void() : MRBINDC_THROW("Parameter `_1` can not be null.", void)), MR::OmittingTargsAndQuals::A<float>(*(MR::OmittingTargsAndQuals::A<float> *)_1))
    );
}
...
{
    a(
        ((_1 ? void() : MRBINDC_THROW("Parameter `_1` can not be null.", void)), MR::OmittingTargsAndQuals::A<int32_t>(*(MR::OmittingTargsAndQuals::A<int32_t> *)_1))
    );
}
...
void MR_OmittingTargsAndQuals_b(const MR_OmittingTargsAndQuals_A_int32_t *_1, const MR_OmittingTargsAndQuals_A_float *_2)
{
    b<float>(
        ((_1 ? void() : MRBINDC_THROW("Parameter `_1` can not be null.", void)), MR::OmittingTargsAndQuals::A<int32_t>(*(MR::OmittingTargsAndQuals::A<int32_t> *)_1)),
        ((_2 ? void() : MRBINDC_THROW("Parameter `_2` can not be null.", void)), MR::OmittingTargsAndQuals::A<float>(*(MR::OmittingTargsAndQuals::A<float> *)_2))
    );
}
...
{
    return (MR_OmittingTargsAndQuals_A_float *)new MR::OmittingTargsAndQuals::A<float>(MR::OmittingTargsAndQuals::A<float>(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<float>(*(MR::OmittingTargsAndQuals::A<float> *)_other))
    ));
}
...
{
    return (MR_OmittingTargsAndQuals_A_float *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<float> *)(_this)).operator=(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::OmittingTargsAndQuals::A<float>(*(MR::OmittingTargsAndQuals::A<float> *)_other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::OmittingTargsAndQuals::A<float> *)(_this)).operator+();
}
