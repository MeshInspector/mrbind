...
{
    return (MR_IOStream_A *)new MR::IOStream::A(MR::IOStream::A(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::IOStream::A(*(MR::IOStream::A *)_other))
    ));
}
...
{
    return (MR_IOStream_A *)std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(MR::IOStream::A *)(_this)).operator=(
        ((_other ? void() : MRBINDC_THROW("Parameter `_other` can not be null.", void)), MR::IOStream::A(*(MR::IOStream::A *)_other))
    ));
}
...
{
    operator<<(
        ((_1 ? void() : MRBINDC_THROW("Parameter `_1` can not be null.", void)), *(std::ostream *)(_1)),
        ((_2 ? void() : MRBINDC_THROW("Parameter `_2` can not be null.", void)), *(const MR::IOStream::A *)(_2))
    );
}
...
void MR_C_input_MR_IOStream_A(MR_C_std_istream *_1, MR_IOStream_A *_2)
{
    operator>>(
        ...
        ((_2 ? void() : MRBINDC_THROW("Parameter `_2` can not be null.", void)), *(MR::IOStream::A *)(_2))
    );
}
