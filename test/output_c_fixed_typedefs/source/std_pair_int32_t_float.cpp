...
{
    return (MR_C_std_pair_int32_t_float *)new std::pair<int32_t, float>(std::pair<int32_t, float>(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::pair<int32_t, float>(*(std::pair<int32_t, float> *)other))
    ));
}
...
{
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::pair<int32_t, float> *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::pair<int32_t, float>(*(std::pair<int32_t, float> *)other))
    );
}
...
int32_t *MR_C_std_pair_int32_t_float_first_mut(MR_C_std_pair_int32_t_float *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::pair<int32_t, float> *)(_this)).first);
}
...
float *MR_C_std_pair_int32_t_float_second_mut(MR_C_std_pair_int32_t_float *_this)
{
    return std::addressof(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::pair<int32_t, float> *)(_this)).second);
}
