public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_NodeHashSet_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.Phmap.NodeHashSet_Int.ConstIterator find(int key)
                {
                    ...
                    return new(__MR_C_phmap_node_hash_set_int_Find(_UnderlyingPtr, &key), is_owning: true);
                }
                ...
                public unsafe MR.CS.Phmap.NodeHashSet_Int.ConstIterator begin()
                {
                    ...
                    return new(__MR_C_phmap_node_hash_set_int_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Phmap.NodeHashSet_Int.ConstIterator end()
                {
                    ...
                    return new(__MR_C_phmap_node_hash_set_int_End(_UnderlyingPtr), is_owning: true);
                }
