        ...
        public static partial class Std
        {
            ...
            public class Const_UnorderedMultiset_Int : MR.CS.Misc.Object<Const_UnorderedMultiset_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                public unsafe bool empty()
                {
                    ...
                    return __MR_C_std_unordered_multiset_int_empty(_UnderlyingPtr) != 0;
                }
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_Int.ConstIterator find(int key)
                {
                    ...
                    __ret = new(__MR_C_std_unordered_multiset_int_find(_UnderlyingPtr, &key), is_owning: true);
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_Int.ConstIterator begin()
                {
                    ...
                    MR.CS.Std.UnorderedMultiset_Int.ConstIterator __ret;
                    __ret = new(__MR_C_std_unordered_multiset_int_begin(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe bool isBegin(MR.CS.Std.UnorderedMultiset_Int.Const_ConstIterator iter)
                {
                    ...
                    return __MR_C_std_unordered_multiset_int_is_begin(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                public unsafe MR.CS.Std.UnorderedMultiset_Int.ConstIterator end()
                {
                    ...
                    MR.CS.Std.UnorderedMultiset_Int.ConstIterator __ret;
                    __ret = new(__MR_C_std_unordered_multiset_int_end(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe bool isEnd(MR.CS.Std.UnorderedMultiset_Int.Const_ConstIterator iter)
                {
                    ...
                    return __MR_C_std_unordered_multiset_int_is_end(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public unsafe int deref()
                    {
                        ...
                        return *__MR_C_std_unordered_multiset_int_const_iterator_deref(_UnderlyingPtr);
                    }
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        return __MR_C_equal_MR_C_std_unordered_multiset_int_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr) != 0;
                    }
