    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_shared_ptr_int_UseCount", ExactSpelling = true)]
                    extern static int __MR_C_std_shared_ptr_int_UseCount(_Underlying *_this);
                    return __MR_C_std_shared_ptr_int_UseCount(_UnderlyingPtr);
                }
