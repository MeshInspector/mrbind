    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Vector_MRCInt64T : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe long MutableToIndex(MR.CS.Std.Vector_MRCInt64T.Const_Iterator iter)
                {
                ...
                public class _InOptConst_ConstIterator
                {
                    ...
                    /// Makes a const iterator from a mutable one.
                    public static unsafe implicit operator _InOptConst_ConstIterator(MR.CS.Std.Vector_MRCInt64T.Const_Iterator iter) {return new MR.CS.Std.Vector_MRCInt64T.ConstIterator(iter);}
                }
            ...
            public class Vector_MRCInt64T : Const_Vector_MRCInt64T
            {
                ...
                public unsafe MR.CS.Std.Vector_MRCInt64T.Iterator MutableBegin()
                {
                ...
                public unsafe bool IsMutableBegin(MR.CS.Std.Vector_MRCInt64T.Const_Iterator iter)
                {
                ...
                public unsafe MR.CS.Std.Vector_MRCInt64T.Iterator MutableEnd()
                {
                ...
                public unsafe bool IsMutableEnd(MR.CS.Std.Vector_MRCInt64T.Const_Iterator iter)
                {
