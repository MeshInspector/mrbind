public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            /// </summary>
            public class Const_NodeHashMap_Int_Float : MR.CS.Misc.Object<Const_NodeHashMap_Int_Float>, System.IDisposable
            {
            ...
            public class NodeHashMap_Int_Float : Const_NodeHashMap_Int_Float
            {
                ...
                public unsafe new MR.CS.Phmap.NodeHashMap_Int_Float.Iterator find(int key)
                {
                    ...
                    __ret = new(__MR_C_phmap_node_hash_map_int_float_FindMutable(_UnderlyingPtr, &key), is_owning: true);
                    __ret._KeepAlive(this);
                    return __ret;
                }
                ...
                public unsafe new MR.CS.Phmap.NodeHashMap_Int_Float.Iterator begin()
                {
                    ...
                    MR.CS.Phmap.NodeHashMap_Int_Float.Iterator __ret;
                    __ret = new(__MR_C_phmap_node_hash_map_int_float_MutableBegin(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAlive(this);
                    return __ret;
                }
                ...
                public unsafe new MR.CS.Phmap.NodeHashMap_Int_Float.Iterator end()
                {
                    ...
                    MR.CS.Phmap.NodeHashMap_Int_Float.Iterator __ret;
                    __ret = new(__MR_C_phmap_node_hash_map_int_float_MutableEnd(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAlive(this);
                    return __ret;
                }
