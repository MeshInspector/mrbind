            ...
            public class Const_Tuple_IntRef_FloatRvalueRef_StdStringRef_StdStringRvalueRef : MR.CS.Misc.Object<Const_Tuple_IntRef_FloatRvalueRef_StdStringRef_StdStringRvalueRef>, System.IDisposable
            {
                ...
                public unsafe Const_Tuple_IntRef_FloatRvalueRef_StdStringRef_StdStringRvalueRef(ref int _0, MR.CS.Misc._MoveRef _move__1, float _1, MR.CS.Std.String _2, MR.CS.Misc._MoveRef _move__3, ReadOnlySpan<char> _3) : this(null, is_owning: true)
                {
                    ...
                    fixed (int *__ptr__0 = &_0)
                    {
                        ...
                        {
                            _UnderlyingPtr = __MR_C_std_tuple_int_ref_float_rvalue_ref_std_string_ref_std_string_rvalue_ref_Construct(__ptr__0, &_1, _2._UnderlyingPtr, __ptr__3, __ptr__3 + __len__3);
                            _KeepAlive(_2);
                        }
                    }
                }
