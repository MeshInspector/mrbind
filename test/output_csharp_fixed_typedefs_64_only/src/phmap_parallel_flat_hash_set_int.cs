public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_ParallelFlatHashSet_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.Phmap.ParallelFlatHashSet_Int.ConstIterator Find(int key)
                {
                    ...
                    return new(__MR_C_phmap_parallel_flat_hash_set_int_Find(_UnderlyingPtr, &key), is_owning: true);
                }
                ...
                public unsafe MR.CS.Phmap.ParallelFlatHashSet_Int.ConstIterator Begin()
                {
                    ...
                    return new(__MR_C_phmap_parallel_flat_hash_set_int_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Phmap.ParallelFlatHashSet_Int.ConstIterator End()
                {
                    ...
                    return new(__MR_C_phmap_parallel_flat_hash_set_int_End(_UnderlyingPtr), is_owning: true);
                }
