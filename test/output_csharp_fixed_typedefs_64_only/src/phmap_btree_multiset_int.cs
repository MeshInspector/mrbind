    ...
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            public class Const_BtreeMultiset_Int : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_multiset_int_IsEmpty", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_multiset_int_IsEmpty(_Underlying *_this);
                    return __MR_C_phmap_btree_multiset_int_IsEmpty(_UnderlyingPtr) != 0;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_multiset_int_IsBegin", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_multiset_int_IsBegin(_Underlying *_this, MR.CS.Phmap.BtreeMultiset_Int.Const_ConstIterator._Underlying *iter);
                    return __MR_C_phmap_btree_multiset_int_IsBegin(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_btree_multiset_int_IsEnd", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_btree_multiset_int_IsEnd(_Underlying *_this, MR.CS.Phmap.BtreeMultiset_Int.Const_ConstIterator._Underlying *iter);
                    return __MR_C_phmap_btree_multiset_int_IsEnd(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
