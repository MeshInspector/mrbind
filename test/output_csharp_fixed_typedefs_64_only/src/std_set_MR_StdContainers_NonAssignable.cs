public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Set_MRStdContainersNonAssignable : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.Std.Set_MRStdContainersNonAssignable.ConstIterator Find(MR.CS.StdContainers.Const_NonAssignable key)
                {
                    ...
                    return new(__MR_C_std_set_MR_StdContainers_NonAssignable_Find(_UnderlyingPtr, key._UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.Set_MRStdContainersNonAssignable.ConstIterator Begin()
                {
                    ...
                    return new(__MR_C_std_set_MR_StdContainers_NonAssignable_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.Set_MRStdContainersNonAssignable.ConstIterator End()
                {
                    ...
                    return new(__MR_C_std_set_MR_StdContainers_NonAssignable_End(_UnderlyingPtr), is_owning: true);
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object, System.IDisposable
                {
                    ...
                    public unsafe MR.CS.StdContainers.Const_NonAssignable Deref()
                    {
                        ...
                        return new(__MR_C_std_set_MR_StdContainers_NonAssignable_const_iterator_Deref(_UnderlyingPtr), is_owning: false);
                    }
                }
