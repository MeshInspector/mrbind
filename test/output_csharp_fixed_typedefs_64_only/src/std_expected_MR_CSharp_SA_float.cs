public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            /// </summary>
            public class Const_Expected_MRCSharpSA_Float : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.CSharp.Const_SA? getValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_SA_float_GetValue(_UnderlyingPtr);
                ...
                public unsafe float? getError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_SA_float_GetError(_UnderlyingPtr);
            ...
            public class Expected_MRCSharpSA_Float : Const_Expected_MRCSharpSA_Float
            {
                ...
                public unsafe new MR.CS.CSharp.SA? getValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_SA_float_GetMutableValue(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Misc.Ref<float>? getError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_SA_float_GetMutableError(_UnderlyingPtr);
