            ...
            public class Const_Tuple_ConstIntRef_ConstFloatRvalueRef_ConstStdStringRef_ConstStdStringRvalueRef : MR.CS.Misc.Object<Const_Tuple_ConstIntRef_ConstFloatRvalueRef_ConstStdStringRef_ConstStdStringRvalueRef>, System.IDisposable
            {
                ...
                public unsafe Const_Tuple_ConstIntRef_ConstFloatRvalueRef_ConstStdStringRef_ConstStdStringRvalueRef(int _0, MR.CS.Misc._MoveRef _move__1, float _1, ReadOnlySpan<char> _2, MR.CS.Misc._MoveRef _move__3, ReadOnlySpan<char> _3) : this(null, is_owning: true)
                {
                    ...
                    fixed (byte *__ptr__2 = __bytes__2)
                    {
                        ...
                        {
                            _UnderlyingPtr = __MR_C_std_tuple_const_int_ref_const_float_rvalue_ref_const_std_string_ref_const_std_string_rvalue_ref_Construct(&_0, &_1, __ptr__2, __ptr__2 + __len__2, __ptr__3, __ptr__3 + __len__3);
                        }
                    }
                }
