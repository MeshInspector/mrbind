public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            /// </summary>
            public class Const_Expected_MRCSharpE1_Float : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.CSharp.E1? getValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_E1_float_GetValue(_UnderlyingPtr);
                ...
                public unsafe float? getError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_E1_float_GetError(_UnderlyingPtr);
                    return __ret is not null ? *__ret : null;
                }
            }
            ...
            public class Expected_MRCSharpE1_Float : Const_Expected_MRCSharpE1_Float
            {
                ...
                public unsafe new MR.CS.Misc.Ref<MR.CS.CSharp.E1>? getValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_E1_float_GetMutableValue(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Misc.Ref<float>? getError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_E1_float_GetMutableError(_UnderlyingPtr);
