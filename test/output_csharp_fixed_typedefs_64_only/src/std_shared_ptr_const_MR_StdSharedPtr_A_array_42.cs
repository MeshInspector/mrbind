        ...
        public static partial class Std
        {
            ...
            public class Const_SharedPtr_ConstMRStdSharedPtrAArray42 : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.StdSharedPtr.Const_A? Get()
                {
                    ...
                    var __ret = __MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_Get(_UnderlyingPtr);
                ...
                public unsafe int UseCount()
                {
                    ...
                    extern static int __MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_UseCount(_Underlying *_this);
            ...
            public class _InOptConst_SharedPtr_ConstMRStdSharedPtrAArray42
            {
                ...
                /// Create a new instance from a non-const pointer to the same type.
                public static unsafe implicit operator _InOptConst_SharedPtr_ConstMRStdSharedPtrAArray42(MR.CS.Std._ByValue_SharedPtr_MRStdSharedPtrAArray42 ptr) {return new MR.CS.Std.SharedPtr_ConstMRStdSharedPtrAArray42(ptr);}
            }
        }
    }
}
