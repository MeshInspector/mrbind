public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            /// </summary>
            public class Const_Set_Float : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.Std.Set_Float.ConstIterator find(float key)
                {
                    ...
                    return new(__MR_C_std_set_float_Find(_UnderlyingPtr, &key), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.Set_Float.ConstIterator begin()
                {
                    ...
                    return new(__MR_C_std_set_float_Begin(_UnderlyingPtr), is_owning: true);
                }
                ...
                public unsafe MR.CS.Std.Set_Float.ConstIterator end()
                {
                    ...
                    return new(__MR_C_std_set_float_End(_UnderlyingPtr), is_owning: true);
                }
