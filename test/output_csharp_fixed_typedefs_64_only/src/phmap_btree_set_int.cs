        ...
        public static partial class Phmap
        {
            ...
            public class Const_BtreeSet_Int : MR.CS.Misc.Object<Const_BtreeSet_Int>, System.IDisposable, IEnumerable<int>
            {
                ...
                public unsafe bool empty()
                {
                    ...
                    return __MR_C_phmap_btree_set_int_empty(_UnderlyingPtr) != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator find(int key)
                {
                    ...
                    __ret = new(__MR_C_phmap_btree_set_int_find(_UnderlyingPtr, &key), is_owning: true);
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator begin()
                {
                    ...
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator __ret;
                    __ret = new(__MR_C_phmap_btree_set_int_begin(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe bool isBegin(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator iter)
                {
                    ...
                    return __MR_C_phmap_btree_set_int_is_begin(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                public unsafe MR.CS.Phmap.BtreeSet_Int.ConstIterator end()
                {
                    ...
                    MR.CS.Phmap.BtreeSet_Int.ConstIterator __ret;
                    __ret = new(__MR_C_phmap_btree_set_int_end(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe bool isEnd(MR.CS.Phmap.BtreeSet_Int.Const_ConstIterator iter)
                {
                    ...
                    return __MR_C_phmap_btree_set_int_is_end(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                public class Const_ConstIterator : MR.CS.Misc.Object<Const_ConstIterator>, System.IDisposable, System.IEquatable<Const_ConstIterator>
                {
                    ...
                    public static unsafe bool operator==(Const_ConstIterator a, Const_ConstIterator b)
                    {
                        ...
                        return __MR_C_equal_MR_C_phmap_btree_set_int_const_iterator(a._UnderlyingPtr, b._UnderlyingPtr) != 0;
                    }
