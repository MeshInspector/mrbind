public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_Expected_MRCSharpTrivial_Float : MR.CS.Misc.Object, System.IDisposable
            {
                ...
                public unsafe MR.CS.CSharp.Const_Trivial? GetValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_Trivial_float_GetValue(_UnderlyingPtr);
                ...
                public unsafe float? GetError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_Trivial_float_GetError(_UnderlyingPtr);
            ...
            public class Expected_MRCSharpTrivial_Float : Const_Expected_MRCSharpTrivial_Float
            {
                ...
                public unsafe new MR.CS.CSharp.Trivial? GetValue()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_Trivial_float_GetMutableValue(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Misc.Ref<float>? GetError()
                {
                    ...
                    var __ret = __MR_C_std_expected_MR_CSharp_Trivial_float_GetMutableError(_UnderlyingPtr);
