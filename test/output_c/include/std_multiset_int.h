...
MR_C_API void MR_C_std_multiset_int_DestroyArray(MR_C_std_multiset_int *_this);
...
MR_C_API void MR_C_std_multiset_int_const_iterator_DestroyArray(MR_C_std_multiset_int_const_iterator *_this);
