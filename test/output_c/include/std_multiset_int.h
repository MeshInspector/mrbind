...
/// Destroys a heap-allocated instance of `std::multiset<int>`.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_multiset_int_Destroy(MR_C_std_multiset_int *_this);
...
MR_C_API void MR_C_std_multiset_int_InsertAtIter(MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *position, int new_elem);

/// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_multiset_int_EraseAtIter(MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *position);

/// The begin iterator, const.
/// Parameter `_this` can not be null.
/// Returns an instance allocated on the heap! Must call `MR_C_std_multiset_int_const_iterator_Destroy()` to free it when you're done using it.
...
/// Constructs a copy of another instance. The source remains alive.
/// Returns an instance allocated on the heap! Must call `MR_C_std_multiset_int_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_multiset_int_const_iterator *MR_C_std_multiset_int_const_iterator_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_multiset_int_const_iterator *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_multiset_int_const_iterator_AssignFromAnother(MR_C_std_multiset_int_const_iterator *_this, MR_C_PassBy other_pass_by, MR_C_std_multiset_int_const_iterator *other);

/// Destroys a heap-allocated instance of `std::multiset<int>::const_iterator`.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_multiset_int_const_iterator_Destroy(MR_C_std_multiset_int_const_iterator *_this);
