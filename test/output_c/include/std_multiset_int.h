...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_multiset_int_empty(const MR_C_std_multiset_int *_this);
...
MR_C_API bool MR_C_std_multiset_int_is_begin(const MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *iter);
...
/// Parameter `_this` can not be null. It is a single object.
/// Parameter `iter` can not be null. It is a single object.
MR_C_API bool MR_C_std_multiset_int_is_end(const MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *iter);
...
MR_C_API bool MR_C_equal_MR_C_std_multiset_int_const_iterator(const MR_C_std_multiset_int_const_iterator *a, const MR_C_std_multiset_int_const_iterator *b);
