...
typedef struct MR_C_std_array_int_42 MR_C_std_array_int_42; // Defined below in this file.
...
MR_C_API void MR_C_std_array_int_42_Destroy(const MR_C_std_array_int_42 *_this);

/// Destroys a heap-allocated array of `MR_C_std_array_int_42`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_array_int_42_DestroyArray(const MR_C_std_array_int_42 *_this);
