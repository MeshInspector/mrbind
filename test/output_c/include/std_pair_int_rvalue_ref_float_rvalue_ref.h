...
MR_C_API MR_C_std_pair_int_rvalue_ref_float_rvalue_ref *MR_C_std_pair_int_rvalue_ref_float_rvalue_ref_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_pair_int_rvalue_ref_float_rvalue_ref *other);

/// Destroys a heap-allocated instance of `MR_C_std_pair_int_rvalue_ref_float_rvalue_ref`.
