...
/// Returns an instance allocated on the heap! Must call `MR_C_std_unique_ptr_int_Destroy()` to free it when you're done using it.
...
MR_C_API void MR_C_std_unique_ptr_int_Destroy(MR_C_std_unique_ptr_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_unique_ptr_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_unique_ptr_int_DestroyArray(MR_C_std_unique_ptr_int *_this);
