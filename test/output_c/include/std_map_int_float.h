...
/// Constructs a copy of another instance. The source remains alive.
/// Returns an instance allocated on the heap! Must call `MR_C_std_map_int_float_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_map_int_float_const_iterator *MR_C_std_map_int_float_const_iterator_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_map_int_float_const_iterator *other);
...
/// Constructs a copy of another instance. The source remains alive.
/// Returns an instance allocated on the heap! Must call `MR_C_std_map_int_float_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_map_int_float_iterator *MR_C_std_map_int_float_iterator_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_map_int_float_iterator *other);
