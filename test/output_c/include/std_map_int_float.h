...
typedef struct MR_C_std_map_int_float MR_C_std_map_int_float; // Defined below in this file.
typedef struct MR_C_std_map_int_float_const_iterator MR_C_std_map_int_float_const_iterator; // Defined below in this file.
typedef struct MR_C_std_map_int_float_iterator MR_C_std_map_int_float_iterator; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API bool MR_C_std_map_int_float_IsEmpty(const MR_C_std_map_int_float *_this);
...
MR_C_API float *MR_C_std_map_int_float_FindOrConstructElem(MR_C_std_map_int_float *_this, const int *key);
...
MR_C_API bool MR_C_std_map_int_float_IsBegin(const MR_C_std_map_int_float *_this, const MR_C_std_map_int_float_const_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_map_int_float_IsMutableBegin(MR_C_std_map_int_float *_this, const MR_C_std_map_int_float_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_map_int_float_IsEnd(const MR_C_std_map_int_float *_this, const MR_C_std_map_int_float_const_iterator *iter);
...
/// Parameter `_this` can not be null.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const int *MR_C_std_map_int_float_const_iterator_DerefKey(const MR_C_std_map_int_float_const_iterator *_this);

/// Dereferences a const iterator, returning the mapped value.
/// Parameter `_this` can not be null.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const float *MR_C_std_map_int_float_const_iterator_DerefValue(const MR_C_std_map_int_float_const_iterator *_this);
...
/// Parameter `_this` can not be null.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const int *MR_C_std_map_int_float_iterator_DerefKey(const MR_C_std_map_int_float_iterator *_this);

/// Dereferences a mutable iterator, returning the mapped value.
/// Parameter `_this` can not be null.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API float *MR_C_std_map_int_float_iterator_DerefValue(const MR_C_std_map_int_float_iterator *_this);
