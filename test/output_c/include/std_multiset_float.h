...
MR_C_API void MR_C_std_multiset_float_InsertAtIter(MR_C_std_multiset_float *_this, const MR_C_std_multiset_float_const_iterator *position, float new_elem);

/// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_multiset_float_EraseAtIter(MR_C_std_multiset_float *_this, const MR_C_std_multiset_float_const_iterator *position);
