...
MR_C_API void MR_C_std_vector_MR_SeparateA_push_back(MR_C_std_vector_MR_SeparateA *_this, MR_C_PassBy new_elem_pass_by, MR_SeparateA *new_elem);
...
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `new_elem` might be preserved in this object.
MR_C_API void MR_C_std_vector_MR_SeparateA_insert(MR_C_std_vector_MR_SeparateA *_this, size_t position, MR_C_PassBy new_elem_pass_by, MR_SeparateA *new_elem);
...
/// The reference to the parameter `new_elem` might be preserved in this object.
MR_C_API void MR_C_std_vector_MR_SeparateA_insert_at_mutable_iter(MR_C_std_vector_MR_SeparateA *_this, const MR_C_std_vector_MR_SeparateA_iterator *position, MR_C_PassBy new_elem_pass_by, MR_SeparateA *new_elem);
...
/// Parameter `position` can not be null. It is a single object.
/// The reference to the parameter `new_elem` might be preserved in this object.
MR_C_API void MR_C_std_vector_MR_SeparateA_insert_at_iter(MR_C_std_vector_MR_SeparateA *_this, const MR_C_std_vector_MR_SeparateA_const_iterator *position, MR_C_PassBy new_elem_pass_by, MR_SeparateA *new_elem);
