...
typedef struct MR_C_std_function_std_string_from_int_int MR_C_std_function_std_string_from_int_int;

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_std_string_from_int_int_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_C_std_function_std_string_from_int_int_DestroyArray()`.
/// Use `MR_C_std_function_std_string_from_int_int_OffsetMutablePtr()` and `MR_C_std_function_std_string_from_int_int_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// The reference to the parameter `other` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_std_string_from_int_int_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_function_std_string_from_int_int *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `other` might be preserved in this object.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_function_std_string_from_int_int_AssignFromAnother(MR_C_std_function_std_string_from_int_int *_this, MR_C_PassBy other_pass_by, MR_C_std_function_std_string_from_int_int *other);

/// Destroys a heap-allocated instance of `MR_C_std_function_std_string_from_int_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_std_string_from_int_int_Destroy(const MR_C_std_function_std_string_from_int_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_std_string_from_int_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_std_string_from_int_int_DestroyArray(const MR_C_std_function_std_string_from_int_int *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_OffsetPtr(const MR_C_std_function_std_string_from_int_int *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_OffsetMutablePtr(MR_C_std_function_std_string_from_int_int *ptr, ptrdiff_t i);

/// Returns true if this instance stores a callable, as opposed to being null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_std_string_from_int_int_has_value(const MR_C_std_function_std_string_from_int_int *_this);

/// Destroys the stored callable, making this instance null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_std_string_from_int_int_reset(MR_C_std_function_std_string_from_int_int *_this);
...
MR_C_API MR_C_std_string *MR_C_std_function_std_string_from_int_int_call(const MR_C_std_function_std_string_from_int_int *_this, int _1, int _2);
...
MR_C_API MR_C_std_function_std_string_from_int_int *MR_C_std_function_std_string_from_int_int_ConstructStateless(MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int _1, int _2));

/// Assign a stateless function.
/// Parameter `_this` can not be null. It is a single object.
/// Callback parameter `_return_pass_by` is an output parameter. It will never be null, and initially points to a zeroed variable.
MR_C_API void MR_C_std_function_std_string_from_int_int_Assign(MR_C_std_function_std_string_from_int_int *_this, MR_C_std_string *(*func)(MR_C_PassBy *_return_pass_by, int _1, int _2));
