...
MR_C_API void MR_StdExpected_SetExp(MR_C_PassBy _1_pass_by, MR_C_std_expected_int_std_string *_1);

/// Generated from function `MR::StdExpected::SetExpConstRef`.
/// Parameter `_1` can not be null. It is a single object.
MR_C_API void MR_StdExpected_SetExpConstRef(const MR_C_std_expected_int_std_string *_1);
...
MR_C_API void MR_StdExpected_SetExpDefTrivial(MR_C_PassBy _1_pass_by, MR_C_std_expected_int_std_string *_1);
