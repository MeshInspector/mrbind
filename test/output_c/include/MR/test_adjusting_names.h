...
/// Returns a pointer to a member variable of class `MR::AdjustingNames::A` named `var<unsigned long>`.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API const unsigned long *MR_AdjustingNames_A_Get_var_unsigned_long(void);
...
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API unsigned long *MR_AdjustingNames_A_GetMutable_var_unsigned_long(void);
