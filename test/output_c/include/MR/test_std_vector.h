...
MR_C_API void MR_StdVector_Set(MR_C_PassBy _1_pass_by, MR_C_std_vector_int *_1);
...
MR_C_API void MR_StdVector_SetWithDefault(MR_C_PassBy _1_pass_by, MR_C_std_vector_int *_1);
...
MR_C_API void MR_StdVector_WriteToRef(MR_C_std_vector_int *_1);

/// Generated from function `MR::StdVector::WriteToPtr`.
MR_C_API void MR_StdVector_WriteToPtr(MR_C_std_vector_int *_1);

/// Generated from function `MR::StdVector::ConstRef`.
/// Parameter `_1` can not be null.
MR_C_API void MR_StdVector_ConstRef(const MR_C_std_vector_int *_1);

/// Generated from function `MR::StdVector::RvalueRef`.
/// Parameter `_1` can not be null.
/// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
///   but if your pointer is owning, you must still destroy it manually later.
MR_C_API void MR_StdVector_RvalueRef(MR_C_std_vector_int *_1);

/// Generated from function `MR::StdVector::ConstRvalueRef`.
/// Parameter `_1` can not be null.
/// In C++ this parameter takes an rvalue reference: it might invalidate the passed object,
///   but if your pointer is owning, you must still destroy it manually later.
MR_C_API void MR_StdVector_ConstRvalueRef(const MR_C_std_vector_int *_1);
