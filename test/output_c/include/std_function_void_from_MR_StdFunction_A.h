...
typedef struct MR_C_std_function_void_from_MR_StdFunction_A MR_C_std_function_void_from_MR_StdFunction_A; // Defined below in this file.
...
MR_C_API void MR_C_std_function_void_from_MR_StdFunction_A_Destroy(MR_C_std_function_void_from_MR_StdFunction_A *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_void_from_MR_StdFunction_A`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_void_from_MR_StdFunction_A_DestroyArray(MR_C_std_function_void_from_MR_StdFunction_A *_this);
