...
typedef struct MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API long MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_UseCount(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 *_this);
