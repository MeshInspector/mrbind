...
typedef struct MR_C_std_vector_unsigned_long MR_C_std_vector_unsigned_long; // Defined below in this file.
typedef struct MR_C_std_vector_unsigned_long_const_iterator MR_C_std_vector_unsigned_long_const_iterator; // Defined below in this file.
typedef struct MR_C_std_vector_unsigned_long_iterator MR_C_std_vector_unsigned_long_iterator; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API bool MR_C_std_vector_unsigned_long_IsEmpty(const MR_C_std_vector_unsigned_long *_this);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_ResizeWithDefaultValue(MR_C_std_vector_unsigned_long *_this, size_t new_size, unsigned long value);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_ShrinkToFit(MR_C_std_vector_unsigned_long *_this);
...
/// Parameter `_this` can not be null.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API unsigned long *MR_C_std_vector_unsigned_long_MutableAt(MR_C_std_vector_unsigned_long *_this, size_t i);
...
/// Parameter `_this` can not be null.
MR_C_API unsigned long *MR_C_std_vector_unsigned_long_MutableFront(MR_C_std_vector_unsigned_long *_this);
...
/// Parameter `_this` can not be null.
MR_C_API unsigned long *MR_C_std_vector_unsigned_long_MutableBack(MR_C_std_vector_unsigned_long *_this);
...
/// Parameter `_this` can not be null.
MR_C_API unsigned long *MR_C_std_vector_unsigned_long_MutableData(MR_C_std_vector_unsigned_long *_this);

/// Inserts a new element at the end.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_PushBack(MR_C_std_vector_unsigned_long *_this, unsigned long new_elem);

/// Removes one element from the end.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_PopBack(MR_C_std_vector_unsigned_long *_this);
...
MR_C_API void MR_C_std_vector_unsigned_long_InsertAtMutableIter(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_iterator *position, unsigned long new_elem);

/// Erases the element at the specified position.
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_EraseAtMutableIter(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_iterator *position);

/// Inserts a new element right before the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_InsertAtIter(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_const_iterator *position, unsigned long new_elem);

/// Erases the element at the specified position. This version takes the position in form of a const iterator, that's the only difference.
/// Parameter `_this` can not be null.
/// Parameter `position` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_EraseAtIter(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_const_iterator *position);
...
MR_C_API bool MR_C_std_vector_unsigned_long_IsBegin(const MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_const_iterator *iter);
...
MR_C_API MR_C_std_vector_unsigned_long_iterator *MR_C_std_vector_unsigned_long_MutableBegin(MR_C_std_vector_unsigned_long *_this);

/// Tests whether a mutable iterator is the begin iterator.
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_vector_unsigned_long_IsMutableBegin(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_vector_unsigned_long_IsEnd(const MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_const_iterator *iter);

/// The end iterator, mutable.
/// Parameter `_this` can not be null.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_vector_unsigned_long_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_vector_unsigned_long_iterator *MR_C_std_vector_unsigned_long_MutableEnd(MR_C_std_vector_unsigned_long *_this);

/// Tests whether a mutable iterator is the end iterator.
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_vector_unsigned_long_IsMutableEnd(MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_iterator *iter);

/// Convert a const iterator to an index.
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API ptrdiff_t MR_C_std_vector_unsigned_long_ToIndex(const MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_const_iterator *iter);

/// Convert a mutable iterator to an index.
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API ptrdiff_t MR_C_std_vector_unsigned_long_MutableToIndex(const MR_C_std_vector_unsigned_long *_this, const MR_C_std_vector_unsigned_long_iterator *iter);
...
/// Parameter `iter` can not be null.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_vector_unsigned_long_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_vector_unsigned_long_const_iterator *MR_C_std_vector_unsigned_long_const_iterator_FromMutable(const MR_C_std_vector_unsigned_long_iterator *iter);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_const_iterator_OffsetBy(MR_C_std_vector_unsigned_long_const_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two const iterators. Completes in constant time.
/// Parameter `a` can not be null.
/// Parameter `b` can not be null.
MR_C_API ptrdiff_t MR_C_std_vector_unsigned_long_const_iterator_Distance(const MR_C_std_vector_unsigned_long_const_iterator *a, const MR_C_std_vector_unsigned_long_const_iterator *b);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_vector_unsigned_long_iterator_OffsetBy(MR_C_std_vector_unsigned_long_iterator *_this, ptrdiff_t delta);

/// Computes the signed difference between two mutable iterators. Completes in constant time.
/// Parameter `a` can not be null.
/// Parameter `b` can not be null.
MR_C_API ptrdiff_t MR_C_std_vector_unsigned_long_iterator_Distance(const MR_C_std_vector_unsigned_long_iterator *a, const MR_C_std_vector_unsigned_long_iterator *b);
