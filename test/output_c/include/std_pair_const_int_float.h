...
typedef struct MR_C_std_pair_const_int_float MR_C_std_pair_const_int_float; // Defined below in this file.
...
MR_C_API void MR_C_std_pair_const_int_float_DestroyArray(MR_C_std_pair_const_int_float *_this);
