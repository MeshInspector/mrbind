...
typedef struct MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API long MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_UseCount(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array *_this);
