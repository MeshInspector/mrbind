...
typedef struct MR_C_std_unordered_multimap_int_float MR_C_std_unordered_multimap_int_float; // Defined below in this file.
typedef struct MR_C_std_unordered_multimap_int_float_const_iterator MR_C_std_unordered_multimap_int_float_const_iterator; // Defined below in this file.
typedef struct MR_C_std_unordered_multimap_int_float_iterator MR_C_std_unordered_multimap_int_float_iterator; // Defined below in this file.
