...
typedef struct MR_C_std_variant_int_float MR_C_std_variant_int_float; // Defined below in this file.
...
MR_C_API void MR_C_std_variant_int_float_Destroy(const MR_C_std_variant_int_float *_this);

/// Destroys a heap-allocated array of `MR_C_std_variant_int_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_variant_int_float_DestroyArray(const MR_C_std_variant_int_float *_this);
