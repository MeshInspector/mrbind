...
typedef struct MR_C_std_function_std_string_from_int_float MR_C_std_function_std_string_from_int_float; // Defined below in this file.
...
MR_C_API void MR_C_std_function_std_string_from_int_float_Destroy(MR_C_std_function_std_string_from_int_float *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_std_string_from_int_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_std_string_from_int_float_DestroyArray(MR_C_std_function_std_string_from_int_float *_this);
