...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_shared_ptr_int_has_value(const MR_C_std_shared_ptr_int *_this);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API int MR_C_std_shared_ptr_int_use_count(const MR_C_std_shared_ptr_int *_this);

/// Resets the pointer to null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_shared_ptr_int_reset(MR_C_std_shared_ptr_int *_this);

/// Construct from a value.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_shared_ptr_int_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_shared_ptr_int *MR_C_std_shared_ptr_int_ConstructFromValue(int value);
...
MR_C_API MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_int_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int *_this);
...
MR_C_API void MR_C_std_shared_ptr_int_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int *_this, MR_C_std_shared_ptr_void *_target);
