...
/// Returns an instance allocated on the heap! Must call `MR_C_phmap_node_hash_map_int_float_Destroy()` to free it when you're done using it.
...
MR_C_API void MR_C_phmap_node_hash_map_int_float_Destroy(MR_C_phmap_node_hash_map_int_float *_this);

/// Destroys a heap-allocated array of `MR_C_phmap_node_hash_map_int_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_phmap_node_hash_map_int_float_DestroyArray(MR_C_phmap_node_hash_map_int_float *_this);
...
/// Parameter `_this` can not be null.
/// Parameter `key` can not be null.
/// Returns an instance allocated on the heap! Must call `MR_C_phmap_node_hash_map_int_float_const_iterator_Destroy()` to free it when you're done using it.
...
/// Parameter `_this` can not be null.
/// Parameter `key` can not be null.
/// Returns an instance allocated on the heap! Must call `MR_C_phmap_node_hash_map_int_float_iterator_Destroy()` to free it when you're done using it.
...
MR_C_API void MR_C_phmap_node_hash_map_int_float_const_iterator_Destroy(MR_C_phmap_node_hash_map_int_float_const_iterator *_this);

/// Destroys a heap-allocated array of `MR_C_phmap_node_hash_map_int_float_const_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_phmap_node_hash_map_int_float_const_iterator_DestroyArray(MR_C_phmap_node_hash_map_int_float_const_iterator *_this);
...
MR_C_API void MR_C_phmap_node_hash_map_int_float_iterator_Destroy(MR_C_phmap_node_hash_map_int_float_iterator *_this);

/// Destroys a heap-allocated array of `MR_C_phmap_node_hash_map_int_float_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_phmap_node_hash_map_int_float_iterator_DestroyArray(MR_C_phmap_node_hash_map_int_float_iterator *_this);
