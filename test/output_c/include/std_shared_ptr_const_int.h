...
typedef struct MR_C_std_shared_ptr_const_int MR_C_std_shared_ptr_const_int; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API long MR_C_std_shared_ptr_const_int_UseCount(const MR_C_std_shared_ptr_const_int *_this);
