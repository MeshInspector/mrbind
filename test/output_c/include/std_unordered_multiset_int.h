...
typedef struct MR_C_std_unordered_multiset_int MR_C_std_unordered_multiset_int; // Defined below in this file.
typedef struct MR_C_std_unordered_multiset_int_const_iterator MR_C_std_unordered_multiset_int_const_iterator; // Defined below in this file.


/// Generated from C++ container `std::unordered_multiset<int>`.
/// Supported `MR_C_PassBy` modes: `MR_C_PassBy_DefaultConstruct`, `MR_C_PassBy_Copy`, `MR_C_PassBy_Move`, (and `MR_C_PassBy_DefaultArgument` and `MR_C_PassBy_NoObject` if supported by the callee).
typedef struct MR_C_std_unordered_multiset_int MR_C_std_unordered_multiset_int;

/// Read-only iterator for `MR_C_std_unordered_multiset_int`.
/// Supported `MR_C_PassBy` modes: `MR_C_PassBy_DefaultConstruct`, `MR_C_PassBy_Copy`, `MR_C_PassBy_Move`, (and `MR_C_PassBy_DefaultArgument` and `MR_C_PassBy_NoObject` if supported by the callee).
typedef struct MR_C_std_unordered_multiset_int_const_iterator MR_C_std_unordered_multiset_int_const_iterator;
...
MR_C_API MR_C_std_unordered_multiset_int *MR_C_std_unordered_multiset_int_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_C_std_unordered_multiset_int_DestroyArray()`.
/// Use `MR_C_std_unordered_multiset_int_OffsetMutablePtr()` and `MR_C_std_unordered_multiset_int_OffsetPtr()` to access the array elements.
...
MR_C_API void MR_C_std_unordered_multiset_int_Destroy(MR_C_std_unordered_multiset_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_unordered_multiset_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_unordered_multiset_int_DestroyArray(MR_C_std_unordered_multiset_int *_this);
...
/// Parameter `_this` can not be null.
MR_C_API size_t MR_C_std_unordered_multiset_int_Size(const MR_C_std_unordered_multiset_int *_this);

/// Returns true if the size is zero.
/// Parameter `_this` can not be null.
MR_C_API bool MR_C_std_unordered_multiset_int_IsEmpty(const MR_C_std_unordered_multiset_int *_this);
...
MR_C_API bool MR_C_std_unordered_multiset_int_IsBegin(const MR_C_std_unordered_multiset_int *_this, const MR_C_std_unordered_multiset_int_const_iterator *iter);
...
/// Parameter `_this` can not be null.
/// Parameter `iter` can not be null.
MR_C_API bool MR_C_std_unordered_multiset_int_IsEnd(const MR_C_std_unordered_multiset_int *_this, const MR_C_std_unordered_multiset_int_const_iterator *iter);

/// Constructs an empty (default-constructed) instance.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_unordered_multiset_int_const_iterator_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_unordered_multiset_int_const_iterator *MR_C_std_unordered_multiset_int_const_iterator_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_C_std_unordered_multiset_int_const_iterator_DestroyArray()`.
/// Use `MR_C_std_unordered_multiset_int_const_iterator_OffsetMutablePtr()` and `MR_C_std_unordered_multiset_int_const_iterator_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_unordered_multiset_int_const_iterator *MR_C_std_unordered_multiset_int_const_iterator_DefaultConstructArray(size_t num_elems);
...
MR_C_API void MR_C_std_unordered_multiset_int_const_iterator_Destroy(MR_C_std_unordered_multiset_int_const_iterator *_this);

/// Destroys a heap-allocated array of `MR_C_std_unordered_multiset_int_const_iterator`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_unordered_multiset_int_const_iterator_DestroyArray(MR_C_std_unordered_multiset_int_const_iterator *_this);
...
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_unordered_multiset_int_const_iterator_Incr(MR_C_std_unordered_multiset_int_const_iterator *_this);
