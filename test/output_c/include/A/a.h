...
MR_C_API MR_SeparateA *MR_SeparateA_DefaultConstruct(void);
...
MR_C_API MR_SeparateA *MR_SeparateA_DefaultConstructArray(size_t num_elems);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_SeparateA_Destroy()` to free it when you're done using it.
MR_C_API MR_SeparateA *MR_SeparateA_ConstructFromAnother(const MR_SeparateA *_other);
...
MR_C_API MR_SeparateA *MR_SeparateA_AssignFromAnother(MR_SeparateA *_this, const MR_SeparateA *_other);
