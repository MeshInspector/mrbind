...
typedef struct MR_C_std_vector_int MR_C_std_vector_int; // Defined below in this file.
typedef struct MR_C_std_vector_int_const_iterator MR_C_std_vector_int_const_iterator; // Defined below in this file.
typedef struct MR_C_std_vector_int_iterator MR_C_std_vector_int_iterator; // Defined below in this file.
