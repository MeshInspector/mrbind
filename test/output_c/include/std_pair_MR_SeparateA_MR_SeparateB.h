...
MR_C_API MR_C_std_pair_MR_SeparateA_MR_SeparateB *MR_C_std_pair_MR_SeparateA_MR_SeparateB_DefaultConstruct(void);
...
MR_C_API MR_C_std_pair_MR_SeparateA_MR_SeparateB *MR_C_std_pair_MR_SeparateA_MR_SeparateB_DefaultConstructArray(size_t num_elems);
...
MR_C_API MR_C_std_pair_MR_SeparateA_MR_SeparateB *MR_C_std_pair_MR_SeparateA_MR_SeparateB_ConstructFromAnother(const MR_C_std_pair_MR_SeparateA_MR_SeparateB *other);
...
/// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_pair_MR_SeparateA_MR_SeparateB_AssignFromAnother(MR_C_std_pair_MR_SeparateA_MR_SeparateB *_this, const MR_C_std_pair_MR_SeparateA_MR_SeparateB *other);
...
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_pair_MR_SeparateA_MR_SeparateB_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_pair_MR_SeparateA_MR_SeparateB *MR_C_std_pair_MR_SeparateA_MR_SeparateB_Construct(const MR_SeparateA *first, const MR_SeparateB *second);
