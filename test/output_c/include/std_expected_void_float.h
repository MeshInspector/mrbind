...
MR_C_API void MR_C_std_expected_void_float_Destroy(MR_C_std_expected_void_float *_this);

/// Destroys a heap-allocated array of `MR_C_std_expected_void_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_expected_void_float_DestroyArray(MR_C_std_expected_void_float *_this);
