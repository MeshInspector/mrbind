...
MR_C_API void MR_C_std_expected_int_std_string_Destroy(MR_C_std_expected_int_std_string *_this);

/// Destroys a heap-allocated array of `MR_C_std_expected_int_std_string`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_expected_int_std_string_DestroyArray(MR_C_std_expected_int_std_string *_this);
