...
/// Returns an instance allocated on the heap! Must call `MR_C_std_tuple_int_float_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_tuple_int_float *MR_C_std_tuple_int_float_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_tuple_int_float *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null.
MR_C_API void MR_C_std_tuple_int_float_AssignFromAnother(MR_C_std_tuple_int_float *_this, MR_C_PassBy other_pass_by, MR_C_std_tuple_int_float *other);

/// Destroys a heap-allocated instance of `MR_C_std_tuple_int_float`.
/// Parameter `_this` can not be null.
