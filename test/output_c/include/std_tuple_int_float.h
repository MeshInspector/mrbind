...
MR_C_API void MR_C_std_tuple_int_float_Destroy(const MR_C_std_tuple_int_float *_this);

/// Destroys a heap-allocated array of `MR_C_std_tuple_int_float`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_tuple_int_float_DestroyArray(const MR_C_std_tuple_int_float *_this);
...
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API int *MR_C_std_tuple_int_float_get_int_mut(MR_C_std_tuple_int_float *_this);
...
/// Parameter `_this` can not be null. It is a single object.
/// The returned pointer will never be null. It is non-owning, do NOT destroy it.
MR_C_API float *MR_C_std_tuple_int_float_get_float_mut(MR_C_std_tuple_int_float *_this);
