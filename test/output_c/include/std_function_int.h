...
typedef struct MR_C_std_function_int MR_C_std_function_int; // Defined below in this file.
...
MR_C_API void MR_C_std_function_int_Destroy(MR_C_std_function_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_int_DestroyArray(MR_C_std_function_int *_this);
