...
typedef struct MR_C_std_function_int_from_std_string MR_C_std_function_int_from_std_string;
...
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_C_std_function_int_from_std_string_DestroyArray()`.
/// Use `MR_C_std_function_int_from_std_string_OffsetMutablePtr()` and `MR_C_std_function_int_from_std_string_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_DefaultConstructArray(size_t num_elems);

/// Constructs a copy of another instance. The source remains alive.
/// The reference to the parameter `other` might be preserved in the constructed object.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_int_from_std_string_Destroy()` to free it when you're done using it.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_ConstructFromAnother(MR_C_PassBy other_pass_by, MR_C_std_function_int_from_std_string *other);

/// Assigns the contents from another instance. Both objects remain alive after the call.
/// Parameter `_this` can not be null. It is a single object.
/// The reference to the parameter `other` might be preserved in this object.
/// When this function is called, this object will drop any object references it held previously.
MR_C_API void MR_C_std_function_int_from_std_string_AssignFromAnother(MR_C_std_function_int_from_std_string *_this, MR_C_PassBy other_pass_by, MR_C_std_function_int_from_std_string *other);

/// Destroys a heap-allocated instance of `MR_C_std_function_int_from_std_string`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_int_from_std_string_Destroy(const MR_C_std_function_int_from_std_string *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_int_from_std_string`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_int_from_std_string_DestroyArray(const MR_C_std_function_int_from_std_string *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_OffsetPtr(const MR_C_std_function_int_from_std_string *ptr, ptrdiff_t i);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_OffsetMutablePtr(MR_C_std_function_int_from_std_string *ptr, ptrdiff_t i);

/// Returns true if this instance stores a callable, as opposed to being null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_int_from_std_string_has_value(const MR_C_std_function_int_from_std_string *_this);
...
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_ConstructStateless(int (*func)(MR_C_std_string *_1));

/// Assign a stateless function.
/// Parameter `_this` can not be null. It is a single object.
/// Callback parameter `_1` will never be null. It is non-owning, do NOT destroy it.
/// In C++ that parameter is an rvalue reference.
MR_C_API void MR_C_std_function_int_from_std_string_Assign(MR_C_std_function_int_from_std_string *_this, int (*func)(MR_C_std_string *_1));
...
MR_C_API MR_C_std_function_int_from_std_string *MR_C_std_function_int_from_std_string_ConstructEx(int (*func)(MR_C_std_string *_1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
///   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
///   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_int_from_std_string_AssignEx(MR_C_std_function_int_from_std_string *_this, int (*func)(MR_C_std_string *_1, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
