...
MR_C_API void MR_C_std_function_void_from_int_int_Destroy(MR_C_std_function_void_from_int_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_void_from_int_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_void_from_int_int_DestroyArray(MR_C_std_function_void_from_int_int *_this);
