...
MR_C_API MR_C_std_function_void_from_int_int *MR_C_std_function_void_from_int_int_DefaultConstruct(void);

/// Constructs an array of empty (default-constructed) instances, of the specified size. Will never return null.
/// The array must be destroyed using `MR_C_std_function_void_from_int_int_DestroyArray()`.
/// Use `MR_C_std_function_void_from_int_int_OffsetMutablePtr()` and `MR_C_std_function_void_from_int_int_OffsetPtr()` to access the array elements.
MR_C_API MR_C_std_function_void_from_int_int *MR_C_std_function_void_from_int_int_DefaultConstructArray(size_t num_elems);
...
MR_C_API void MR_C_std_function_void_from_int_int_Destroy(const MR_C_std_function_void_from_int_int *_this);

/// Destroys a heap-allocated array of `MR_C_std_function_void_from_int_int`. Does nothing if the pointer is null.
MR_C_API void MR_C_std_function_void_from_int_int_DestroyArray(const MR_C_std_function_void_from_int_int *_this);

/// Offsets a pointer to an array element by `i` positions (not bytes). Use only if you're certain that the pointer points to an array element.
/// The reference to the parameter `ptr` might be preserved in the return value.
MR_C_API const MR_C_std_function_void_from_int_int *MR_C_std_function_void_from_int_int_OffsetPtr(const MR_C_std_function_void_from_int_int *ptr, ptrdiff_t i);
...
/// Parameter `_this` can not be null. It is a single object.
MR_C_API bool MR_C_std_function_void_from_int_int_has_value(const MR_C_std_function_void_from_int_int *_this);

/// Destroys the stored callable, making this instance null.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_void_from_int_int_reset(MR_C_std_function_void_from_int_int *_this);

/// Calls the stored callable.
/// Parameter `_this` can not be null. It is a single object.
MR_C_API void MR_C_std_function_void_from_int_int_call(const MR_C_std_function_void_from_int_int *_this, int _1, int _2);

/// Construct a stateless function.
/// Never returns null. Returns an instance allocated on the heap! Must call `MR_C_std_function_void_from_int_int_Destroy()` to free it when you're done using it.
MR_C_API MR_C_std_function_void_from_int_int *MR_C_std_function_void_from_int_int_ConstructStateless(void (*func)(int _1, int _2));
...
MR_C_API MR_C_std_function_void_from_int_int *MR_C_std_function_void_from_int_int_ConstructEx(void (*func)(int _1, int _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
...
///   If `*_this_userdata` is non-null and `_other_userdata` is non-null, the functor is being assigned. The simplest option is to destroy `*_this_userdata` first, and then behave as if it was null.
///   Both `*_this_userdata` and `_other_userdata` will never be null at the same time.
MR_C_API void MR_C_std_function_void_from_int_int_AssignEx(MR_C_std_function_void_from_int_int *_this, void (*func)(int _1, int _2, void *_userdata, void **_cleanup_value), void *userdata, void (*postcall_callback)(void *_userdata, void *_cleanup_value), void (*userdata_callback)(void **_this_userdata, void *_other_userdata));
