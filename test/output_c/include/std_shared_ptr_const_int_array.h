...
typedef struct MR_C_std_shared_ptr_const_int_array MR_C_std_shared_ptr_const_int_array; // Defined below in this file.
...
/// Parameter `_this` can not be null.
MR_C_API long MR_C_std_shared_ptr_const_int_array_UseCount(const MR_C_std_shared_ptr_const_int_array *_this);
...
MR_C_API void MR_C_std_shared_ptr_const_int_array_Construct(const int *ptr);
