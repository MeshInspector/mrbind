...
{
    MRBINDC_TRY(
    return bool(((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const std::shared_ptr<const MR::StdSharedPtr::A[42]> *)(_this)));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const MR::StdSharedPtr::A[42]> *)(_this)).reset();
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const MR::StdSharedPtr::A[42]> *)(_this)) = std::shared_ptr<const MR::StdSharedPtr::A[42]>(std::shared_ptr<void>{}, ((const MR::StdSharedPtr::A *)ptr));
    ) // MRBINDC_TRY
}
...
void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_AssignFromMutable(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 *_this, MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_MR_StdSharedPtr_A_array_42 *ptr)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(ptr, std::shared_ptr<MR::StdSharedPtr::A[42]>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const MR::StdSharedPtr::A[42]> *)(_this)) = (MRBINDC_CLASSARG_DEF_CTOR(ptr, std::shared_ptr<MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_COPY(ptr, (std::shared_ptr<MR::StdSharedPtr::A[42]>), std::shared_ptr<MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_MOVE(ptr, (std::shared_ptr<MR::StdSharedPtr::A[42]>), std::shared_ptr<MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(ptr, MR_C_PassBy_DefaultArgument, std::shared_ptr<MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(ptr, MR_C_PassBy_NoObject, std::shared_ptr<MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_END(ptr, std::shared_ptr<MR::StdSharedPtr::A[42]>));
    ) // MRBINDC_TRY
}
...
void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42_AssignAliasing(MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 *_this, MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, const MR_StdSharedPtr_A *ptr)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(ownership, std::shared_ptr<const void>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const MR::StdSharedPtr::A[42]> *)(_this)) = std::shared_ptr<const MR::StdSharedPtr::A[42]>(
        (MRBINDC_CLASSARG_DEF_CTOR(ownership, std::shared_ptr<const void>) MRBINDC_CLASSARG_COPY(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_MOVE(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_DefaultArgument, std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_NoObject, std::shared_ptr<const void>) MRBINDC_CLASSARG_END(ownership, std::shared_ptr<const void>)),
        ((const MR::StdSharedPtr::A *)ptr)
    );
    ) // MRBINDC_TRY
...
MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_void_ConstructFrom_MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42(MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 *_other)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>);
    return (MR_C_std_shared_ptr_const_void *)new std::shared_ptr<const void>(std::shared_ptr<const void>(
        (MRBINDC_CLASSARG_DEF_CTOR(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_COPY(_other, (std::shared_ptr<const MR::StdSharedPtr::A[42]>), std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_MOVE(_other, (std::shared_ptr<const MR::StdSharedPtr::A[42]>), std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(_other, MR_C_PassBy_DefaultArgument, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(_other, MR_C_PassBy_NoObject, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_END(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>))
    ));
    ) // MRBINDC_TRY
}

void MR_C_std_shared_ptr_const_void_AssignFrom_MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42(MR_C_std_shared_ptr_const_void *_this, MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_array_42 *_other)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>);
    ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(std::shared_ptr<const void> *)(_this)) = (MRBINDC_CLASSARG_DEF_CTOR(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_COPY(_other, (std::shared_ptr<const MR::StdSharedPtr::A[42]>), std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_MOVE(_other, (std::shared_ptr<const MR::StdSharedPtr::A[42]>), std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(_other, MR_C_PassBy_DefaultArgument, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(_other, MR_C_PassBy_NoObject, std::shared_ptr<const MR::StdSharedPtr::A[42]>) MRBINDC_CLASSARG_END(_other, std::shared_ptr<const MR::StdSharedPtr::A[42]>));
    ) // MRBINDC_TRY
}
