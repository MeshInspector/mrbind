...
{
    (_this ? *(phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::btree_multiset<int>) MRBINDC_CLASSARG_COPY(other, (phmap::btree_multiset<int>), phmap::btree_multiset<int>) MRBINDC_CLASSARG_MOVE(other, (phmap::btree_multiset<int>), phmap::btree_multiset<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::btree_multiset<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::btree_multiset<int>) MRBINDC_CLASSARG_END(other, phmap::btree_multiset<int>))
    );
}

void MR_C_phmap_btree_multiset_int_Destroy(MR_C_phmap_btree_multiset_int *_this)
{
    delete ((phmap::btree_multiset<int> *)_this);
}

void MR_C_phmap_btree_multiset_int_DestroyArray(MR_C_phmap_btree_multiset_int *_this)
{
    delete[] ((phmap::btree_multiset<int> *)_this);
}
...
bool MR_C_phmap_btree_multiset_int_IsEmpty(const MR_C_phmap_btree_multiset_int *_this)
{
    return (_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_btree_multiset_int_Clear(MR_C_phmap_btree_multiset_int *_this)
{
    (_this ? *(phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

size_t MR_C_phmap_btree_multiset_int_Count(const MR_C_phmap_btree_multiset_int *_this, const int *key)
{
    return (_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).count(
...
{
    return (MR_C_phmap_btree_multiset_int_const_iterator *)new phmap::btree_multiset<int>::const_iterator((_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *key : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_btree_multiset_int_const_iterator *)new phmap::btree_multiset<int>::const_iterator((_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}

bool MR_C_phmap_btree_multiset_int_IsBegin(const MR_C_phmap_btree_multiset_int *_this, const MR_C_phmap_btree_multiset_int_const_iterator *iter)
{
    return (_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::btree_multiset<int>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_btree_multiset_int_const_iterator *MR_C_phmap_btree_multiset_int_End(const MR_C_phmap_btree_multiset_int *_this)
{
    return (MR_C_phmap_btree_multiset_int_const_iterator *)new phmap::btree_multiset<int>::const_iterator((_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}

bool MR_C_phmap_btree_multiset_int_IsEnd(const MR_C_phmap_btree_multiset_int *_this, const MR_C_phmap_btree_multiset_int_const_iterator *iter)
{
    return (_this ? *(const phmap::btree_multiset<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::btree_multiset<int>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_btree_multiset_int_const_iterator *)new phmap::btree_multiset<int>::const_iterator(phmap::btree_multiset<int>::const_iterator(
        (other ? phmap::btree_multiset<int>::const_iterator(*(phmap::btree_multiset<int>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_multiset<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::btree_multiset<int>::const_iterator(*(phmap::btree_multiset<int>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}

void MR_C_phmap_btree_multiset_int_const_iterator_Destroy(MR_C_phmap_btree_multiset_int_const_iterator *_this)
{
    delete ((phmap::btree_multiset<int>::const_iterator *)_this);
}

void MR_C_phmap_btree_multiset_int_const_iterator_DestroyArray(MR_C_phmap_btree_multiset_int_const_iterator *_this)
{
    delete[] ((phmap::btree_multiset<int>::const_iterator *)_this);
}
...
{
    return &(*(_this ? *(const phmap::btree_multiset<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}

void MR_C_phmap_btree_multiset_int_const_iterator_Incr(MR_C_phmap_btree_multiset_int_const_iterator *_this)
{
    ++(_this ? *(phmap::btree_multiset<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
