...
namespace mrbindc_details
{
    ...
    #define MRBINDC_CLASSARG_DEF_ARG(param_, default_arg_, .../*cpp_type_*/) param_##_pass_by == MR_C_PassBy_DefaultArgument ? (param_ ? throw std::runtime_error("Expected a null pointer to be passed to `" #param_ " because `MR_C_PassBy_DefaultArgument` was used.") : __VA_ARGS__(default_arg_)) :
    #define MRBINDC_CLASSARG_NO_DEF_ARG(param_, .../*cpp_type_*/) param_##_pass_by == MR_C_PassBy_DefaultArgument ? throw std::runtime_error("Function parameter `" #param_ " has no default argument, yet `MR_C_PassBy_DefaultArgument` was used for it.") :
