...
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<int[42]>);
    return (MR_C_std_shared_ptr_int_array_42 *)new std::shared_ptr<int[42]>(std::shared_ptr<int[42]>(
...
void MR_C_std_shared_ptr_int_array_42_AssignFromAnother(MR_C_std_shared_ptr_int_array_42 *_this, MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_int_array_42 *other)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<int[42]>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int[42]> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::shared_ptr<int[42]>) MRBINDC_CLASSARG_COPY(other, (std::shared_ptr<int[42]>), std::shared_ptr<int[42]>) MRBINDC_CLASSARG_MOVE(other, (std::shared_ptr<int[42]>), std::shared_ptr<int[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::shared_ptr<int[42]>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::shared_ptr<int[42]>) MRBINDC_CLASSARG_END(other, std::shared_ptr<int[42]>))
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int[42]> *)(_this)).get();
    ) // MRBINDC_TRY
}

bool MR_C_std_shared_ptr_int_array_42_has_value(const MR_C_std_shared_ptr_int_array_42 *_this)
{
    MRBINDC_TRY(
    return bool(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int[42]> *)(_this)));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return int(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int[42]> *)(_this)).use_count());
    ) // MRBINDC_TRY
}

void MR_C_std_shared_ptr_int_array_42_reset(MR_C_std_shared_ptr_int_array_42 *_this)
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int[42]> *)(_this)).reset();
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int[42]> *)(_this)) = std::shared_ptr<int[42]>(std::unique_ptr<int[]>(ptr).release());
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int[42]> *)(_this)) = std::shared_ptr<int[42]>(std::shared_ptr<void>{}, ptr);
    ) // MRBINDC_TRY
}
...
void MR_C_std_shared_ptr_int_array_42_AssignAliasing(MR_C_std_shared_ptr_int_array_42 *_this, MR_C_PassBy ownership_pass_by, MR_C_std_shared_ptr_const_void *ownership, int *ptr)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(ownership, std::shared_ptr<const void>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<int[42]> *)(_this)) = std::shared_ptr<int[42]>(
        (MRBINDC_CLASSARG_DEF_CTOR(ownership, std::shared_ptr<const void>) MRBINDC_CLASSARG_COPY(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_MOVE(ownership, (std::shared_ptr<const void>), std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_DefaultArgument, std::shared_ptr<const void>) MRBINDC_CLASSARG_NO_DEF_ARG(ownership, MR_C_PassBy_NoObject, std::shared_ptr<const void>) MRBINDC_CLASSARG_END(ownership, std::shared_ptr<const void>)),
        ptr
    );
    ) // MRBINDC_TRY
...
MR_C_std_shared_ptr_void *MR_C_std_shared_ptr_int_array_42_ConvertTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int_array_42 *_this)
{
    MRBINDC_TRY(
    return (MR_C_std_shared_ptr_void *)new std::shared_ptr<void>(std::shared_ptr<void>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int[42]> *)(_this))));
    ) // MRBINDC_TRY
}

void MR_C_std_shared_ptr_int_array_42_AssignTo_MR_C_std_shared_ptr_void(const MR_C_std_shared_ptr_int_array_42 *_this, MR_C_std_shared_ptr_void *_target)
{
    MRBINDC_TRY(
    ((_target ? void() : MRBINDC_THROW("Parameter `_target` can not be null.", void)), *(std::shared_ptr<void> *)(_target)) = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<int[42]> *)(_this));
    ) // MRBINDC_TRY
}
