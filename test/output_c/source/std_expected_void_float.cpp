...
MR_C_std_expected_void_float *MR_C_std_expected_void_float_ConstructFrom(const MR_C_std_expected_void_float *other)
{
    return (MR_C_std_expected_void_float *)new std::expected<void, float>(std::expected<void, float>(
        (other ? std::expected<void, float>(*(std::expected<void, float> *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
...
void MR_C_std_expected_void_float_AssignFrom(MR_C_std_expected_void_float *_this, const MR_C_std_expected_void_float *other)
{
    (_this ? *(std::expected<void, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? std::expected<void, float>(*(std::expected<void, float> *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
...
void MR_C_std_expected_void_float_Destroy(MR_C_std_expected_void_float *_this)
{
    delete ((std::expected<void, float> *)_this);
}

void MR_C_std_expected_void_float_DestroyArray(MR_C_std_expected_void_float *_this)
{
    delete[] ((std::expected<void, float> *)_this);
}
