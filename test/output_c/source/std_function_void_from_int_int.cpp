...
{
    return (MR_C_std_function_void_from_int_int *)new std::function<void(int, int)>(func ? std::function<void(int, int)>(_functor{func, userdata, userdata_callback}) : nullptr);
}
