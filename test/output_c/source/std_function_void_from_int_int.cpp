...
void MR_C_std_function_void_from_int_int_Destroy(MR_C_std_function_void_from_int_int *_this)
{
    delete ((std::function<void(int, int)> *)_this);
}

void MR_C_std_function_void_from_int_int_DestroyArray(MR_C_std_function_void_from_int_int *_this)
{
    delete[] ((std::function<void(int, int)> *)_this);
}
