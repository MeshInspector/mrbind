...
MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_void_ConstructFrom_MR_C_std_shared_ptr_const_int(MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_int *_other)
{
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<const int>);
...
void MR_C_std_shared_ptr_const_void_AssignFrom_MR_C_std_shared_ptr_const_int(MR_C_std_shared_ptr_const_void *_this, MR_C_PassBy _other_pass_by, MR_C_std_shared_ptr_const_int *_other)
{
    MRBINDC_CLASSARG_GUARD(_other, std::shared_ptr<const int>);
