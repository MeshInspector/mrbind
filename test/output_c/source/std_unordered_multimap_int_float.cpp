...
{
    return (MR_C_std_unordered_multimap_int_float *)new std::unordered_multimap<int, float>(std::unordered_multimap<int, float>(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::unordered_multimap<int, float>) MRBINDC_CLASSARG_COPY(other, std::unordered_multimap<int, float>) MRBINDC_CLASSARG_MOVE(other, std::unordered_multimap<int, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::unordered_multimap<int, float>) MRBINDC_CLASSARG_END(other, std::unordered_multimap<int, float>))
    ));
}
...
{
    return (MR_C_std_unordered_multimap_int_float_const_iterator *)new std::unordered_multimap<int, float>::const_iterator(std::unordered_multimap<int, float>::const_iterator(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::unordered_multimap<int, float>::const_iterator) MRBINDC_CLASSARG_COPY(other, std::unordered_multimap<int, float>::const_iterator) MRBINDC_CLASSARG_MOVE(other, std::unordered_multimap<int, float>::const_iterator) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::unordered_multimap<int, float>::const_iterator) MRBINDC_CLASSARG_END(other, std::unordered_multimap<int, float>::const_iterator))
    ));
}
...
{
    return (MR_C_std_unordered_multimap_int_float_iterator *)new std::unordered_multimap<int, float>::iterator(std::unordered_multimap<int, float>::iterator(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::unordered_multimap<int, float>::iterator) MRBINDC_CLASSARG_COPY(other, std::unordered_multimap<int, float>::iterator) MRBINDC_CLASSARG_MOVE(other, std::unordered_multimap<int, float>::iterator) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::unordered_multimap<int, float>::iterator) MRBINDC_CLASSARG_END(other, std::unordered_multimap<int, float>::iterator))
    ));
}
