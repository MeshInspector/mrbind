...
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::function<int(void)> *)(_this)).operator()();
    ) // MRBINDC_TRY
}
...
namespace
{
    struct _functor_MR_C_std_function_int
    {
        ...
        _functor_MR_C_std_function_int(FuncPtr _func, void *_userdata, PostcallCbPtr _postcall_cb, UserdataCbPtr _userdata_cb) : _func(_func), _userdata(_userdata), _postcall_cb(_postcall_cb), _userdata_cb(_userdata_cb) {}

        _functor_MR_C_std_function_int(const _functor_MR_C_std_function_int &other) : _func(other._func), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
        ...
        _functor_MR_C_std_function_int(_functor_MR_C_std_function_int &&other) noexcept : _func(other._func), _userdata(other._userdata), _postcall_cb(other._postcall_cb), _userdata_cb(other._userdata_cb)
        {
            other._func = nullptr;
        ...
        _functor_MR_C_std_function_int &operator=(const _functor_MR_C_std_function_int &other)
        {
        ...
        _functor_MR_C_std_function_int &operator=(_functor_MR_C_std_function_int &&other) noexcept
        {
            _func = other._func;
            _userdata = other._userdata;
            _postcall_cb = other._postcall_cb;
        ...
        ~_functor_MR_C_std_function_int()
        {
        ...
        auto operator()(void) -> int
        {
            ...
            {
                _functor_MR_C_std_function_int *_self = nullptr;
                void *_value = nullptr;
                ~_cleanup_guard_type()
                {
