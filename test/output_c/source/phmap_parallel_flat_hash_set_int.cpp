...
{
    (_this ? *(phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::parallel_flat_hash_set<int>) MRBINDC_CLASSARG_COPY(other, (phmap::parallel_flat_hash_set<int>), phmap::parallel_flat_hash_set<int>) MRBINDC_CLASSARG_MOVE(other, (phmap::parallel_flat_hash_set<int>), phmap::parallel_flat_hash_set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::parallel_flat_hash_set<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::parallel_flat_hash_set<int>) MRBINDC_CLASSARG_END(other, phmap::parallel_flat_hash_set<int>))
    );
}

void MR_C_phmap_parallel_flat_hash_set_int_Destroy(MR_C_phmap_parallel_flat_hash_set_int *_this)
{
    delete ((phmap::parallel_flat_hash_set<int> *)_this);
}

void MR_C_phmap_parallel_flat_hash_set_int_DestroyArray(MR_C_phmap_parallel_flat_hash_set_int *_this)
{
    delete[] ((phmap::parallel_flat_hash_set<int> *)_this);
}
...
{
    return (_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_phmap_parallel_flat_hash_set_int_IsEmpty(const MR_C_phmap_parallel_flat_hash_set_int *_this)
{
    return (_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_parallel_flat_hash_set_int_Clear(MR_C_phmap_parallel_flat_hash_set_int *_this)
{
    (_this ? *(phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

bool MR_C_phmap_parallel_flat_hash_set_int_Contains(const MR_C_phmap_parallel_flat_hash_set_int *_this, const int *key)
{
    return (_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int_const_iterator *)new phmap::parallel_flat_hash_set<int>::const_iterator((_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *key : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        new_elem
    );
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int_const_iterator *)new phmap::parallel_flat_hash_set<int>::const_iterator((_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::parallel_flat_hash_set<int>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int_const_iterator *)new phmap::parallel_flat_hash_set<int>::const_iterator((_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}
...
{
    return (_this ? *(const phmap::parallel_flat_hash_set<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::parallel_flat_hash_set<int>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_parallel_flat_hash_set_int_const_iterator *)new phmap::parallel_flat_hash_set<int>::const_iterator(phmap::parallel_flat_hash_set<int>::const_iterator(
        (other ? phmap::parallel_flat_hash_set<int>::const_iterator(*(phmap::parallel_flat_hash_set<int>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::parallel_flat_hash_set<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::parallel_flat_hash_set<int>::const_iterator(*(phmap::parallel_flat_hash_set<int>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}

void MR_C_phmap_parallel_flat_hash_set_int_const_iterator_Destroy(MR_C_phmap_parallel_flat_hash_set_int_const_iterator *_this)
{
    delete ((phmap::parallel_flat_hash_set<int>::const_iterator *)_this);
}

void MR_C_phmap_parallel_flat_hash_set_int_const_iterator_DestroyArray(MR_C_phmap_parallel_flat_hash_set_int_const_iterator *_this)
{
    delete[] ((phmap::parallel_flat_hash_set<int>::const_iterator *)_this);
}
...
{
    return &(*(_this ? *(const phmap::parallel_flat_hash_set<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")));
}
...
{
    ++(_this ? *(phmap::parallel_flat_hash_set<int>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
