...
{
    return std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::parallel_flat_hash_set<int>::const_iterator *)(_this)));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), phmap::parallel_flat_hash_set<int>::const_iterator(*(phmap::parallel_flat_hash_set<int>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), phmap::parallel_flat_hash_set<int>::const_iterator(*(phmap::parallel_flat_hash_set<int>::const_iterator *)b));
}
