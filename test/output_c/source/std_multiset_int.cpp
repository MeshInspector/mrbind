...
{
    delete ((std::multiset<int> *)_this);
}

void MR_C_std_multiset_int_DestroyArray(MR_C_std_multiset_int *_this)
{
    delete[] ((std::multiset<int> *)_this);
}
...
{
    delete ((std::multiset<int>::const_iterator *)_this);
}

void MR_C_std_multiset_int_const_iterator_DestroyArray(MR_C_std_multiset_int_const_iterator *_this)
{
    delete[] ((std::multiset<int>::const_iterator *)_this);
}
