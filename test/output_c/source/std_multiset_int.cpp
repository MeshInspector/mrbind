...
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::multiset<int>);
    return (MR_C_std_multiset_int *)new std::multiset<int>(std::multiset<int>(
...
void MR_C_std_multiset_int_AssignFromAnother(MR_C_std_multiset_int *_this, MR_C_PassBy other_pass_by, MR_C_std_multiset_int *other)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::multiset<int>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::multiset<int>) MRBINDC_CLASSARG_COPY(other, (std::multiset<int>), std::multiset<int>) MRBINDC_CLASSARG_MOVE(other, (std::multiset<int>), std::multiset<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::multiset<int>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::multiset<int>) MRBINDC_CLASSARG_END(other, std::multiset<int>))
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int> *)(_this)) = std::multiset<int>(ptr, ptr + size);
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).size();
    ) // MRBINDC_TRY
}

bool MR_C_std_multiset_int_empty(const MR_C_std_multiset_int *_this)
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).empty();
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int> *)(_this)).clear();
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).count(
...
{
    MRBINDC_TRY(
    return (MR_C_std_multiset_int_const_iterator *)new std::multiset<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).find(
        ((key ? void() : MRBINDC_THROW("Parameter `key` can not be null.", void)), *key)
    ));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int> *)(_this)).insert(
        new_elem
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return (MR_C_std_multiset_int_const_iterator *)new std::multiset<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).cbegin());
    ) // MRBINDC_TRY
}

bool MR_C_std_multiset_int_is_begin(const MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *iter)
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).cbegin() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<int>::const_iterator *)(iter));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return (MR_C_std_multiset_int_const_iterator *)new std::multiset<int>::const_iterator(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).cend());
    ) // MRBINDC_TRY
}

bool MR_C_std_multiset_int_is_end(const MR_C_std_multiset_int *_this, const MR_C_std_multiset_int_const_iterator *iter)
{
    MRBINDC_TRY(
    return ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int> *)(_this)).cend() == ((iter ? void() : MRBINDC_THROW("Parameter `iter` can not be null.", void)), *(const std::multiset<int>::const_iterator *)(iter));
    ) // MRBINDC_TRY
}
...
MR_C_std_multiset_int_const_iterator *MR_C_std_multiset_int_const_iterator_ConstructFromAnother(const MR_C_std_multiset_int_const_iterator *other)
{
    MRBINDC_TRY(
    return (MR_C_std_multiset_int_const_iterator *)new std::multiset<int>::const_iterator(std::multiset<int>::const_iterator(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)other))
    ));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int>::const_iterator *)(_this)).operator=(
        ((other ? void() : MRBINDC_THROW("Parameter `other` can not be null.", void)), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)other))
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return std::addressof(*((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::multiset<int>::const_iterator *)(_this)));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ++((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::multiset<int>::const_iterator *)(_this));
    ) // MRBINDC_TRY
}
...
bool MR_C_equal_MR_C_std_multiset_int_const_iterator(const MR_C_std_multiset_int_const_iterator *a, const MR_C_std_multiset_int_const_iterator *b)
{
    MRBINDC_TRY(
    return ((a ? void() : MRBINDC_THROW("Parameter `a` can not be null.", void)), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)a)) == ((b ? void() : MRBINDC_THROW("Parameter `b` can not be null.", void)), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)b));
    ) // MRBINDC_TRY
}
