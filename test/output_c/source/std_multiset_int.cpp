...
{
    MRBINDC_TRY(
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::multiset<int>::const_iterator(*(std::multiset<int>::const_iterator *)b));
    ) // MRBINDC_TRY
}
