...
{
    delete ((std::set<int> *)_this);
}

void MR_C_std_set_int_DestroyArray(MR_C_std_set_int *_this)
{
    delete[] ((std::set<int> *)_this);
}
...
{
    delete ((std::set<int>::const_iterator *)_this);
}

void MR_C_std_set_int_const_iterator_DestroyArray(MR_C_std_set_int_const_iterator *_this)
{
    delete[] ((std::set<int>::const_iterator *)_this);
}
