...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), std::set<int>::const_iterator(*(std::set<int>::const_iterator *)b));
}
