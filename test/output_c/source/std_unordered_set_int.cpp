...
void MR_C_std_unordered_set_int_InsertAtIter(MR_C_std_unordered_set_int *_this, const MR_C_std_unordered_set_int_const_iterator *position, int new_elem)
{
    (_this ? *(std::unordered_set<int>*)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).insert(
        (position ? std::unordered_set<int>::const_iterator(*(std::unordered_set<int>::const_iterator *)position) : throw std::runtime_error("Parameter `position` can not be null.")),
        new_elem
    );
}

void MR_C_std_unordered_set_int_EraseAtIter(MR_C_std_unordered_set_int *_this, const MR_C_std_unordered_set_int_const_iterator *position)
{
    (_this ? *(std::unordered_set<int>*)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).erase(
        (position ? std::unordered_set<int>::const_iterator(*(std::unordered_set<int>::const_iterator *)position) : throw std::runtime_error("Parameter `position` can not be null."))
    );
}
