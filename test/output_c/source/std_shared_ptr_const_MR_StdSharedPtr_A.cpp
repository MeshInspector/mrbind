...
long MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_UseCount(const MR_C_std_shared_ptr_const_MR_StdSharedPtr_A *_this)
{
...
void MR_C_std_shared_ptr_const_MR_StdSharedPtr_A_Construct(const MR_StdSharedPtr_A *ptr)
{
