...
{
    return (MR_C_std_map_int_float_const_iterator *)new std::map<int, float>::const_iterator(std::map<int, float>::const_iterator(
        (other ? std::map<int, float>::const_iterator(*(std::map<int, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    return (MR_C_std_map_int_float_iterator *)new std::map<int, float>::iterator(std::map<int, float>::iterator(
        (other ? std::map<int, float>::iterator(*(std::map<int, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
