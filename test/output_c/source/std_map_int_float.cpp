...
{
    return (MR_C_std_map_int_float_const_iterator *)new std::map<int, float>::const_iterator(std::map<int, float>::const_iterator(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::map<int, float>::const_iterator) MRBINDC_CLASSARG_COPY(other, (std::map<int, float>::const_iterator), std::map<int, float>::const_iterator) MRBINDC_CLASSARG_MOVE(other, (std::map<int, float>::const_iterator), std::map<int, float>::const_iterator) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::map<int, float>::const_iterator) MRBINDC_CLASSARG_END(other, std::map<int, float>::const_iterator))
    ));
}
...
{
    return (MR_C_std_map_int_float_iterator *)new std::map<int, float>::iterator(std::map<int, float>::iterator(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::map<int, float>::iterator) MRBINDC_CLASSARG_COPY(other, (std::map<int, float>::iterator), std::map<int, float>::iterator) MRBINDC_CLASSARG_MOVE(other, (std::map<int, float>::iterator), std::map<int, float>::iterator) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::map<int, float>::iterator) MRBINDC_CLASSARG_END(other, std::map<int, float>::iterator))
    ));
}
