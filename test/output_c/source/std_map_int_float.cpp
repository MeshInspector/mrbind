...
{
    return (MR_C_std_map_int_float *)new std::map<int, float>(std::map<int, float>(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::map<int, float>) MRBINDC_CLASSARG_COPY(other, (std::map<int, float>), std::map<int, float>) MRBINDC_CLASSARG_MOVE(other, (std::map<int, float>), std::map<int, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, std::map<int, float>) MRBINDC_CLASSARG_END(other, std::map<int, float>))
    ));
}
