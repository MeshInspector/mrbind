...
void MR_C_std_function_void_from_MR_StdFunction_A_Destroy(MR_C_std_function_void_from_MR_StdFunction_A *_this)
{
    delete ((std::function<void(MR::StdFunction::A)> *)_this);
}

void MR_C_std_function_void_from_MR_StdFunction_A_DestroyArray(MR_C_std_function_void_from_MR_StdFunction_A *_this)
{
    delete[] ((std::function<void(MR::StdFunction::A)> *)_this);
}
