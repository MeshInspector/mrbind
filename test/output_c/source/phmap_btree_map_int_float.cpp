...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_map<int, float> *)(_this)).begin() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::btree_map<int, float>::iterator *)(iter));
}
...
{
    return ((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_map<int, float> *)(_this)).end() == ((iter ? void() : throw std::runtime_error("Parameter `iter` can not be null.")), *(const phmap::btree_map<int, float>::iterator *)(iter));
}
...
{
    return (const MR_C_std_pair_const_int_float *)std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_map<int, float>::const_iterator *)(_this)));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), phmap::btree_map<int, float>::const_iterator(*(phmap::btree_map<int, float>::const_iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), phmap::btree_map<int, float>::const_iterator(*(phmap::btree_map<int, float>::const_iterator *)b));
}
...
{
    return (MR_C_std_pair_const_int_float *)std::addressof(*((_this ? void() : throw std::runtime_error("Parameter `_this` can not be null.")), *(const phmap::btree_map<int, float>::iterator *)(_this)));
}
...
{
    return ((a ? void() : throw std::runtime_error("Parameter `a` can not be null.")), phmap::btree_map<int, float>::iterator(*(phmap::btree_map<int, float>::iterator *)a)) == ((b ? void() : throw std::runtime_error("Parameter `b` can not be null.")), phmap::btree_map<int, float>::iterator(*(phmap::btree_map<int, float>::iterator *)b));
}
