...
{
    (_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, phmap::btree_map<int, float>) MRBINDC_CLASSARG_COPY(other, (phmap::btree_map<int, float>), phmap::btree_map<int, float>) MRBINDC_CLASSARG_MOVE(other, (phmap::btree_map<int, float>), phmap::btree_map<int, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, phmap::btree_map<int, float>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, phmap::btree_map<int, float>) MRBINDC_CLASSARG_END(other, phmap::btree_map<int, float>))
    );
}

void MR_C_phmap_btree_map_int_float_Destroy(MR_C_phmap_btree_map_int_float *_this)
{
    delete ((phmap::btree_map<int, float> *)_this);
}

void MR_C_phmap_btree_map_int_float_DestroyArray(MR_C_phmap_btree_map_int_float *_this)
{
    delete[] ((phmap::btree_map<int, float> *)_this);
}
...
{
    return (_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).size();
}

bool MR_C_phmap_btree_map_int_float_IsEmpty(const MR_C_phmap_btree_map_int_float *_this)
{
    return (_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).empty();
}

void MR_C_phmap_btree_map_int_float_Clear(MR_C_phmap_btree_map_int_float *_this)
{
    (_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).clear();
}

float *MR_C_phmap_btree_map_int_float_FindOrConstructElem(MR_C_phmap_btree_map_int_float *_this, const int *key)
{
    return &((_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))[(key ? *key : throw std::runtime_error("Parameter `key` can not be null."))]);
}

bool MR_C_phmap_btree_map_int_float_Contains(const MR_C_phmap_btree_map_int_float *_this, const int *key)
{
    return (_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).contains(
...
{
    return (MR_C_phmap_btree_map_int_float_const_iterator *)new phmap::btree_map<int, float>::const_iterator((_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *key : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_btree_map_int_float_iterator *)new phmap::btree_map<int, float>::iterator((_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).find(
        (key ? *key : throw std::runtime_error("Parameter `key` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_btree_map_int_float_const_iterator *)new phmap::btree_map<int, float>::const_iterator((_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin());
}
...
{
    return (_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cbegin() == (iter ? *(const phmap::btree_map<int, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_btree_map_int_float_iterator *MR_C_phmap_btree_map_int_float_MutableBegin(MR_C_phmap_btree_map_int_float *_this)
{
    return (MR_C_phmap_btree_map_int_float_iterator *)new phmap::btree_map<int, float>::iterator((_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin());
}
...
{
    return (_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).begin() == (iter ? *(const phmap::btree_map<int, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_btree_map_int_float_const_iterator *)new phmap::btree_map<int, float>::const_iterator((_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend());
}
...
{
    return (_this ? *(const phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).cend() == (iter ? *(const phmap::btree_map<int, float>::const_iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}

MR_C_phmap_btree_map_int_float_iterator *MR_C_phmap_btree_map_int_float_MutableEnd(MR_C_phmap_btree_map_int_float *_this)
{
    return (MR_C_phmap_btree_map_int_float_iterator *)new phmap::btree_map<int, float>::iterator((_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end());
}
...
{
    return (_this ? *(phmap::btree_map<int, float> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).end() == (iter ? *(const phmap::btree_map<int, float>::iterator *)(iter) : throw std::runtime_error("Parameter `iter` can not be null."));
}
...
{
    return (MR_C_phmap_btree_map_int_float_const_iterator *)new phmap::btree_map<int, float>::const_iterator(phmap::btree_map<int, float>::const_iterator(
        (other ? phmap::btree_map<int, float>::const_iterator(*(phmap::btree_map<int, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_map<int, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::btree_map<int, float>::const_iterator(*(phmap::btree_map<int, float>::const_iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}

void MR_C_phmap_btree_map_int_float_const_iterator_Destroy(MR_C_phmap_btree_map_int_float_const_iterator *_this)
{
    delete ((phmap::btree_map<int, float>::const_iterator *)_this);
}

void MR_C_phmap_btree_map_int_float_const_iterator_DestroyArray(MR_C_phmap_btree_map_int_float_const_iterator *_this)
{
    delete[] ((phmap::btree_map<int, float>::const_iterator *)_this);
}
...
MR_C_phmap_btree_map_int_float_const_iterator *MR_C_phmap_btree_map_int_float_const_iterator_FromMutable(const MR_C_phmap_btree_map_int_float_iterator *iter)
{
    return (MR_C_phmap_btree_map_int_float_const_iterator *)new phmap::btree_map<int, float>::const_iterator(phmap::btree_map<int, float>::iterator(
        (iter ? phmap::btree_map<int, float>::iterator(*(phmap::btree_map<int, float>::iterator *)iter) : throw std::runtime_error("Parameter `iter` can not be null."))
    ));
}
...
{
    return (MR_C_phmap_btree_map_int_float_iterator *)new phmap::btree_map<int, float>::iterator(phmap::btree_map<int, float>::iterator(
        (other ? phmap::btree_map<int, float>::iterator(*(phmap::btree_map<int, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    ));
}
...
{
    (_this ? *(phmap::btree_map<int, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (other ? phmap::btree_map<int, float>::iterator(*(phmap::btree_map<int, float>::iterator *)other) : throw std::runtime_error("Parameter `other` can not be null."))
    );
}

void MR_C_phmap_btree_map_int_float_iterator_Destroy(MR_C_phmap_btree_map_int_float_iterator *_this)
{
    delete ((phmap::btree_map<int, float>::iterator *)_this);
}

void MR_C_phmap_btree_map_int_float_iterator_DestroyArray(MR_C_phmap_btree_map_int_float_iterator *_this)
{
    delete[] ((phmap::btree_map<int, float>::iterator *)_this);
}
...
{
    return &((_this ? *(const phmap::btree_map<int, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}
...
{
    return &((_this ? *(const phmap::btree_map<int, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_phmap_btree_map_int_float_const_iterator_Incr(MR_C_phmap_btree_map_int_float_const_iterator *_this)
{
    ++(_this ? *(phmap::btree_map<int, float>::const_iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
...
{
    return &((_this ? *(const phmap::btree_map<int, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->first);
}

float *MR_C_phmap_btree_map_int_float_iterator_DerefValue(const MR_C_phmap_btree_map_int_float_iterator *_this)
{
    return &((_this ? *(const phmap::btree_map<int, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."))->second);
}

void MR_C_phmap_btree_map_int_float_iterator_Incr(MR_C_phmap_btree_map_int_float_iterator *_this)
{
    ++(_this ? *(phmap::btree_map<int, float>::iterator *)(_this) : throw std::runtime_error("Parameter `_this` can not be null."));
}
