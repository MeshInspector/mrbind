...
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<const MR::CSharp::SA>);
    return (MR_C_std_shared_ptr_const_MR_CSharp_SA *)new std::shared_ptr<const MR::CSharp::SA>(std::shared_ptr<const MR::CSharp::SA>(
...
void MR_C_std_shared_ptr_const_MR_CSharp_SA_AssignFromAnother(MR_C_std_shared_ptr_const_MR_CSharp_SA *_this, MR_C_PassBy other_pass_by, MR_C_std_shared_ptr_const_MR_CSharp_SA *other)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(other, std::shared_ptr<const MR::CSharp::SA>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)).operator=(
        (MRBINDC_CLASSARG_DEF_CTOR(other, std::shared_ptr<const MR::CSharp::SA>) MRBINDC_CLASSARG_COPY(other, (std::shared_ptr<const MR::CSharp::SA>), std::shared_ptr<const MR::CSharp::SA>) MRBINDC_CLASSARG_MOVE(other, (std::shared_ptr<const MR::CSharp::SA>), std::shared_ptr<const MR::CSharp::SA>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_DefaultArgument, std::shared_ptr<const MR::CSharp::SA>) MRBINDC_CLASSARG_NO_DEF_ARG(other, MR_C_PassBy_NoObject, std::shared_ptr<const MR::CSharp::SA>) MRBINDC_CLASSARG_END(other, std::shared_ptr<const MR::CSharp::SA>))
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    return (const MR_CSharp_SA *)(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this)).get());
    ) // MRBINDC_TRY
}

bool MR_C_std_shared_ptr_const_MR_CSharp_SA_has_value(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this)
{
    MRBINDC_TRY(
    return bool(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this)));
    ) // MRBINDC_TRY
}

int MR_C_std_shared_ptr_const_MR_CSharp_SA_use_count(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this)
{
    MRBINDC_TRY(
    return int(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this)).use_count());
    ) // MRBINDC_TRY
}

void MR_C_std_shared_ptr_const_MR_CSharp_SA_reset(MR_C_std_shared_ptr_const_MR_CSharp_SA *_this)
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)).reset();
    ) // MRBINDC_TRY
}

MR_C_std_shared_ptr_const_MR_CSharp_SA *MR_C_std_shared_ptr_const_MR_CSharp_SA_ConstructFromValue(const MR_CSharp_SA *value)
{
    MRBINDC_TRY(
    return (MR_C_std_shared_ptr_const_MR_CSharp_SA *)new std::shared_ptr<const MR::CSharp::SA>(std::make_shared<const MR::CSharp::SA>(
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)) = std::shared_ptr<const MR::CSharp::SA>(
        std::unique_ptr<const MR::CSharp::SA>((const MR::CSharp::SA *)ptr)
    );
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)) = std::shared_ptr<const MR::CSharp::SA>(std::shared_ptr<void>{}, ((const MR::CSharp::SA *)ptr));
    ) // MRBINDC_TRY
}
...
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(ptr, std::shared_ptr<MR::CSharp::SA>);
    return (MR_C_std_shared_ptr_const_MR_CSharp_SA *)new std::shared_ptr<const MR::CSharp::SA>(std::shared_ptr<const MR::CSharp::SA>(
...
void MR_C_std_shared_ptr_const_MR_CSharp_SA_AssignFromMutable(MR_C_std_shared_ptr_const_MR_CSharp_SA *_this, MR_C_PassBy ptr_pass_by, MR_C_std_shared_ptr_MR_CSharp_SA *ptr)
{
    MRBINDC_TRY(
    MRBINDC_CLASSARG_GUARD(ptr, std::shared_ptr<MR::CSharp::SA>);
    ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(std::shared_ptr<const MR::CSharp::SA> *)(_this)) = (MRBINDC_CLASSARG_DEF_CTOR(ptr, std::shared_ptr<MR::CSharp::SA>) MRBINDC_CLASSARG_COPY(ptr, (std::shared_ptr<MR::CSharp::SA>), std::shared_ptr<MR::CSharp::SA>) MRBINDC_CLASSARG_MOVE(ptr, (std::shared_ptr<MR::CSharp::SA>), std::shared_ptr<MR::CSharp::SA>) MRBINDC_CLASSARG_NO_DEF_ARG(ptr, MR_C_PassBy_DefaultArgument, std::shared_ptr<MR::CSharp::SA>) MRBINDC_CLASSARG_NO_DEF_ARG(ptr, MR_C_PassBy_NoObject, std::shared_ptr<MR::CSharp::SA>) MRBINDC_CLASSARG_END(ptr, std::shared_ptr<MR::CSharp::SA>));
    ) // MRBINDC_TRY
}
...
MR_C_std_shared_ptr_const_void *MR_C_std_shared_ptr_const_MR_CSharp_SA_ConvertTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this)
{
    MRBINDC_TRY(
    return (MR_C_std_shared_ptr_const_void *)new std::shared_ptr<const void>(std::shared_ptr<const void>(((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this))));
    ) // MRBINDC_TRY
}

void MR_C_std_shared_ptr_const_MR_CSharp_SA_AssignTo_MR_C_std_shared_ptr_const_void(const MR_C_std_shared_ptr_const_MR_CSharp_SA *_this, MR_C_std_shared_ptr_const_void *_target)
{
    MRBINDC_TRY(
    ((_target ? void() : MRBINDC_THROW("Parameter `_target` can not be null.", void)), *(std::shared_ptr<const void> *)(_target)) = ((_this ? void() : MRBINDC_THROW("Parameter `_this` can not be null.", void)), *(const std::shared_ptr<const MR::CSharp::SA> *)(_this));
    ) // MRBINDC_TRY
}
