...
void MR_C_std_vector_MR_A_PushBack(MR_C_std_vector_MR_A *_this, MR_A_PassBy new_elem_pass_by, MR_A *new_elem)
{
    (*((std::vector<MR::A>*)_this)).push_back(
        MRBINDC_CLASSARG_DEF_CTOR(new_elem, MR::A, MR_A_PassBy) MRBINDC_CLASSARG_COPY(new_elem, MR::A, MR_A_PassBy) MRBINDC_CLASSARG_MOVE(new_elem, MR::A, MR_A_PassBy) MRBINDC_CLASSARG_NO_DEF_ARG(new_elem, MR::A, MR_A_PassBy) MRBINDC_CLASSARG_END(new_elem, MR::A) 
    );
}
