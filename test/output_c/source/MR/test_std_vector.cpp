...
void MR_StdVector_Set(MR_C_PassBy _0_pass_by, MR_C_std_vector_int *_0)
{
    using namespace MR;
    using namespace StdVector;
    MR::StdVector::Set(
        MRBINDC_CLASSARG_DEF_CTOR(_0, std::vector<int>) MRBINDC_CLASSARG_COPY(_0, std::vector<int>) MRBINDC_CLASSARG_MOVE(_0, std::vector<int>) MRBINDC_CLASSARG_NO_DEF_ARG(_0, std::vector<int>) MRBINDC_CLASSARG_END(_0, std::vector<int>) 
    );
}

void MR_StdVector_SetWithDefault(MR_C_PassBy _0_pass_by, MR_C_std_vector_int *_0)
{
    using namespace MR;
    using namespace StdVector;
    MR::StdVector::SetWithDefault(
        MRBINDC_CLASSARG_DEF_CTOR(_0, std::vector<int>) MRBINDC_CLASSARG_COPY(_0, std::vector<int>) MRBINDC_CLASSARG_MOVE(_0, std::vector<int>) MRBINDC_CLASSARG_DEF_ARG(_0, std::vector<int>, std::type_identity_t<std::vector<int>>{1, 2, 3}) MRBINDC_CLASSARG_END(_0, std::vector<int>) 
    );
}
