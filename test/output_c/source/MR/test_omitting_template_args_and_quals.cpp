...
{
    return (MR_OmittingTargsAndQuals_A_int *)new MR::OmittingTargsAndQuals::A<int>(MR::OmittingTargsAndQuals::A<int>(
        (_other ? MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_other) : throw std::runtime_error("Parameter `_other` can not be null."))
    ));
}
...
{
    return (MR_OmittingTargsAndQuals_A_int *)&((_this ? *(MR::OmittingTargsAndQuals::A<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator=(
        (_other ? MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_other) : throw std::runtime_error("Parameter `_other` can not be null."))
    ));
}
...
{
    (_this ? *(MR::OmittingTargsAndQuals::A<int> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).operator+();
}
...
{
    a(
        (_1 ? MR::OmittingTargsAndQuals::A<int>(*(MR::OmittingTargsAndQuals::A<int> *)_1) : throw std::runtime_error("Parameter `_1` can not be null."))
    );
}
