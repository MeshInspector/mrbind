...
{
    return MRBINDC_BIT_CAST((MR_DeclOrder_A_B), (_this ? *(MR::DeclOrder::A *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).c());
}
...
{
    return MRBINDC_BIT_CAST((MR_DeclOrder_A), (_this ? *(MR::DeclOrder::A::B *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).a());
}
...
{
    return MRBINDC_BIT_CAST((MR_DeclOrder_C_true), (_this ? *(MR::DeclOrder::C<false> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).blah());
}

MR_DeclOrder_C_false MR_DeclOrder_C_true_blah(MR_DeclOrder_C_true *_this)
{
    return MRBINDC_BIT_CAST((MR_DeclOrder_C_false), (_this ? *(MR::DeclOrder::C<true> *)(_this) : throw std::runtime_error("Parameter `_this` can not be null.")).blah());
}
