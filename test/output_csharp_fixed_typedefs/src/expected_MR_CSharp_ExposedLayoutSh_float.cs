public static partial class MR
{
    public static partial class CS
    {
        ...
        public class Const_Expected_MRCSharpExposedLayoutSh_Float : MR.CS.Misc.Object<Const_Expected_MRCSharpExposedLayoutSh_Float>, System.IDisposable
        {
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetValue", ExactSpelling = true)]
                extern static MR.CS.CSharp.ExposedLayoutSh *__MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetValue(_Underlying *_this);
                var __c_ret = __MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetValue(_UnderlyingPtr);
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetError", ExactSpelling = true)]
                extern static float *__MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetError(_Underlying *_this);
                var __c_ret = __MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetError(_UnderlyingPtr);
        ...
        public class Expected_MRCSharpExposedLayoutSh_Float : Const_Expected_MRCSharpExposedLayoutSh_Float
        {
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableValue", ExactSpelling = true)]
                extern static MR.CS.CSharp.ExposedLayoutSh *__MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableValue(_Underlying *_this);
                var __c_ret = __MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableValue(_UnderlyingPtr);
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableError", ExactSpelling = true)]
                extern static float *__MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableError(_Underlying *_this);
                var __c_ret = __MR_C_expected_MR_CSharp_ExposedLayoutSh_float_GetMutableError(_UnderlyingPtr);
