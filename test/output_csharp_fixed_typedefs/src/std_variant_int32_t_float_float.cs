public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            /// </summary>
            public class Const_Variant_Int32T_Float_Float : MR.CS.Misc.Object<Const_Variant_Int32T_Float_Float>, System.IDisposable
            {
                ...
                ~Const_Variant_Int32T_Float_Float() {Dispose(false);}

                internal unsafe Const_Variant_Int32T_Float_Float(_Underlying *ptr, bool is_owning) : base(is_owning) {_UnderlyingPtr = ptr;}
                ...
                public unsafe ulong index()
                {
                    ...
                    extern static ulong __MR_C_std_variant_int32_t_float_float_Index(_Underlying *_this);
                ...
                /// Constructs the variant storing the element 0, of type `int32_t`.
                /// </summary>
                public static unsafe implicit operator Const_Variant_Int32T_Float_Float(int value) {return new(value);}
            ...
            /// </summary>
            public class Variant_Int32T_Float_Float : Const_Variant_Int32T_Float_Float
            {
                internal unsafe Variant_Int32T_Float_Float(_Underlying *ptr, bool is_owning) : base(ptr, is_owning) {}
                ...
                /// Constructs a copy of another instance. The source remains alive.
                /// </summary>
                public Variant_Int32T_Float_Float(Variant_Int32T_Float_Float other) : this((Const_Variant_Int32T_Float_Float)other) {}
                ...
                /// Constructs the variant storing the element 0, of type `int32_t`.
                /// </summary>
                public static unsafe implicit operator Variant_Int32T_Float_Float(int value) {return new(value);}
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_variant_int32_t_float_float_GetMutable_int32_t", ExactSpelling = true)]
                    extern static int *__MR_C_std_variant_int32_t_float_float_GetMutable_int32_t(_Underlying *_this);
                    var __c_ret = __MR_C_std_variant_int32_t_float_float_GetMutable_int32_t(_UnderlyingPtr);
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_variant_int32_t_float_float_GetMutable_float_1", ExactSpelling = true)]
                    extern static float *__MR_C_std_variant_int32_t_float_float_GetMutable_float_1(_Underlying *_this);
                    var __c_ret = __MR_C_std_variant_int32_t_float_float_GetMutable_float_1(_UnderlyingPtr);
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_variant_int32_t_float_float_GetMutable_float_2", ExactSpelling = true)]
                    extern static float *__MR_C_std_variant_int32_t_float_float_GetMutable_float_2(_Underlying *_this);
                    var __c_ret = __MR_C_std_variant_int32_t_float_float_GetMutable_float_2(_UnderlyingPtr);
                    return __c_ret is not null ? new MR.CS.Misc.Ref<float>(__c_ret) : null;
                }
            }

            /// <summary>
            /// This is used for optional parameters of class `Variant_Int32T_Float_Float` with default arguments.
            /// This is only used mutable parameters. For const ones we have `_InOptConst_Variant_Int32T_Float_Float`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Variant_Int32T_Float_Float`/`Const_Variant_Int32T_Float_Float` directly.
            /// </summary>
            public class _InOptMut_Variant_Int32T_Float_Float
            {
                public Variant_Int32T_Float_Float? Opt;

                public _InOptMut_Variant_Int32T_Float_Float() {}
                public _InOptMut_Variant_Int32T_Float_Float(Variant_Int32T_Float_Float value) {Opt = value;}
                public static implicit operator _InOptMut_Variant_Int32T_Float_Float(Variant_Int32T_Float_Float value) {return new(value);}
            }

            /// <summary>
            /// This is used for optional parameters of class `Variant_Int32T_Float_Float` with default arguments.
            /// This is only used const parameters. For non-const ones we have `_InOptMut_Variant_Int32T_Float_Float`.
            /// Usage:
            /// * Pass `null` to use the default argument.
            /// * Pass `new()` to pass no object.
            /// * Pass an instance of `Variant_Int32T_Float_Float`/`Const_Variant_Int32T_Float_Float` to pass it to the function.
            /// </summary>
            public class _InOptConst_Variant_Int32T_Float_Float
            {
                public Const_Variant_Int32T_Float_Float? Opt;

                public _InOptConst_Variant_Int32T_Float_Float() {}
                public _InOptConst_Variant_Int32T_Float_Float(Const_Variant_Int32T_Float_Float value) {Opt = value;}
                public static implicit operator _InOptConst_Variant_Int32T_Float_Float(Const_Variant_Int32T_Float_Float value) {return new(value);}

                /// <summary>
                /// Constructs the variant storing the element 0, of type `int32_t`.
                /// </summary>
                public static unsafe implicit operator _InOptConst_Variant_Int32T_Float_Float(int value) {return new Const_Variant_Int32T_Float_Float(value);}
            }
        }
    }
}
