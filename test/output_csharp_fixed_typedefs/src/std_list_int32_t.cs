    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Const_List_Int32T : MR.CS.Misc.Object<Const_List_Int32T>, System.IDisposable, IEnumerable<int>
            {
                ...
                {
                    Const_List_Int32T _container;
                    MR.CS.Std.List_Int32T.ConstIterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(Const_List_Int32T container)
                    {
            ...
            public class List_Int32T : Const_List_Int32T, IEnumerable<MR.CS.Misc.Ref<int>>
            {
                ...
                {
                    List_Int32T _container;
                    MR.CS.Std.List_Int32T.Iterator _cur;
                    bool _first = true;
                    bool _done;

                    public _Enumerator(List_Int32T container)
                    {
                        _container = container;
                        _cur = _container.begin();
                        _done = _cur == _container.end();
                ...
                public unsafe void resizeWithDefaultValue(ulong new_size, int value)
                {
                    ...
                    extern static void __MR_C_std_list_int32_t_resize_with_default_value(_Underlying *_this, ulong new_size, int value);
