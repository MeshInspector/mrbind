    ...
    public static partial class CS
    {
        public static partial class TestSimpleTypes
        {
            ...
            public class Const_ClassTemplate_MRCUint64T : MR.CS.Misc.Object<Const_ClassTemplate_MRCUint64T>, System.IDisposable
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_TestSimpleTypes_ClassTemplate_uint64_t_Construct_int32_t", ExactSpelling = true)]
                    extern static MR.CS.TestSimpleTypes.ClassTemplate_MRCUint64T._Underlying *__MR_TestSimpleTypes_ClassTemplate_uint64_t_Construct_int32_t(int _1);
                    _UnderlyingPtr = __MR_TestSimpleTypes_ClassTemplate_uint64_t_Construct_int32_t(_1);
                }
            ...
            public class ClassTemplate_MRCUint64T : Const_ClassTemplate_MRCUint64T
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_TestSimpleTypes_ClassTemplate_uint64_t_foo_int32_t", ExactSpelling = true)]
                    extern static void __MR_TestSimpleTypes_ClassTemplate_uint64_t_foo_int32_t(_Underlying *_this);
                    __MR_TestSimpleTypes_ClassTemplate_uint64_t_foo_int32_t(_UnderlyingPtr);
                }
            }
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_TestSimpleTypes_CheckChar_uint8_t_ptr", ExactSpelling = true)]
                extern static void __MR_TestSimpleTypes_CheckChar_uint8_t_ptr(byte *_1);
                byte __value__1 = _1 is not null ? _1.Value : default(byte);
                if (_1 is not null) _1.Value = __value__1;
                __MR_TestSimpleTypes_CheckChar_uint8_t_ptr(_1 is not null ? &__value__1 : null);
            }
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_TestSimpleTypes_CheckChar_int8_t_ptr", ExactSpelling = true)]
                extern static void __MR_TestSimpleTypes_CheckChar_int8_t_ptr(sbyte *_1);
                sbyte __value__1 = _1 is not null ? _1.Value : default(sbyte);
                if (_1 is not null) _1.Value = __value__1;
                __MR_TestSimpleTypes_CheckChar_int8_t_ptr(_1 is not null ? &__value__1 : null);
            }
            ...
            {
                [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_TestSimpleTypes_FuncTemplate_int32_t", ExactSpelling = true)]
                extern static int __MR_TestSimpleTypes_FuncTemplate_int32_t(int _1);
                return __MR_TestSimpleTypes_FuncTemplate_int32_t(_1);
            }
        }
    }
}
