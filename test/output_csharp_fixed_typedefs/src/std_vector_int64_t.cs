public static partial class MR
{
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            /// </summary>
            public class Const_Vector_MRCInt64T : MR.CS.Misc.Object<Const_Vector_MRCInt64T>, System.IDisposable
            {
            ...
            public class Vector_MRCInt64T : Const_Vector_MRCInt64T
            {
                ...
                public unsafe new MR.CS.Misc.Ref<long>? front()
                {
                    ...
                    var __c_ret = __MR_C_std_vector_int64_t_MutableFront(_UnderlyingPtr);
                ...
                public unsafe new MR.CS.Misc.Ref<long>? back()
                {
                    ...
                    var __c_ret = __MR_C_std_vector_int64_t_MutableBack(_UnderlyingPtr);
                    return __c_ret is not null ? new MR.CS.Misc.Ref<long>(__c_ret) : null;
                }
                ...
                public unsafe new MR.CS.PtrMRCInt64T data()
                {
                    ...
                    return new(__MR_C_std_vector_int64_t_MutableData(_UnderlyingPtr));
                }
                ...
                public unsafe new MR.CS.Std.Vector_MRCInt64T.Iterator begin()
                {
                    ...
                    __ret = new(__MR_C_std_vector_int64_t_MutableBegin(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
                ...
                public unsafe new MR.CS.Std.Vector_MRCInt64T.Iterator end()
                {
                    ...
                    MR.CS.Std.Vector_MRCInt64T.Iterator __ret;
                    __ret = new(__MR_C_std_vector_int64_t_MutableEnd(_UnderlyingPtr), is_owning: true);
                    __ret._KeepAliveEnclosingObject = this;
                    return __ret;
                }
