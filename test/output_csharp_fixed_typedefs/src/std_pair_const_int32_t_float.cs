    ...
    public static partial class CS
    {
        public static partial class Std
        {
            ...
            public class Pair_ConstInt32T_Float : Const_Pair_ConstInt32T_Float
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_std_pair_const_int32_t_float_MutableSecond", ExactSpelling = true)]
                    extern static float *__MR_C_std_pair_const_int32_t_float_MutableSecond(_Underlying *_this);
                    return ref *__MR_C_std_pair_const_int32_t_float_MutableSecond(_UnderlyingPtr);
                }
            }
