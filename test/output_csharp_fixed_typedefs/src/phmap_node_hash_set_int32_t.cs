public static partial class MR
{
    public static partial class CS
    {
        public static partial class Phmap
        {
            ...
            /// </summary>
            public class Const_NodeHashSet_Int32T : MR.CS.Misc.Object<Const_NodeHashSet_Int32T>, System.IDisposable
            {
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_node_hash_set_int32_t_IsEmpty", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_node_hash_set_int32_t_IsEmpty(_Underlying *_this);
                    return __MR_C_phmap_node_hash_set_int32_t_IsEmpty(_UnderlyingPtr) != 0;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_node_hash_set_int32_t_IsBegin", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_node_hash_set_int32_t_IsBegin(_Underlying *_this, MR.CS.Phmap.NodeHashSet_Int32T.Const_ConstIterator._Underlying *iter);
                    return __MR_C_phmap_node_hash_set_int32_t_IsBegin(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
                ...
                {
                    [System.Runtime.InteropServices.DllImport("bleh", EntryPoint = "MR_C_phmap_node_hash_set_int32_t_IsEnd", ExactSpelling = true)]
                    extern static byte __MR_C_phmap_node_hash_set_int32_t_IsEnd(_Underlying *_this, MR.CS.Phmap.NodeHashSet_Int32T.Const_ConstIterator._Underlying *iter);
                    return __MR_C_phmap_node_hash_set_int32_t_IsEnd(_UnderlyingPtr, iter._UnderlyingPtr) != 0;
                }
